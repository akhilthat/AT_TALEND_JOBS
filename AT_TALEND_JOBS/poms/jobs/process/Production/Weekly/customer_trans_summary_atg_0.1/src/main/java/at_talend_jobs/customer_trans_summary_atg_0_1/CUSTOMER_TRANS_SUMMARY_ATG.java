...
public class CUSTOMER_TRANS_SUMMARY_ATG implements TalendJob {
	static {System.setProperty("TalendJob.log", "CUSTOMER_TRANS_SUMMARY_ATG.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(CUSTOMER_TRANS_SUMMARY_ATG.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_W_u1gAajEeqS3P9meBs8cg", "0.1");
...
org.talend.components.snowflake.SnowflakeConnectionProperties props_tDBConnection_2 =
        (org.talend.components.snowflake.SnowflakeConnectionProperties) def_tDBConnection_2.createRuntimeProperties();
 		                    ...
 		                    "Talend_user");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:gPtbWp3cfuOpqR+fIRMJXixltVrnaL/GCB4j9lGUlK04fF/y"));
...
public static class row9Struct implements routines.system.IPersistableRow<row9Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_CUSTOMER_TRANS_SUMMARY_ATG, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBOutput_9";
		...
		int tos_count_tDBOutput_9 = 0;
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_9", "tDBOutput_1", "tSnowflakeOutput");
				talendJobLogProcess(globalMap);
			}
...
@SuppressWarnings("unchecked")
java.util.Map<String, Object> restRequest_tDBOutput_9 = (java.util.Map<String, Object>)globalMap.get("restRequest");
String currentTRestRequestOperation_tDBOutput_9 = (String)(restRequest_tDBOutput_9 != null ? restRequest_tDBOutput_9.get("OPERATION") : null);

org.talend.components.api.component.ComponentDefinition def_tDBOutput_9 =
...
org.talend.components.snowflake.tsnowflakeoutput.TSnowflakeOutputProperties props_tDBOutput_9 =
        (org.talend.components.snowflake.tsnowflakeoutput.TSnowflakeOutputProperties) def_tDBOutput_9.createRuntimeProperties();
 		                    ...
 		                    props_tDBOutput_9.setValue("convertColumnsAndTableToUppercase",
 		                    true);
 		                    
 		                    props_tDBOutput_9.setValue("convertEmptyStringsToNull",
 		                    false);
 		                    
 		                    props_tDBOutput_9.setValue("useSchemaDatePattern",
 		                    false);
 		                    
 		                    props_tDBOutput_9.setValue("dieOnError",
 		                    false);
 		                    ...
 		                    props_tDBOutput_9.connection.setValue("useCustomRegion",
 		                    false);
 		                    
 		                    props_tDBOutput_9.connection.userPassword.setValue("useAuth",
 		                    false);
 		                    
 		                    props_tDBOutput_9.connection.referencedComponent.setValue("referenceType",
 		                        org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE);
 		                    
 		                    props_tDBOutput_9.connection.referencedComponent.setValue("componentInstanceId",
 		                    "tDBConnection_2");
 		                    
 		                    props_tDBOutput_9.connection.referencedComponent.setValue("referenceDefinitionName",
 		                    "tSnowflakeConnection");
 		                    
 		                    props_tDBOutput_9.table.setValue("tableName",
 		                    "CUSTOMER_TRANS_SUMMARY_ATG");
 		                    
 		                    props_tDBOutput_9.table.connection.setValue("region",
 		                        org.talend.components.snowflake.SnowflakeRegion.AWS_US_EAST_1);
 		                    
 		                    props_tDBOutput_9.table.connection.setValue("useCustomRegion",
 		                    false);
 		                    
 		                    props_tDBOutput_9.table.connection.userPassword.setValue("useAuth",
 		                    false);
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_9_2_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"CUSTOMERNO\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CUSTOMERNO\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"CUSTOMERNO\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CUSTOMERNO\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CUSTOMER_ID\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CUSTOMER_ID\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"CUSTOMER_ID\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CUSTOMER_ID\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ATG_ID\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ATG_ID\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"ATG_ID\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ATG_ID\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRANSACTION_DATE\",\"type\":[{\"type\":\"int\",\"logicalType\":\"date\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRANSACTION_DATE\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRANSACTION_DATE\",\"di.prop.di.date.date\":\"true\",\"di.column.talendType\":\"id_Date\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"yyyy-MM-dd\",\"di.column.relationshipType\":\"\",\"di.prop.di.column.logicalType\":\"date\",\"di.table.label\":\"TRANSACTION_DATE\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"STORE_NO\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"STORE_NO\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"STORE_NO\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"STORE_NO\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"REGISTER_NO\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"REGISTER_NO\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"REGISTER_NO\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"REGISTER_NO\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"HE_NO\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"HE_NO\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"HE_NO\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"HE_NO\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRANSACTION_NO\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRANSACTION_NO\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRANSACTION_NO\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRANSACTION_NO\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRANSACTION_ID\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRANSACTION_ID\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRANSACTION_ID\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRANSACTION_ID\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"UNITS\",\"type\":[\"double\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"UNITS\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"UNITS\",\"di.column.talendType\":\"id_Double\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"UNITS\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"EMPLOYEE_FLAG\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"EMPLOYEE_FLAG\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"EMPLOYEE_FLAG\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"EMPLOYEE_FLAG\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"CONTINUITY_ORDER\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CONTINUITY_ORDER\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"CONTINUITY_ORDER\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CONTINUITY_ORDER\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"OMS_ORDER\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"OMS_ORDER\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"OMS_ORDER\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"OMS_ORDER\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"VOUCHER_RD\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"VOUCHER_RD\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"VOUCHER_RD\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"VOUCHER_RD\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"SUBSCRIPTION_ORDER\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"SUBSCRIPTION_ORDER\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"SUBSCRIPTION_ORDER\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"SUBSCRIPTION_ORDER\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRANSACTION_TOTAL\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRANSACTION_TOTAL\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRANSACTION_TOTAL\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRANSACTION_TOTAL\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tDBOutput_9\",\"di.table.label\":\"tDBOutput_9\"}",s);
    ...
    if (org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE == props_tDBOutput_9.connection.referencedComponent.referenceType.getValue()) {
        final String referencedComponentInstanceId_tDBOutput_9 = props_tDBOutput_9.connection.referencedComponent.componentInstanceId.getStringValue();
        if (referencedComponentInstanceId_tDBOutput_9 != null) {
            org.talend.daikon.properties.Properties referencedComponentProperties_tDBOutput_9 = (org.talend.daikon.properties.Properties) globalMap.get(
                referencedComponentInstanceId_tDBOutput_9 + "_COMPONENT_RUNTIME_PROPERTIES");
            props_tDBOutput_9.connection.referencedComponent.setReference(referencedComponentProperties_tDBOutput_9);
        }
    }
    if (org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE == props_tDBOutput_9.table.connection.referencedComponent.referenceType.getValue()) {
        final String referencedComponentInstanceId_tDBOutput_9 = props_tDBOutput_9.table.connection.referencedComponent.componentInstanceId.getStringValue();
        if (referencedComponentInstanceId_tDBOutput_9 != null) {
            org.talend.daikon.properties.Properties referencedComponentProperties_tDBOutput_9 = (org.talend.daikon.properties.Properties) globalMap.get(
                referencedComponentInstanceId_tDBOutput_9 + "_COMPONENT_RUNTIME_PROPERTIES");
            props_tDBOutput_9.table.connection.referencedComponent.setReference(referencedComponentProperties_tDBOutput_9);
        }
    }
...
org.talend.daikon.runtime.RuntimeInfo runtime_info_tDBOutput_9 = def_tDBOutput_9.getRuntimeInfo(
    org.talend.components.api.component.runtime.ExecutionEngine.DI, props_tDBOutput_9, topology_tDBOutput_9);
java.util.Set<org.talend.components.api.component.ConnectorTopology> supported_connector_topologies_tDBOutput_9 = def_tDBOutput_9.getSupportedConnectorTopologies();

org.talend.components.api.component.runtime.RuntimableRuntime componentRuntime_tDBOutput_9 = (org.talend.components.api.component.runtime.RuntimableRuntime)(Class.forName(runtime_info_tDBOutput_9.getRuntimeClassName()).newInstance());
org.talend.daikon.properties.ValidationResult initVr_tDBOutput_9 = componentRuntime_tDBOutput_9.initialize(container_tDBOutput_9, props_tDBOutput_9);
...
if(componentRuntime_tDBOutput_9 instanceof org.talend.components.api.component.runtime.SourceOrSink) {
	...
	if (doesNodeBelongToRequest_tDBOutput_9) {
        org.talend.daikon.properties.ValidationResult vr_tDBOutput_9 = sourceOrSink_tDBOutput_9.validate(container_tDBOutput_9);
    ...
    if (sourceOrSink_tDBOutput_9 instanceof org.talend.components.api.component.runtime.Sink) {
    	org.talend.components.api.component.runtime.Sink sink_tDBOutput_9 =
            	(org.talend.components.api.component.runtime.Sink)sourceOrSink_tDBOutput_9;
        org.talend.components.api.component.runtime.WriteOperation writeOperation_tDBOutput_9 = sink_tDBOutput_9.createWriteOperation();
        if (doesNodeBelongToRequest_tDBOutput_9) {
    ...
    for (org.talend.components.api.component.Connector currentConnector : props_tDBOutput_9.getAvailableConnectors(null, false)) {
    ...
    incomingEnforcer_tDBOutput_9 = new org.talend.codegen.enforcer.IncomingSchemaEnforcer(designSchema_tDBOutput_9);
 ...
 */
	...
	currentComponent="tDBInput_9";
		...
		int tos_count_tDBInput_9 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_9{
                    ...
                    log4jParamters_tDBInput_9.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_9.append(" | ");
                            log4jParamters_tDBInput_9.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:c8As8RdfQIa95Q+8yeNd2hZxUesImvGCAZNefg0nc73mQbaK").substring(0, 4) + "...");     
                        log4jParamters_tDBInput_9.append(" | ");
                            log4jParamters_tDBInput_9.append("TABLE" + " = " + "\"RetCatData\"");
                        log4jParamters_tDBInput_9.append(" | ");
                            log4jParamters_tDBInput_9.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_9.append(" | ");
                            log4jParamters_tDBInput_9.append("QUERY" + " = " + "\"  select * from Customer_Trans_Summary_ATG  where [Transaction Date] between CONVERT(CHAR(10), DATEADD(DAY, -7, GETDATE()), 121) and CONVERT(CHAR(10), DATEADD(DAY, -1, GETDATE()), 121)    \"");
                        log4jParamters_tDBInput_9.append(" | ");
                        ...
                        log4jParamters_tDBInput_9.append(" | ");
                            log4jParamters_tDBInput_9.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("CUSTOMERNO")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CUSTOMER_ID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ATG_ID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRANSACTION_DATE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("STORE_NO")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("REGISTER_NO")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("HE_NO")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRANSACTION_NO")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRANSACTION_ID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("UNITS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EMPLOYEE_FLAG")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("BOPUS_ORDER")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CONTINUITY_ORDER")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("OMS_ORDER")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("VOUCHER_RD")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("SUBSCRIPTION_ORDER")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRANSACTION_TOTAL")+"}]");
                        log4jParamters_tDBInput_9.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_9", "tDBInput_1", "tMSSqlInput");
				talendJobLogProcess(globalMap);
			}
	...
	final String decryptedPassword_tDBInput_9 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:zCElAi+FOlGBTfyYhmSftATFBWqG6tT2QQ/9kRFScM62J+kf");
...
+"()), 121) and CONVERT(CHAR(10), DATEADD(DAY, -1, GETDATE()), 121)\n\n";
            ...
            if(tmpContent_tDBInput_9 != null) {
            	if (talendToDBList_tDBInput_9 .contains(rsmd_tDBInput_9.getColumnTypeName(12).toUpperCase(java.util.Locale.ENGLISH))) {
            ...
            if(tmpContent_tDBInput_9 != null) {
            	if (talendToDBList_tDBInput_9 .contains(rsmd_tDBInput_9.getColumnTypeName(16).toUpperCase(java.util.Locale.ENGLISH))) {
 ...
 */
	...
	currentComponent="tDBOutput_9";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row9","tDBInput_9","tDBInput_1","tMSSqlInput","tDBOutput_9","tDBOutput_1","tSnowflakeOutput"
        ...
        if (incomingEnforcer_tDBOutput_9 != null) {
            incomingEnforcer_tDBOutput_9.createNewRecord();
                ...
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("CUSTOMERNO") != null){
                    incomingEnforcer_tDBOutput_9.put("CUSTOMERNO", row9.CUSTOMERNO);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("CUSTOMER_ID") != null){
                    incomingEnforcer_tDBOutput_9.put("CUSTOMER_ID", row9.CUSTOMER_ID);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("ATG_ID") != null){
                    incomingEnforcer_tDBOutput_9.put("ATG_ID", row9.ATG_ID);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("TRANSACTION_DATE") != null){
                    incomingEnforcer_tDBOutput_9.put("TRANSACTION_DATE", row9.TRANSACTION_DATE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("STORE_NO") != null){
                    incomingEnforcer_tDBOutput_9.put("STORE_NO", row9.STORE_NO);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("REGISTER_NO") != null){
                    incomingEnforcer_tDBOutput_9.put("REGISTER_NO", row9.REGISTER_NO);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("HE_NO") != null){
                    incomingEnforcer_tDBOutput_9.put("HE_NO", row9.HE_NO);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("TRANSACTION_NO") != null){
                    incomingEnforcer_tDBOutput_9.put("TRANSACTION_NO", row9.TRANSACTION_NO);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("TRANSACTION_ID") != null){
                    incomingEnforcer_tDBOutput_9.put("TRANSACTION_ID", row9.TRANSACTION_ID);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("UNITS") != null){
                    incomingEnforcer_tDBOutput_9.put("UNITS", row9.UNITS);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("EMPLOYEE_FLAG") != null){
                    incomingEnforcer_tDBOutput_9.put("EMPLOYEE_FLAG", row9.EMPLOYEE_FLAG);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("BOPUS_ORDER") != null){
                    incomingEnforcer_tDBOutput_9.put("BOPUS_ORDER", row9.BOPUS_ORDER);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("CONTINUITY_ORDER") != null){
                    incomingEnforcer_tDBOutput_9.put("CONTINUITY_ORDER", row9.CONTINUITY_ORDER);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("OMS_ORDER") != null){
                    incomingEnforcer_tDBOutput_9.put("OMS_ORDER", row9.OMS_ORDER);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("VOUCHER_RD") != null){
                    incomingEnforcer_tDBOutput_9.put("VOUCHER_RD", row9.VOUCHER_RD);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("SUBSCRIPTION_ORDER") != null){
                    incomingEnforcer_tDBOutput_9.put("SUBSCRIPTION_ORDER", row9.SUBSCRIPTION_ORDER);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_9 != null && incomingEnforcer_tDBOutput_9.getRuntimeSchema().getField("TRANSACTION_TOTAL") != null){
...
resourceMap.put("finish_tDBOutput_9", Boolean.TRUE);
    ...
    if (writer_tDBOutput_9 != null) {
        org.talend.components.api.component.runtime.Result resultObject_tDBOutput_9 = (org.talend.components.api.component.runtime.Result)writer_tDBOutput_9.close();
        resultMap_tDBOutput_9 = writer_tDBOutput_9.getWriteOperation().finalize(java.util.Arrays.<org.talend.components.api.component.runtime.Result>asList(resultObject_tDBOutput_9), container_tDBOutput_9);
    }
if(resultMap_tDBOutput_9!=null) {
	for(java.util.Map.Entry<String,Object> entry_tDBOutput_9 : resultMap_tDBOutput_9.entrySet()) {
		...
		case org.talend.components.api.component.ComponentDefinition.RETURN_ERROR_MESSAGE :
			container_tDBOutput_9.setComponentData("tDBOutput_9", "ERROR_MESSAGE", entry_tDBOutput_9.getValue());
			break;
		case org.talend.components.api.component.ComponentDefinition.RETURN_TOTAL_RECORD_COUNT :
			container_tDBOutput_9.setComponentData("tDBOutput_9", "NB_LINE", entry_tDBOutput_9.getValue());
			break;
		case org.talend.components.api.component.ComponentDefinition.RETURN_SUCCESS_RECORD_COUNT :
			container_tDBOutput_9.setComponentData("tDBOutput_9", "NB_SUCCESS", entry_tDBOutput_9.getValue());
			break;
		case org.talend.components.api.component.ComponentDefinition.RETURN_REJECT_RECORD_COUNT :
			container_tDBOutput_9.setComponentData("tDBOutput_9", "NB_REJECT", entry_tDBOutput_9.getValue());
			break;
		default :
            StringBuilder studio_key_tDBOutput_9 = new StringBuilder();
            for (int i_tDBOutput_9 = 0; i_tDBOutput_9 < entry_tDBOutput_9.getKey().length(); i_tDBOutput_9++) {
			...
			container_tDBOutput_9.setComponentData("tDBOutput_9", studio_key_tDBOutput_9.toString().toUpperCase(java.util.Locale.ENGLISH), entry_tDBOutput_9.getValue());
			break;
		}
	}
}
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row9",2,0,
			 			"tDBInput_9","tDBInput_1","tMSSqlInput","tDBOutput_9","tDBOutput_1","tSnowflakeOutput","output")) {
						talendJobLogProcess(globalMap);
					}
...
if(resourceMap.get("finish_tDBOutput_9")==null){
    if(resourceMap.get("writer_tDBOutput_9")!=null){
		try {
			((org.talend.components.api.component.runtime.Writer)resourceMap.get("writer_tDBOutput_9")).close();
		} catch (java.io.IOException e_tDBOutput_9) {
			String errorMessage_tDBOutput_9 = "failed to release the resource in tDBOutput_9 :" + e_tDBOutput_9.getMessage();
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'CUSTOMER_TRANS_SUMMARY_ATG' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-06-21T12:56:02.365736600Z");
        ...
        try {
            ...
            java.io.InputStream inContext = CUSTOMER_TRANS_SUMMARY_ATG.class.getClassLoader().getResourceAsStream("at_talend_jobs/customer_trans_summary_atg_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CUSTOMER_TRANS_SUMMARY_ATG.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
final Thread launchingThread = Thread.currentThread();
        ...
        new Thread(){
            public void run() {
                ...
                try {
((java.util.Map) threadLocal.get()).put("errorCode", null);tDBRow_10Process(globalMap);
...
globalMap.put("tDBRow_10_SUBPROCESS_STATE", -1);
((java.util.Map) threadLocal.get()).put("status", "failure");throw e_tDBRow_10;
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CUSTOMER_TRANS_SUMMARY_ATG");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'CUSTOMER_TRANS_SUMMARY_ATG' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     188996 characters generated by Talend Cloud Data Management Platform 
 *     on the June 21, 2023 at 8:56:02 AM EDT
 ************************************************************************************************/