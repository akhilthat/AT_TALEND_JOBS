...
public class TTAALLCL3 implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "TTAALLCL3.log");
	}
	...
	public void tDBInput_19_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
...
// clear the temporary values in the globalMap
				...
				while ((((globalMap.get("tDBRow_4_SUBPROCESS_STATE") == null) ? true
						: ((Integer) globalMap.get("tDBRow_4_SUBPROCESS_STATE") == 0))
						...
						|| ((globalMap.get("tDBRow_7_SUBPROCESS_STATE") == null) ? true
								: ((Integer) globalMap.get("tDBRow_7_SUBPROCESS_STATE") == 0))
						|| false)) {
					Thread.sleep(100);
				}
	...
	public void tDBRow_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBRow_4.setValue("dieOnError", false);
	...
	public void tDBInput_19Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tFileOutputDelimited_13 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileOutputDelimited_13
									.append("FILENAME" + " = " + "\"/data/talend/data_repository/SETHDR.csv\"");
							log4jParamters_tFileOutputDelimited_13.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFileOutputDelimited_13", "tFileOutputDelimited_13", "tFileOutputDelimited");
					talendJobLogProcess(globalMap);
				}

				String fileName_tFileOutputDelimited_13 = "";
				fileName_tFileOutputDelimited_13 = (new java.io.File("/data/talend/data_repository/SETHDR.csv"))
				...
				if (directory_tFileOutputDelimited_13 != null
					...
					if (!dir_tFileOutputDelimited_13.exists()) {
						log.info("tFileOutputDelimited_13 - Creating directory '"
								+ dir_tFileOutputDelimited_13.getCanonicalPath() + "'.");
						dir_tFileOutputDelimited_13.mkdirs();
						log.info("tFileOutputDelimited_13 - The directory '"
								+ dir_tFileOutputDelimited_13.getCanonicalPath() + "' has been created successfully.");
					}
				}
				...
				zipOut_tFileOutputDelimited_13 = new java.util.zip.ZipOutputStream(new java.io.BufferedOutputStream(
						new java.io.FileOutputStream(zipName_tFileOutputDelimited_13)));
				zipOut_tFileOutputDelimited_13
						.putNextEntry(new java.util.zip.ZipEntry(filetFileOutputDelimited_13.getName()));
				outtFileOutputDelimited_13 = new java.io.BufferedWriter(
						new java.io.OutputStreamWriter(zipOut_tFileOutputDelimited_13, "ISO-8859-15"));
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBInput_19 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_19.append(" | ");
							log4jParamters_tDBInput_19.append("PASS" + " = "
									+ String.valueOf(
							...
							log4jParamters_tDBInput_19.append(" | ");
							log4jParamters_tDBInput_19.append(
									"TRIM_COLUMN" + " = " + "[{TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("ISETNO")
											+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("IPKGYN") + "}]");
							log4jParamters_tDBInput_19.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_19", "tDBInput_19", "tAS400Input");
					talendJobLogProcess(globalMap);
				}
				...
				String url_tDBInput_19 = "jdbc:as400://" + context.jda_host_name + "/" + context.jda_mm_lib + ";"
						+ "prompt=false";

				log.debug("tDBInput_19 - Driver ClassName: " + driverClass_tDBInput_19 + ".");

				log.debug("tDBInput_19 - Connection attempt to '" + url_tDBInput_19 + "' with the username '"
						+ dbUser_tDBInput_19 + "'.");
				...
				try {
					...
					while (rs_tDBInput_19.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row26", "tDBInput_19", "tDBInput_19", "tAS400Input", "tFileOutputDelimited_13",
								"tFileOutputDelimited_13", "tFileOutputDelimited"
						...
						if (row26.ISETNO != null) {
							sb_tFileOutputDelimited_13
									.append(row26.ISETNO.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_13.append(OUT_DELIM_tFileOutputDelimited_13);
						if (row26.IPKGYN != null) {
							sb_tFileOutputDelimited_13.append(row26.IPKGYN);
						}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row26", 2, 0,
						"tDBInput_19", "tDBInput_19", "tAS400Input", "tFileOutputDelimited_13",
						"tFileOutputDelimited_13", "tFileOutputDelimited", "output")) {
					talendJobLogProcess(globalMap);
				}
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tDBInput_19:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public void tFileInputDelimited_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBOutput_14.table.setValue("tableName", "INVENTORY_SET_FILE_SETHDR");
				...
				class SchemaSettingTool_tDBOutput_14_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"IPKGYN\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":1,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"IPKGYN\",\"talend.field.default\":\"\"},{",
								s);
...
// ###############################
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tFileInputDelimited_8 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_8
									.append("FILENAME" + " = " + "\"/data/talend/data_repository/SETHDR.zip\"");
							...
							log4jParamters_tFileInputDelimited_8.append(" | ");
							log4jParamters_tFileInputDelimited_8.append(
									"TRIMSELECT" + " = " + "[{TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("ISETNO")
											+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("IPKGYN") + "}]");
							log4jParamters_tFileInputDelimited_8.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFileInputDelimited_8", "tFileInputDelimited_8", "tFileInputDelimited");
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					try {
						if (filename_tFileInputDelimited_8 instanceof java.io.InputStream) {
							zis_tFileInputDelimited_8 = new java.util.zip.ZipInputStream(
					...
					while (true) {
						...
						try {
							fid_tFileInputDelimited_8 = new org.talend.fileprocess.FileInputDelimited(
									zis_tFileInputDelimited_8, "ISO-8859-15", ",", "\n", false, 1, 0,
						...
						while (fid_tFileInputDelimited_8 != null && fid_tFileInputDelimited_8.nextRecord()) {
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_8.setException(new RuntimeException(String.format(
												...
												"ISETNO", "row8", temp, ex_tFileInputDelimited_8),
							...
							log.debug("tFileInputDelimited_8 - Retrieving the record "
...
// Start of branch "row8"
							if (row8 != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "row8", "tFileInputDelimited_8", "tFileInputDelimited_8",
...
// # Output table : 'SETHDR'
									...
									SETHDR = SETHDR_tmp;
									log.debug("tMap_5 - Outputting the record " + count_SETHDR_tMap_5
											+ " of the output table 'SETHDR'.");
...
// Start of branch "SETHDR"
								if (SETHDR != null) {
									...
									if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
											...
											, "SETHDR", "tMap_5", "tMap_5", "tMap", "tDBOutput_14", "tDBOutput_14",
											"tSnowflakeOutput"
									...
									// schema
									if (incomingEnforcer_tDBOutput_14 != null && incomingEnforcer_tDBOutput_14
									...
									// schema
									if (incomingEnforcer_tDBOutput_14 != null && incomingEnforcer_tDBOutput_14
											.getRuntimeSchema().getField("IPKGYN") != null) {
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row8", 2, 0,
						"tFileInputDelimited_8", "tFileInputDelimited_8", "tFileInputDelimited", "tMap_5", "tMap_5",
						"tMap", "output")) {
					talendJobLogProcess(globalMap);
				}
...
// end of generic
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "SETHDR", 2, 0, "tMap_5",
						"tMap_5", "tMap", "tDBOutput_14", "tDBOutput_14", "tSnowflakeOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
					...
					class BytesLimit65535_tFileDelete_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileDelete_1
									.append("PATH" + " = " + "\"/data/talend/data_repository/SETHDR.zip\"");
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tFileOutputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileOutputDelimited_1
									.append("FILENAME" + " = " + "\"/data/talend/data_repository/TBLFLD.csv\"");
							log4jParamters_tFileOutputDelimited_1.append(" | ");
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File("/data/talend/data_repository/TBLFLD.csv"))
						.getAbsolutePath().replace("\\", "/");
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("TBLNAM") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("TBLVAL") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("TBLDSC")
									+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("TBLDEF") + "}, {TRIM="
									+ ("false") + ", SCHEMA_COLUMN=" + ("TBLLAN") + "}]");
							log4jParamters_tDBInput_1.append(" | ");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row42", "tDBInput_1", "tDBInput_1", "tAS400Input", "tFileOutputDelimited_1",
						...
						if (row42.TBLNAM != null) {
							sb_tFileOutputDelimited_1.append(row42.TBLNAM);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row42.TBLVAL != null) {
							sb_tFileOutputDelimited_1.append(row42.TBLVAL);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row42.TBLDSC != null) {
							sb_tFileOutputDelimited_1.append(row42.TBLDSC);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row42.TBLDEF != null) {
							sb_tFileOutputDelimited_1.append(row42.TBLDEF);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row42.TBLLAN != null) {
							sb_tFileOutputDelimited_1.append(row42.TBLLAN);
						}
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBOutput_1.table.setValue("tableName", "TABLE_FIELDS_FILE_TBLFLD");
				...
				class SchemaSettingTool_tDBOutput_1_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"TBLNAM\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":6,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TBLNAM\",\"talend.field.default\":\"\"},{",
								s);

						a("\"name\":\"TBLVAL\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":6,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TBLVAL\",\"talend.field.default\":\"\"},{",
								s);

						a("\"name\":\"TBLDSC\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":35,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TBLDSC\",\"talend.field.default\":\"\"},{",
								s);

						a("\"name\":\"TBLDEF\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":1,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TBLDEF\",\"talend.field.default\":\"\"},{",
								s);

						a("\"name\":\"TBLLAN\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":3,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TBLLAN\",\"talend.field.default\":\"\"},{",
								s);
					...
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1
									.append("FILENAME" + " = " + "\"/data/talend/data_repository/TBLFLD.zip\"");
...
// Start of branch "row19"
							if (row19 != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "row19", "tFileInputDelimited_1", "tFileInputDelimited_1",
...
// # Output table : 'TBLFLD'
									...
									TBLFLD = TBLFLD_tmp;
									log.debug("tMap_1 - Outputting the record " + count_TBLFLD_tMap_1
											+ " of the output table 'TBLFLD'.");
...
// Start of branch "TBLFLD"
								if (TBLFLD != null) {
									...
									if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
											...
											, "TBLFLD", "tMap_1", "tMap_1", "tMap", "tDBOutput_1", "tDBOutput_1",
											"tSnowflakeOutput"
...
// end of generic
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "TBLFLD", 2, 0, "tMap_1",
					...
					class BytesLimit65535_tFileDelete_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileDelete_2
									.append("PATH" + " = " + "\"/data/talend/data_repository/TBLFLD.zip\"");
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tFileOutputDelimited_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileOutputDelimited_2
									.append("FILENAME" + " = " + "\"/data/talend/data_repository/TBLMCH.csv\"");
							log4jParamters_tFileOutputDelimited_2.append(" | ");
				...
				fileName_tFileOutputDelimited_2 = (new java.io.File("/data/talend/data_repository/TBLMCH.csv"))
						.getAbsolutePath().replace("\\", "/");
					...
					class BytesLimit65535_tDBInput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("MCHNUM") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("MCHNAM") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("MCHSCN")
									+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("MCHSDT") + "}, {TRIM="
									+ ("false") + ", SCHEMA_COLUMN=" + ("MCHEXT") + "}]");
							log4jParamters_tDBInput_2.append(" | ");
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row44", "tDBInput_2", "tDBInput_2", "tAS400Input", "tFileOutputDelimited_2",
						...
						if (row44.MCHNUM != null) {
							sb_tFileOutputDelimited_2.append(row44.MCHNUM);
						}
						sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row44.MCHNAM != null) {
							sb_tFileOutputDelimited_2.append(row44.MCHNAM);
						}
						sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row44.MCHSCN != null) {
							sb_tFileOutputDelimited_2
									.append(row44.MCHSCN.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row44.MCHSDT != null) {
							sb_tFileOutputDelimited_2
									.append(row44.MCHSDT.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row44.MCHEXT != null) {
							sb_tFileOutputDelimited_2.append(row44.MCHEXT);
						}
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBOutput_3.table.setValue("tableName", "TBLMCH");
				...
				class SchemaSettingTool_tDBOutput_3_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"MCHNAM\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":20,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"MCHNAM\",\"talend.field.default\":\"\"},{",
								s);

						a("\"name\":\"MCHSCN\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":1,\"talend.field.scale\":0,\"talend.field.dbType\":-5,\"talend.field.dbColumnName\":\"MCHSCN\",\"talend.field.default\":\"\"},{",
								s);

						a("\"name\":\"MCHSDT\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":6,\"talend.field.scale\":0,\"talend.field.dbType\":-5,\"talend.field.dbColumnName\":\"MCHSDT\",\"talend.field.default\":\"\"},{",
								s);

						a("\"name\":\"MCHEXT\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":4,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"MCHEXT\",\"talend.field.default\":\"\"},{",
								s);
					...
					class BytesLimit65535_tFileInputDelimited_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_2
									.append("FILENAME" + " = " + "\"/data/talend/data_repository/TBLMCH.zip\"");
							...
							try {
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"MCHSCN", "row21", temp, ex_tFileInputDelimited_2),
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"MCHSDT", "row21", temp, ex_tFileInputDelimited_2),
												ex_tFileInputDelimited_2));
									}
...
// Start of branch "row21"
							if (row21 != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "row21", "tFileInputDelimited_2", "tFileInputDelimited_2",
...
// # Output table : 'TBLMCH_2'
									...
									log.debug("tMap_2 - Outputting the record " + count_TBLMCH_2_tMap_2
											+ " of the output table 'TBLMCH_2'.");
...
// Start of branch "TBLMCH_2"
								if (TBLMCH_2 != null) {
									...
									if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
											...
											, "TBLMCH_2", "tMap_2", "tMap_2", "tMap", "tDBOutput_3", "tDBOutput_3",
											"tSnowflakeOutput"
...
// end of generic
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "TBLMCH_2", 2, 0,
						"tMap_2", "tMap_2", "tMap", "tDBOutput_3", "tDBOutput_3", "tSnowflakeOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
					...
					class BytesLimit65535_tFileDelete_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileDelete_3
									.append("PATH" + " = " + "\"/data/talend/data_repository/TBLMCH.zip\"");
	...
	public void tDBRow_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBRow_7.setValue("dieOnError", false);
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tFileOutputDelimited_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileOutputDelimited_3
									.append("FILENAME" + " = " + "\"/data/talend/data_repository/INVBAL2.zip\"");
							log4jParamters_tFileOutputDelimited_3.append(" | ");
				...
				fileName_tFileOutputDelimited_3 = (new java.io.File("/data/talend/data_repository/INVBAL2.zip"))
						.getAbsolutePath().replace("\\", "/");
					...
					class BytesLimit65535_tDBInput_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_3.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									...
									+ ("LOCNBR") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("SOFTCM") + "}]");
							log4jParamters_tDBInput_3.append(" | ");
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row38", "tDBInput_3", "tDBInput_3", "tAS400Input", "tFileOutputDelimited_3",
						...
						if (row38.INUMBR != null) {
							sb_tFileOutputDelimited_3
									.append(row38.INUMBR.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
						if (row38.LOCNBR != null) {
							sb_tFileOutputDelimited_3
									.append(row38.LOCNBR.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
						if (row38.SOFTCM != null) {
							sb_tFileOutputDelimited_3
									.append(row38.SOFTCM.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
	...
	public void tFileInputDelimited_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBOutput_4.table.setValue("tableName", "INVBAL_EXTENSION_INVBAL2");
				...
				class SchemaSettingTool_tDBOutput_4_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"LOCNBR\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"LOCNBR\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"LOCNBR\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"LOCNBR\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"SOFTCM\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"SOFTCM\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"SOFTCM\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"SOFTCM\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"DATELOADED\",\"type\":[{\"type\":\"int\",\"logicalType\":\"date\"},\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"LOAD_DATE\",\"talend.field.dbColumnName\":\"DATELOADED\",\"di.prop.di.date.date\":\"true\",\"di.column.talendType\":\"id_Date\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"yyyy-MM-dd\",\"di.column.relationshipType\":\"\",\"di.prop.di.column.logicalType\":\"date\",\"di.table.label\":\"DATELOADED\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"INVBAL2\",\"di.table.label\":\"INVBAL2\"}",
								s);
							...
							try {
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"INUMBR", "row16", temp, ex_tFileInputDelimited_3),
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"LOCNBR", "row16", temp, ex_tFileInputDelimited_3),
												ex_tFileInputDelimited_3));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"SOFTCM", "row16", temp, ex_tFileInputDelimited_3),
												ex_tFileInputDelimited_3));
									}
...
// Start of branch "row16"
							if (row16 != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "row16", "tFileInputDelimited_3", "tFileInputDelimited_3",
...
// # Output table : 'INVBAL2'
									...
									INVBAL2 = INVBAL2_tmp;
									log.debug("tMap_4 - Outputting the record " + count_INVBAL2_tMap_4
											+ " of the output table 'INVBAL2'.");
...
// Start of branch "INVBAL2"
								if (INVBAL2 != null) {
									...
									if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
											...
											, "INVBAL2", "tMap_4", "tMap_4", "tMap", "tDBOutput_4", "tDBOutput_4",
											"tSnowflakeOutput"
									...
									// schema
									if (incomingEnforcer_tDBOutput_4 != null && incomingEnforcer_tDBOutput_4
											.getRuntimeSchema().getField("LOCNBR") != null) {
										incomingEnforcer_tDBOutput_4.put("LOCNBR", INVBAL2.LOCNBR);
									}
									// skip the put action if the input column doesn't appear in component runtime
									// schema
									if (incomingEnforcer_tDBOutput_4 != null && incomingEnforcer_tDBOutput_4
											.getRuntimeSchema().getField("SOFTCM") != null) {
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row16", 2, 0,
						"tFileInputDelimited_3", "tFileInputDelimited_3", "tFileInputDelimited", "tMap_4", "tMap_4",
						"tMap", "output")) {
					talendJobLogProcess(globalMap);
				}
...
// end of generic
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "INVBAL2", 2, 0,
						"tMap_4", "tMap_4", "tMap", "tDBOutput_4", "tDBOutput_4", "tSnowflakeOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
					...
					class BytesLimit65535_tFileDelete_4 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileDelete_4
									.append("PATH" + " = " + "\"/data/talend/data_repository/INVBAL2.zip\"");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_1.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:l565tsO++40HDUkl4urKDUlbclbaukTVOGjliihnC/eoHf6X"));
...
// finally of generic
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-06-28T14:32:17.394960400Z");
		...
		try {
			...
			java.io.InputStream inContext = TTAALLCL3.class.getClassLoader()
					.getResourceAsStream("at_talend_jobs/ttaallcl3_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = TTAALLCL3.class.getClassLoader()
...
/************************************************************************************************
 * 640019 characters generated by Talend Cloud Data Management Platform on the
 * June 28, 2023 at 10:32:17 AM EDT
 ************************************************************************************************/