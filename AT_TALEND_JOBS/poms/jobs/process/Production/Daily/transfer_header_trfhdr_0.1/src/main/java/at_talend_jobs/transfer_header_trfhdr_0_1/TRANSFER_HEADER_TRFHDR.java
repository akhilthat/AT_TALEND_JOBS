...
public class TRANSFER_HEADER_TRFHDR implements TalendJob {
	static {System.setProperty("TalendJob.log", "TRANSFER_HEADER_TRFHDR.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(TRANSFER_HEADER_TRFHDR.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_S3xAcDZMEeqYYKudWeBa8Q", "0.1");
...
org.talend.components.snowflake.SnowflakeConnectionProperties props_tDBConnection_1 =
        (org.talend.components.snowflake.SnowflakeConnectionProperties) def_tDBConnection_1.createRuntimeProperties();
 		                    ...
 		                    "Talend_user");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:NozuU7BPx4dfnUkTaWaU610Xw0qPNyufk1w/FkyqrHaxRNm/"));
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tFileOutputDelimited_8";
		...
		int tos_count_tFileOutputDelimited_8 = 0;
                ...
                class BytesLimit65535_tFileOutputDelimited_8{
                    ...
                    log4jParamters_tFileOutputDelimited_8.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_8.append(" | ");
                            log4jParamters_tFileOutputDelimited_8.append("FILENAME" + " = " + "\"/data/talend/data_repository/TRFHDR.csv\"");
                        log4jParamters_tFileOutputDelimited_8.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tFileOutputDelimited_8", "tFileOutputDelimited_1", "tFileOutputDelimited");
				talendJobLogProcess(globalMap);
			}
			

String fileName_tFileOutputDelimited_8 = "";
    fileName_tFileOutputDelimited_8 = (new java.io.File("/data/talend/data_repository/TRFHDR.csv")).getAbsolutePath().replace("\\","/");
            ...
            final String OUT_DELIM_ROWSEP_tFileOutputDelimited_8 = /** Start field tFileOutputDelimited_8:ROWSEPARATOR */"\n"/** End field tFileOutputDelimited_8:ROWSEPARATOR */;
                    ...
                    if(directory_tFileOutputDelimited_8 != null && directory_tFileOutputDelimited_8.trim().length() != 0) {
                        ...
                        if(!dir_tFileOutputDelimited_8.exists()) {
                                log.info("tFileOutputDelimited_8 - Creating directory '" + dir_tFileOutputDelimited_8.getCanonicalPath() +"'.");
                            dir_tFileOutputDelimited_8.mkdirs();
                                log.info("tFileOutputDelimited_8 - The directory '"+ dir_tFileOutputDelimited_8.getCanonicalPath() + "' has been created successfully.");
                        }
                    }
                        ...
                        zipOut_tFileOutputDelimited_8.putNextEntry(new java.util.zip.ZipEntry(filetFileOutputDelimited_8.getName()));
                        outtFileOutputDelimited_8 = new java.io.BufferedWriter(new java.io.OutputStreamWriter(zipOut_tFileOutputDelimited_8,"ISO-8859-15"));
 ...
 */
	...
	currentComponent="tDBInput_8";
		...
		int tos_count_tDBInput_8 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_8{
                    ...
                    log4jParamters_tDBInput_8.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_8.append(" | ");
                            log4jParamters_tDBInput_8.append("PASS" + " = " + String.valueOf(routines.system.PasswordEncryptUtil.encryptPassword(context.jda_password)).substring(0, 4) + "...");     
                        log4jParamters_tDBInput_8.append(" | ");
                            log4jParamters_tDBInput_8.append("TABLE" + " = " + "\"\"");
                        log4jParamters_tDBInput_8.append(" | ");
                            log4jParamters_tDBInput_8.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_8.append(" | ");
                            log4jParamters_tDBInput_8.append("QUERY" + " = " + "\"  select * from MM4R5LIB.TRFHDR   where TRFIDT >= (VALUES  VARCHAR_FORMAT(CURRENT TIMESTAMP - 6 MONTHS, 'YYMMDD'))    \"");
                        log4jParamters_tDBInput_8.append(" | ");
                            log4jParamters_tDBInput_8.append("PROPERTIES" + " = " + "\"prompt=false\"");
                        log4jParamters_tDBInput_8.append(" | ");
                            log4jParamters_tDBInput_8.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_8.append(" | ");
                            log4jParamters_tDBInput_8.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("TRFBCH")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFSTS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFTYP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFPTY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFFLC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFTLC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFICN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFIDT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFBCN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFBDT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFSCN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFSDT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFRCN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFRDT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFINS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFDLC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFREF")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFPYN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRINIT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFPON")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFBON")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTUNT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTPCK")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTPLT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTCTN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTIPK")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTRTA")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTCST")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTCUB")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTUNP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTPLP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTCTP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTIPP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTRTP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTCSP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTPCU")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRPKLN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THCYCL")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THSCWV")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THSCSQ")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THSCNM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFXRF")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THCNYN")+"}]");
                        log4jParamters_tDBInput_8.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_8", "tDBInput_1", "tAS400Input");
				talendJobLogProcess(globalMap);
			}
	...
	final String decryptedPassword_tDBInput_8 = context.jda_password; 
				...
				String url_tDBInput_8 = "jdbc:as400://" + context.jda_host_name + "/" + context.jda_mm_lib + ";" + "prompt=false";
 ...
 */
	...
	currentComponent="tFileOutputDelimited_8";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row10","tDBInput_8","tDBInput_1","tAS400Input","tFileOutputDelimited_8","tFileOutputDelimited_1","tFileOutputDelimited"
    			...
    			if(log.isTraceEnabled()){
                    ...
                    StringBuilder sb_tFileOutputDelimited_8 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_8.append(
                            row10.TRFFLC.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.TRFTLC != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.TRFTLC.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                        sb_tFileOutputDelimited_8.append(
                        ...
                        sb_tFileOutputDelimited_8.append(
                            row10.TRFPON.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                        sb_tFileOutputDelimited_8.append(
                        ...
                        sb_tFileOutputDelimited_8.append(
                            row10.THTUNT.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.THTPCK != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.THTPCK.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.THTPLT != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.THTPLT.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.THTCTN != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.THTCTN.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.THTIPK != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.THTIPK.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.THTRTA != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.THTRTA.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.THTCST != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.THTCST.setScale(3, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.THTCUB != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.THTCUB.setScale(3, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.THTUNP != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.THTUNP.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.THTPLP != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.THTPLP.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.THTCTP != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.THTCTP.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.THTIPP != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.THTIPP.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.THTRTP != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.THTRTP.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.THTCSP != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.THTCSP.setScale(3, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.THTPCU != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.THTPCU.setScale(3, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.TRPKLN != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.TRPKLN.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                            if(row10.THCYCL != null) {
                        sb_tFileOutputDelimited_8.append(
                            row10.THCYCL.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_8.append(OUT_DELIM_tFileOutputDelimited_8);
                        sb_tFileOutputDelimited_8.append(
		...
		resourceMap.put("finish_tFileOutputDelimited_8", true);
				...
				log.debug("tFileOutputDelimited_8 - Written records count: " + nb_line_tFileOutputDelimited_8 + " .");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row10",2,0,
			 			"tDBInput_8","tDBInput_1","tAS400Input","tFileOutputDelimited_8","tFileOutputDelimited_1","tFileOutputDelimited","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBOutput_3";
		...
		int tos_count_tDBOutput_3 = 0;
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_3", "tDBOutput_1", "tSnowflakeOutput");
				talendJobLogProcess(globalMap);
			}
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_3_2_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"TRFBCH\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFBCH\",\"talend.field.dbColumnName\":\"TRFBCH\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFBCH\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFSTS\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFSTS\",\"talend.field.dbColumnName\":\"TRFSTS\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFSTS\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFTYP\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFTYP\",\"talend.field.dbColumnName\":\"TRFTYP\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFTYP\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFPTY\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFPTY\",\"talend.field.dbColumnName\":\"TRFPTY\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFPTY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFFLC\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFFLC\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRFFLC\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFFLC\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFTLC\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFTLC\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRFTLC\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFTLC\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFICN\",\"type\":[\"double\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFICN\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRFICN\",\"di.column.talendType\":\"id_Double\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFICN\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFIDT\",\"type\":[\"double\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFIDT\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRFIDT\",\"di.column.talendType\":\"id_Double\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFIDT\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFBCN\",\"type\":[\"double\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFBCN\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRFBCN\",\"di.column.talendType\":\"id_Double\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFBCN\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFBDT\",\"type\":[\"double\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFBDT\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRFBDT\",\"di.column.talendType\":\"id_Double\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFBDT\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFSCN\",\"type\":[\"double\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFSCN\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRFSCN\",\"di.column.talendType\":\"id_Double\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFSCN\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFSDT\",\"type\":[\"double\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFSDT\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRFSDT\",\"di.column.talendType\":\"id_Double\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFSDT\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFRCN\",\"type\":[\"double\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFRCN\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRFRCN\",\"di.column.talendType\":\"id_Double\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFRCN\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFRDT\",\"type\":[\"double\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFRDT\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRFRDT\",\"di.column.talendType\":\"id_Double\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFRDT\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFINS\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFINS\",\"talend.field.dbColumnName\":\"TRFINS\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFINS\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFDLC\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFDLC\",\"talend.field.dbColumnName\":\"TRFDLC\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFDLC\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFREF\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFREF\",\"talend.field.dbColumnName\":\"TRFREF\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFREF\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFPYN\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFPYN\",\"talend.field.dbColumnName\":\"TRFPYN\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFPYN\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRINIT\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRINIT\",\"talend.field.dbColumnName\":\"TRINIT\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRINIT\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFPON\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFPON\",\"talend.field.dbColumnName\":\"TRFPON\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFPON\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFBON\",\"type\":[\"double\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFBON\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRFBON\",\"di.column.talendType\":\"id_Double\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFBON\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THTUNT\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THTUNT\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THTUNT\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THTUNT\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THTPCK\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THTPCK\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THTPCK\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THTPCK\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THTPLT\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THTPLT\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THTPLT\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THTPLT\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THTCTN\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THTCTN\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THTCTN\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THTCTN\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THTIPK\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THTIPK\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THTIPK\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THTIPK\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THTRTA\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THTRTA\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THTRTA\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THTRTA\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THTCST\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THTCST\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THTCST\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THTCST\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THTCUB\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THTCUB\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THTCUB\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THTCUB\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THTUNP\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THTUNP\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THTUNP\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THTUNP\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THTPLP\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THTPLP\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THTPLP\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THTPLP\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THTCTP\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THTCTP\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THTCTP\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THTCTP\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THTIPP\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THTIPP\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THTIPP\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THTIPP\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THTRTP\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THTRTP\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THTRTP\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THTRTP\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"THTPCU\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THTPCU\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THTPCU\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THTPCU\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRPKLN\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRPKLN\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRPKLN\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRPKLN\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THCYCL\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THCYCL\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THCYCL\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THCYCL\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THSCWV\",\"type\":[\"double\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THSCWV\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THSCWV\",\"di.column.talendType\":\"id_Double\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THSCWV\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THSCSQ\",\"type\":[\"double\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THSCSQ\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THSCSQ\",\"di.column.talendType\":\"id_Double\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THSCSQ\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THSCNM\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THSCNM\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THSCNM\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THSCNM\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFXRF\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TRFXRF\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TRFXRF\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TRFXRF\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"THCNYN\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"THCNYN\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"THCNYN\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"THCNYN\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tDBOutput_3\",\"di.table.label\":\"tDBOutput_3\"}",s);
 ...
 */
	...
	currentComponent="tFileInputDelimited_12";
		...
		int tos_count_tFileInputDelimited_12 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileInputDelimited_12{
                    ...
                    log4jParamters_tFileInputDelimited_12.append("Parameters:");
                            log4jParamters_tFileInputDelimited_12.append("FILENAME" + " = " + "\"/data/talend/data_repository/TRFHDR.zip\"");
                        ...
                        log4jParamters_tFileInputDelimited_12.append(" | ");
                            log4jParamters_tFileInputDelimited_12.append("TRIMSELECT" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("TRFBCH")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFSTS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFTYP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFPTY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFFLC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFTLC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFICN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFIDT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFBCN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFBDT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFSCN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFSDT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFRCN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFRDT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFINS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFDLC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFREF")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFPYN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRINIT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFPON")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFBON")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTUNT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTPCK")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTPLT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTCTN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTIPK")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTRTA")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTCST")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTCUB")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTUNP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTPLP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTCTP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTIPP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTRTP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTCSP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THTPCU")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRPKLN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THCYCL")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THSCWV")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THSCSQ")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THSCNM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFXRF")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("THCNYN")+"}]");
                        log4jParamters_tFileInputDelimited_12.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tFileInputDelimited_12", "tFileInputDelimited_1", "tFileInputDelimited");
				talendJobLogProcess(globalMap);
			}
				...
				try{
						...
						try {
							if(filename_tFileInputDelimited_12 instanceof java.io.InputStream){
								zis_tFileInputDelimited_12 = new java.util.zip.ZipInputStream(new java.io.BufferedInputStream((java.io.InputStream)filename_tFileInputDelimited_12));
							}else{
								zis_tFileInputDelimited_12 = new java.util.zip.ZipInputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(String.valueOf(filename_tFileInputDelimited_12))));
							}
						} catch(java.lang.Exception e) {
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",e.getMessage());
							...
							try {
								fid_tFileInputDelimited_12 = new org.talend.fileprocess.FileInputDelimited(zis_tFileInputDelimited_12, "ISO-8859-15",",","\n",false,1,0,
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFFLC", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFTLC", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFICN", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_12.setException(new RuntimeException("Value is empty for column : 'TRFICN' in 'row2' connection, value is invalid or this column should be nullable or have a default value."));
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFIDT", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_12.setException(new RuntimeException("Value is empty for column : 'TRFIDT' in 'row2' connection, value is invalid or this column should be nullable or have a default value."));
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFBCN", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_12.setException(new RuntimeException("Value is empty for column : 'TRFBCN' in 'row2' connection, value is invalid or this column should be nullable or have a default value."));
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFBDT", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_12.setException(new RuntimeException("Value is empty for column : 'TRFBDT' in 'row2' connection, value is invalid or this column should be nullable or have a default value."));
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFSCN", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_12.setException(new RuntimeException("Value is empty for column : 'TRFSCN' in 'row2' connection, value is invalid or this column should be nullable or have a default value."));
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFSDT", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_12.setException(new RuntimeException("Value is empty for column : 'TRFSDT' in 'row2' connection, value is invalid or this column should be nullable or have a default value."));
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFRCN", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_12.setException(new RuntimeException("Value is empty for column : 'TRFRCN' in 'row2' connection, value is invalid or this column should be nullable or have a default value."));
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFRDT", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_12.setException(new RuntimeException("Value is empty for column : 'TRFRDT' in 'row2' connection, value is invalid or this column should be nullable or have a default value."));
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFBON", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_12.setException(new RuntimeException("Value is empty for column : 'TRFBON' in 'row2' connection, value is invalid or this column should be nullable or have a default value."));
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THTUNT", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THTPCK", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THTPLT", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THTCTN", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THTIPK", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THTRTA", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THTCST", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THTCUB", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THTUNP", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THTPLP", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THTCTP", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THTIPP", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THTRTP", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THTCSP", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THTPCU", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRPKLN", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THCYCL", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THSCWV", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_12.setException(new RuntimeException("Value is empty for column : 'THSCWV' in 'row2' connection, value is invalid or this column should be nullable or have a default value."));
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",ex_tFileInputDelimited_12.getMessage());
									rowstate_tFileInputDelimited_12.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"THSCSQ", "row2", temp, ex_tFileInputDelimited_12), ex_tFileInputDelimited_12));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_12.setException(new RuntimeException("Value is empty for column : 'THSCSQ' in 'row2' connection, value is invalid or this column should be nullable or have a default value."));
...
globalMap.put("tFileInputDelimited_12_ERROR_MESSAGE",e.getMessage());
			...
			log.debug("tFileInputDelimited_12 - Retrieving the record " + fid_tFileInputDelimited_12.getRowNumber() + ".");
...
if(row2 != null) { 
	...
	currentComponent="tDBOutput_3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tFileInputDelimited_12","tFileInputDelimited_1","tFileInputDelimited","tDBOutput_3","tDBOutput_1","tSnowflakeOutput"
        ...
        if (incomingEnforcer_tDBOutput_3 != null) {
            incomingEnforcer_tDBOutput_3.createNewRecord();
                ...
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFBCH") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFBCH", row2.TRFBCH);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFSTS") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFSTS", row2.TRFSTS);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFTYP") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFTYP", row2.TRFTYP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFPTY") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFPTY", row2.TRFPTY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFFLC") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFFLC", row2.TRFFLC);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFTLC") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFTLC", row2.TRFTLC);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFICN") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFICN", row2.TRFICN);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFIDT") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFIDT", row2.TRFIDT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFBCN") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFBCN", row2.TRFBCN);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFBDT") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFBDT", row2.TRFBDT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFSCN") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFSCN", row2.TRFSCN);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFSDT") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFSDT", row2.TRFSDT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFRCN") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFRCN", row2.TRFRCN);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFRDT") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFRDT", row2.TRFRDT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFINS") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFINS", row2.TRFINS);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFDLC") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFDLC", row2.TRFDLC);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFREF") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFREF", row2.TRFREF);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFPYN") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFPYN", row2.TRFPYN);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRINIT") != null){
                    incomingEnforcer_tDBOutput_3.put("TRINIT", row2.TRINIT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFPON") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFPON", row2.TRFPON);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFBON") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFBON", row2.TRFBON);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THTUNT") != null){
                    incomingEnforcer_tDBOutput_3.put("THTUNT", row2.THTUNT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THTPCK") != null){
                    incomingEnforcer_tDBOutput_3.put("THTPCK", row2.THTPCK);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THTPLT") != null){
                    incomingEnforcer_tDBOutput_3.put("THTPLT", row2.THTPLT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THTCTN") != null){
                    incomingEnforcer_tDBOutput_3.put("THTCTN", row2.THTCTN);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THTIPK") != null){
                    incomingEnforcer_tDBOutput_3.put("THTIPK", row2.THTIPK);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THTRTA") != null){
                    incomingEnforcer_tDBOutput_3.put("THTRTA", row2.THTRTA);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THTCST") != null){
                    incomingEnforcer_tDBOutput_3.put("THTCST", row2.THTCST);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THTCUB") != null){
                    incomingEnforcer_tDBOutput_3.put("THTCUB", row2.THTCUB);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THTUNP") != null){
                    incomingEnforcer_tDBOutput_3.put("THTUNP", row2.THTUNP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THTPLP") != null){
                    incomingEnforcer_tDBOutput_3.put("THTPLP", row2.THTPLP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THTCTP") != null){
                    incomingEnforcer_tDBOutput_3.put("THTCTP", row2.THTCTP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THTIPP") != null){
                    incomingEnforcer_tDBOutput_3.put("THTIPP", row2.THTIPP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THTRTP") != null){
                    incomingEnforcer_tDBOutput_3.put("THTRTP", row2.THTRTP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THTCSP") != null){
                    incomingEnforcer_tDBOutput_3.put("THTCSP", row2.THTCSP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THTPCU") != null){
                    incomingEnforcer_tDBOutput_3.put("THTPCU", row2.THTPCU);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRPKLN") != null){
                    incomingEnforcer_tDBOutput_3.put("TRPKLN", row2.TRPKLN);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THCYCL") != null){
                    incomingEnforcer_tDBOutput_3.put("THCYCL", row2.THCYCL);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THSCWV") != null){
                    incomingEnforcer_tDBOutput_3.put("THSCWV", row2.THSCWV);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THSCSQ") != null){
                    incomingEnforcer_tDBOutput_3.put("THSCSQ", row2.THSCSQ);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THSCNM") != null){
                    incomingEnforcer_tDBOutput_3.put("THSCNM", row2.THSCNM);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("TRFXRF") != null){
                    incomingEnforcer_tDBOutput_3.put("TRFXRF", row2.TRFXRF);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("THCNYN") != null){
	...
	currentComponent="tFileInputDelimited_12";
            ...
            if(fid_tFileInputDelimited_12!=null){
            	globalMap.put("tFileInputDelimited_12_NB_LINE", nb_line_tFileInputDelimited_12);
						...
						log.info("tFileInputDelimited_12- Retrieved records count: "+ nb_line_tFileInputDelimited_12 + ".");
		...
		default :
			...
			break;
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tFileInputDelimited_12","tFileInputDelimited_1","tFileInputDelimited","tDBOutput_3","tDBOutput_1","tSnowflakeOutput","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBRow_7";
		...
		int tos_count_tDBRow_7 = 0;
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBRow_7", "tDBRow_1", "tSnowflakeRow");
				talendJobLogProcess(globalMap);
			}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileDelete_1{
                    ...
                    log4jParamters_tFileDelete_1.append("Parameters:");
                            log4jParamters_tFileDelete_1.append("PATH" + " = " + "\"/data/talend/data_repository/TRFHDR.zip\"");
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'TRANSFER_HEADER_TRFHDR' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-06-29T14:04:41.792843200Z");
        ...
        try {
            ...
            java.io.InputStream inContext = TRANSFER_HEADER_TRFHDR.class.getClassLoader().getResourceAsStream("at_talend_jobs/transfer_header_trfhdr_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = TRANSFER_HEADER_TRFHDR.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
final Thread launchingThread = Thread.currentThread();
        ...
        new Thread(){
            public void run() {
                ...
                try {
((java.util.Map) threadLocal.get()).put("errorCode", null);tDBRow_5Process(globalMap);
...
globalMap.put("tDBRow_5_SUBPROCESS_STATE", -1);
((java.util.Map) threadLocal.get()).put("status", "failure");throw e_tDBRow_5;
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TRANSFER_HEADER_TRFHDR");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     433304 characters generated by Talend Cloud Data Management Platform 
 *     on the June 29, 2023 at 10:04:41 AM EDT
 ************************************************************************************************/