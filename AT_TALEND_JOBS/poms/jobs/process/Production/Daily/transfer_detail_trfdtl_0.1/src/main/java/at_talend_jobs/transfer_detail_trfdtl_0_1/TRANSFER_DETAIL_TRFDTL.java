...
public class TRANSFER_DETAIL_TRFDTL implements TalendJob {
	static {System.setProperty("TalendJob.log", "TRANSFER_DETAIL_TRFDTL.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(TRANSFER_DETAIL_TRFDTL.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_JoEzMDZLEeqYYKudWeBa8Q", "0.1");
...
org.talend.components.snowflake.SnowflakeConnectionProperties props_tDBConnection_1 =
        (org.talend.components.snowflake.SnowflakeConnectionProperties) def_tDBConnection_1.createRuntimeProperties();
 		                    ...
 		                    "Talend_user");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:kL9ffP8fnA7xjQ25SCtTkxM72/X4smJCY/npiZyj4pfi13HN"));
                ...
                class BytesLimit65535_tFileOutputDelimited_6{
                    ...
                    log4jParamters_tFileOutputDelimited_6.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_6.append(" | ");
                            log4jParamters_tFileOutputDelimited_6.append("FILENAME" + " = " + "\"/data/talend/data_repository/TRFDTL.csv\"");
                        log4jParamters_tFileOutputDelimited_6.append(" | ");
...
String fileName_tFileOutputDelimited_6 = "";
    fileName_tFileOutputDelimited_6 = (new java.io.File("/data/talend/data_repository/TRFDTL.csv")).getAbsolutePath().replace("\\","/");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_6{
                    ...
                    log4jParamters_tDBInput_6.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_6.append(" | ");
                            log4jParamters_tDBInput_6.append("QUERY" + " = " + "\"  select * from TRFDTL where TRFBCH in   (  select TRFBCH from MM4R5LIB.TRFHDR  where TRFIDT between (VALUES  VARCHAR_FORMAT(CURRENT TIMESTAMP - 6 MONTHS, 'YYMMDD')) and (VALUES  VARCHAR_FORMAT(CURRENT TIMESTAMP, 'YYMMDD'))  )    \"");
                        log4jParamters_tDBInput_6.append(" | ");
                            log4jParamters_tDBInput_6.append("PROPERTIES" + " = " + "\"prompt=false\"");
                        log4jParamters_tDBInput_6.append(" | ");
                            log4jParamters_tDBInput_6.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_6.append(" | ");
                            log4jParamters_tDBInput_6.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("TRFBCH")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFFLC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFTLC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("INUMBR")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ASNUM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IDEPT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ISDEPT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ICLAS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ISCLAS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFREQ")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFSHP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFREC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFALC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFSUB")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFSCD")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFRLC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFCST")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFRIN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFROU")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ICUBE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IVNDPN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFSTS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFTYP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFPTY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TDCYCL")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TDSCWV")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TDSCSQ")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TDSCNM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRSVND")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRSTYL")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRSCOL")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRSSIZ")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRSDIM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFDSP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TDSCQT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TDRCQT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TDWGHT")+"}]");
                        log4jParamters_tDBInput_6.append(" | ");
 ...
 */
	...
	currentComponent="tFileOutputDelimited_6";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row11","tDBInput_6","tDBInput_1","tAS400Input","tFileOutputDelimited_6","tFileOutputDelimited_1","tFileOutputDelimited"
    			...
    			if(log.isTraceEnabled()){
                    ...
                    StringBuilder sb_tFileOutputDelimited_6 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_6.append(
                            row11.TRFFLC.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                            if(row11.TRFTLC != null) {
                        sb_tFileOutputDelimited_6.append(
                            row11.TRFTLC.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                            if(row11.INUMBR != null) {
                        sb_tFileOutputDelimited_6.append(
                            row11.INUMBR.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                        sb_tFileOutputDelimited_6.append(
                        ...
                        sb_tFileOutputDelimited_6.append(
                            row11.TRFREQ.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                            if(row11.TRFSHP != null) {
                        sb_tFileOutputDelimited_6.append(
                            row11.TRFSHP.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                            if(row11.TRFREC != null) {
                        sb_tFileOutputDelimited_6.append(
                            row11.TRFREC.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                            if(row11.TRFALC != null) {
                        sb_tFileOutputDelimited_6.append(
                            row11.TRFALC.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                            if(row11.TRFSUB != null) {
                        sb_tFileOutputDelimited_6.append(
                            row11.TRFSUB.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                        ...
                        sb_tFileOutputDelimited_6.append(
                            row11.TRFCST.setScale(3, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                            if(row11.TRFRIN != null) {
                        sb_tFileOutputDelimited_6.append(
                            row11.TRFRIN.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                            if(row11.TRFROU != null) {
                        sb_tFileOutputDelimited_6.append(
                            row11.TRFROU.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                            if(row11.ICUBE != null) {
                        sb_tFileOutputDelimited_6.append(
                            row11.ICUBE.setScale(3, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                        ...
                        sb_tFileOutputDelimited_6.append(
                            row11.TDCYCL.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                        sb_tFileOutputDelimited_6.append(
                        ...
                        sb_tFileOutputDelimited_6.append(
                            row11.TDSCQT.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                            if(row11.TDRCQT != null) {
                        sb_tFileOutputDelimited_6.append(
                            row11.TDRCQT.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_6.append(OUT_DELIM_tFileOutputDelimited_6);
                            if(row11.TDWGHT != null) {
                        sb_tFileOutputDelimited_6.append(
                            row11.TDWGHT.setScale(3, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_5_2_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"TRFBCH\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":8,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TRFBCH\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFFLC\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":5,\"talend.field.scale\":0,\"talend.field.dbType\":-5,\"talend.field.dbColumnName\":\"TRFFLC\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFTLC\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":5,\"talend.field.scale\":0,\"talend.field.dbType\":-5,\"talend.field.dbColumnName\":\"TRFTLC\",\"talend.field.default\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"TRFREQ\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":9,\"talend.field.scale\":2,\"talend.field.dbType\":3,\"talend.field.dbColumnName\":\"TRFREQ\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFSHP\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":9,\"talend.field.scale\":2,\"talend.field.dbType\":3,\"talend.field.dbColumnName\":\"TRFSHP\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFREC\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":9,\"talend.field.scale\":2,\"talend.field.dbType\":3,\"talend.field.dbColumnName\":\"TRFREC\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFALC\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":9,\"talend.field.scale\":2,\"talend.field.dbType\":3,\"talend.field.dbColumnName\":\"TRFALC\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFSUB\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":9,\"talend.field.scale\":0,\"talend.field.dbType\":-5,\"talend.field.dbColumnName\":\"TRFSUB\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFSCD\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":1,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TRFSCD\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFRLC\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":8,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TRFRLC\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFCST\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":9,\"talend.field.scale\":3,\"talend.field.dbType\":3,\"talend.field.dbColumnName\":\"TRFCST\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFRIN\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":9,\"talend.field.scale\":2,\"talend.field.dbType\":3,\"talend.field.dbColumnName\":\"TRFRIN\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFROU\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":9,\"talend.field.scale\":2,\"talend.field.dbType\":3,\"talend.field.dbColumnName\":\"TRFROU\",\"talend.field.default\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"TRFSTS\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":1,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TRFSTS\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFTYP\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":1,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TRFTYP\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFPTY\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":1,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TRFPTY\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TDCYCL\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":5,\"talend.field.scale\":0,\"talend.field.dbType\":-5,\"talend.field.dbColumnName\":\"TDCYCL\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TDSCWV\",\"type\":[\"double\",\"null\"],\"default\":\"\",\"talend.field.dbType\":8,\"talend.field.dbColumnName\":\"TDSCWV\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TDSCSQ\",\"type\":[\"double\",\"null\"],\"default\":\"\",\"talend.field.dbType\":8,\"talend.field.dbColumnName\":\"TDSCSQ\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TDSCNM\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":8,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TDSCNM\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRSVND\",\"type\":[\"double\",\"null\"],\"default\":\"\",\"talend.field.dbType\":8,\"talend.field.dbColumnName\":\"TRSVND\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRSTYL\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":15,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TRSTYL\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRSCOL\",\"type\":[\"double\",\"null\"],\"default\":\"\",\"talend.field.dbType\":8,\"talend.field.dbColumnName\":\"TRSCOL\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRSSIZ\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":4,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TRSSIZ\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRSDIM\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":4,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TRSDIM\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TRFDSP\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":1,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TRFDSP\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TDSCQT\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":9,\"talend.field.scale\":2,\"talend.field.dbType\":3,\"talend.field.dbColumnName\":\"TDSCQT\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TDRCQT\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":9,\"talend.field.scale\":2,\"talend.field.dbType\":3,\"talend.field.dbColumnName\":\"TDRCQT\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TDWGHT\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":7,\"talend.field.scale\":3,\"talend.field.dbType\":3,\"talend.field.dbColumnName\":\"TDWGHT\",\"talend.field.default\":\"\"},{",s);
 ...
 */
	...
	currentComponent="tFileInputDelimited_4";
		...
		int tos_count_tFileInputDelimited_4 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileInputDelimited_4{
                    ...
                    log4jParamters_tFileInputDelimited_4.append("Parameters:");
                            log4jParamters_tFileInputDelimited_4.append("FILENAME" + " = " + "\"/data/talend/data_repository/TRFDTL.zip\"");
                        ...
                        log4jParamters_tFileInputDelimited_4.append(" | ");
                            log4jParamters_tFileInputDelimited_4.append("TRIMSELECT" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("TRFBCH")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFFLC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFTLC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("INUMBR")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ASNUM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IDEPT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ISDEPT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ICLAS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ISCLAS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFREQ")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFSHP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFREC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFALC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFSUB")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFSCD")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFRLC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFCST")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFRIN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFROU")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ICUBE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IVNDPN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFSTS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFTYP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFPTY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TDCYCL")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TDSCWV")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TDSCSQ")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TDSCNM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRSVND")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRSTYL")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRSCOL")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRSSIZ")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRSDIM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TRFDSP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TDSCQT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TDRCQT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TDWGHT")+"}]");
                        log4jParamters_tFileInputDelimited_4.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tFileInputDelimited_4", "tFileInputDelimited_1", "tFileInputDelimited");
				talendJobLogProcess(globalMap);
			}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFFLC", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFTLC", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ASNUM", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"IDEPT", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ISDEPT", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ICLAS", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ISCLAS", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFREQ", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFSHP", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFREC", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFALC", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFSUB", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFCST", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFRIN", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRFROU", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ICUBE", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TDCYCL", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TDSCWV", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TDSCSQ", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRSVND", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TRSCOL", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TDSCQT", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TDRCQT", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
globalMap.put("tFileInputDelimited_4_ERROR_MESSAGE",ex_tFileInputDelimited_4.getMessage());
									rowstate_tFileInputDelimited_4.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TDWGHT", "row13", temp, ex_tFileInputDelimited_4), ex_tFileInputDelimited_4));
								}
...
if(row13 != null) { 
	...
	currentComponent="tMap_5";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row13","tFileInputDelimited_4","tFileInputDelimited_1","tFileInputDelimited","tMap_5","tMap_1","tMap"
...
TRFDTL = TRFDTL_tmp;
log.debug("tMap_5 - Outputting the record " + count_TRFDTL_tMap_5 + " of the output table 'TRFDTL'.");
...
if(TRFDTL != null) { 
	...
	currentComponent="tDBOutput_5";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"TRFDTL","tMap_5","tMap_1","tMap","tDBOutput_5","tDBOutput_1","tSnowflakeOutput"
        ...
        if (incomingEnforcer_tDBOutput_5 != null) {
            incomingEnforcer_tDBOutput_5.createNewRecord();
                ...
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFBCH") != null){
                    incomingEnforcer_tDBOutput_5.put("TRFBCH", TRFDTL.TRFBCH);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFFLC") != null){
                    incomingEnforcer_tDBOutput_5.put("TRFFLC", TRFDTL.TRFFLC);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFTLC") != null){
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("ASNUM") != null){
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFREQ") != null){
                    incomingEnforcer_tDBOutput_5.put("TRFREQ", TRFDTL.TRFREQ);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFSHP") != null){
                    incomingEnforcer_tDBOutput_5.put("TRFSHP", TRFDTL.TRFSHP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFREC") != null){
                    incomingEnforcer_tDBOutput_5.put("TRFREC", TRFDTL.TRFREC);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFALC") != null){
                    incomingEnforcer_tDBOutput_5.put("TRFALC", TRFDTL.TRFALC);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFSUB") != null){
                    incomingEnforcer_tDBOutput_5.put("TRFSUB", TRFDTL.TRFSUB);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFSCD") != null){
                    incomingEnforcer_tDBOutput_5.put("TRFSCD", TRFDTL.TRFSCD);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFRLC") != null){
                    incomingEnforcer_tDBOutput_5.put("TRFRLC", TRFDTL.TRFRLC);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFCST") != null){
                    incomingEnforcer_tDBOutput_5.put("TRFCST", TRFDTL.TRFCST);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFRIN") != null){
                    incomingEnforcer_tDBOutput_5.put("TRFRIN", TRFDTL.TRFRIN);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFROU") != null){
                    incomingEnforcer_tDBOutput_5.put("TRFROU", TRFDTL.TRFROU);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("ICUBE") != null){
                    incomingEnforcer_tDBOutput_5.put("ICUBE", TRFDTL.ICUBE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("IVNDPN") != null){
                    incomingEnforcer_tDBOutput_5.put("IVNDPN", TRFDTL.IVNDPN);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFSTS") != null){
                    incomingEnforcer_tDBOutput_5.put("TRFSTS", TRFDTL.TRFSTS);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFTYP") != null){
                    incomingEnforcer_tDBOutput_5.put("TRFTYP", TRFDTL.TRFTYP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFPTY") != null){
                    incomingEnforcer_tDBOutput_5.put("TRFPTY", TRFDTL.TRFPTY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TDCYCL") != null){
                    incomingEnforcer_tDBOutput_5.put("TDCYCL", TRFDTL.TDCYCL);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TDSCWV") != null){
                    incomingEnforcer_tDBOutput_5.put("TDSCWV", TRFDTL.TDSCWV);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TDSCSQ") != null){
                    incomingEnforcer_tDBOutput_5.put("TDSCSQ", TRFDTL.TDSCSQ);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TDSCNM") != null){
                    incomingEnforcer_tDBOutput_5.put("TDSCNM", TRFDTL.TDSCNM);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRSVND") != null){
                    incomingEnforcer_tDBOutput_5.put("TRSVND", TRFDTL.TRSVND);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRSTYL") != null){
                    incomingEnforcer_tDBOutput_5.put("TRSTYL", TRFDTL.TRSTYL);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRSCOL") != null){
                    incomingEnforcer_tDBOutput_5.put("TRSCOL", TRFDTL.TRSCOL);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRSSIZ") != null){
                    incomingEnforcer_tDBOutput_5.put("TRSSIZ", TRFDTL.TRSSIZ);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRSDIM") != null){
                    incomingEnforcer_tDBOutput_5.put("TRSDIM", TRFDTL.TRSDIM);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TRFDSP") != null){
                    incomingEnforcer_tDBOutput_5.put("TRFDSP", TRFDTL.TRFDSP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TDSCQT") != null){
                    incomingEnforcer_tDBOutput_5.put("TDSCQT", TRFDTL.TDSCQT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TDRCQT") != null){
                    incomingEnforcer_tDBOutput_5.put("TDRCQT", TRFDTL.TDRCQT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("TDWGHT") != null){
                    incomingEnforcer_tDBOutput_5.put("TDWGHT", TRFDTL.TDWGHT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_5 != null && incomingEnforcer_tDBOutput_5.getRuntimeSchema().getField("LOAD_DATE") != null){
...
// ###############################      
				log.debug("tMap_5 - Written records count in the table 'TRFDTL': " + count_TRFDTL_tMap_5 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row13",2,0,
			 			"tFileInputDelimited_4","tFileInputDelimited_1","tFileInputDelimited","tMap_5","tMap_1","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	for(java.util.Map.Entry<String,Object> entry_tDBOutput_5 : resultMap_tDBOutput_5.entrySet()) {
		...
		default :
			...
			break;
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"TRFDTL",2,0,
			 			"tMap_5","tMap_1","tMap","tDBOutput_5","tDBOutput_1","tSnowflakeOutput","output")) {
						talendJobLogProcess(globalMap);
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileDelete_1{
                    ...
                    log4jParamters_tFileDelete_1.append("Parameters:");
                            log4jParamters_tFileDelete_1.append("PATH" + " = " + "\"/data/talend/data_repository/TRFDTL.zip\"");
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'TRANSFER_DETAIL_TRFDTL' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-06-29T13:28:23.874479600Z");
        ...
        try {
            ...
            java.io.InputStream inContext = TRANSFER_DETAIL_TRFDTL.class.getClassLoader().getResourceAsStream("at_talend_jobs/transfer_detail_trfdtl_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = TRANSFER_DETAIL_TRFDTL.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TRANSFER_DETAIL_TRFDTL");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     415522 characters generated by Talend Cloud Data Management Platform 
 *     on the June 29, 2023 at 9:28:23 AM EDT
 ************************************************************************************************/