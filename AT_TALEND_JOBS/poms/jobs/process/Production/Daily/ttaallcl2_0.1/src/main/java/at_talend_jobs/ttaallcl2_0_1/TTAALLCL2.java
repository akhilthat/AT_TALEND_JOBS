...
public class TTAALLCL2 implements TalendJob {
	static {System.setProperty("TalendJob.log", "TTAALLCL2.log");}
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_nEGQgAVwEeqgh6rCafRRhA", "0.1");
...
org.talend.components.snowflake.SnowflakeConnectionProperties props_tDBConnection_1 =
        (org.talend.components.snowflake.SnowflakeConnectionProperties) def_tDBConnection_1.createRuntimeProperties();
 		                    ...
 		                    "Talend_user");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:qLRScne4mKhxmm4Y+RI6QvqKwzdR1rW4JMD/AUIah4bq2BqU"));
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tFileOutputDelimited_15";
		...
		int tos_count_tFileOutputDelimited_15 = 0;
                ...
                class BytesLimit65535_tFileOutputDelimited_15{
                    ...
                    log4jParamters_tFileOutputDelimited_15.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_15.append(" | ");
                            log4jParamters_tFileOutputDelimited_15.append("FILENAME" + " = " + "\"/data/talend/data_repository/INZTAG.csv\"");
                        log4jParamters_tFileOutputDelimited_15.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tFileOutputDelimited_15", "tFileOutputDelimited_1", "tFileOutputDelimited");
				talendJobLogProcess(globalMap);
			}
			

String fileName_tFileOutputDelimited_15 = "";
    fileName_tFileOutputDelimited_15 = (new java.io.File("/data/talend/data_repository/INZTAG.csv")).getAbsolutePath().replace("\\","/");
            ...
            final String OUT_DELIM_ROWSEP_tFileOutputDelimited_15 = /** Start field tFileOutputDelimited_15:ROWSEPARATOR */"\n"/** End field tFileOutputDelimited_15:ROWSEPARATOR */;
                    ...
                    if(directory_tFileOutputDelimited_15 != null && directory_tFileOutputDelimited_15.trim().length() != 0) {
                        ...
                        if(!dir_tFileOutputDelimited_15.exists()) {
                                log.info("tFileOutputDelimited_15 - Creating directory '" + dir_tFileOutputDelimited_15.getCanonicalPath() +"'.");
                            dir_tFileOutputDelimited_15.mkdirs();
                                log.info("tFileOutputDelimited_15 - The directory '"+ dir_tFileOutputDelimited_15.getCanonicalPath() + "' has been created successfully.");
                        }
                    }
                        ...
                        zipOut_tFileOutputDelimited_15= new java.util.zip.ZipOutputStream(
                                new java.io.BufferedOutputStream(new java.io.FileOutputStream(zipName_tFileOutputDelimited_15)));
                        zipOut_tFileOutputDelimited_15.putNextEntry(new java.util.zip.ZipEntry(filetFileOutputDelimited_15.getName()));
                        outtFileOutputDelimited_15 = new java.io.BufferedWriter(new java.io.OutputStreamWriter(zipOut_tFileOutputDelimited_15,"ISO-8859-15"));
 ...
 */
	...
	currentComponent="tDBInput_21";
		...
		int tos_count_tDBInput_21 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_21{
                    ...
                    log4jParamters_tDBInput_21.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_21.append(" | ");
                            log4jParamters_tDBInput_21.append("PASS" + " = " + String.valueOf(routines.system.PasswordEncryptUtil.encryptPassword(context.jda_password)).substring(0, 4) + "...");     
                        log4jParamters_tDBInput_21.append(" | ");
                        ...
                        log4jParamters_tDBInput_21.append(" | ");
                            log4jParamters_tDBInput_21.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("INUMBR")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGAMT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGFRM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGAUM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TASUOM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGSRV")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TASNUM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGVIT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGCTG")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("SUBSKU")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CMPSKU")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("UPSSKU")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("SAVSKU")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IMGNM1")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IMGNM2")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IMGNM3")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IMGNM4")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IMGNM5")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGAUT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TASHLF")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TADYEX")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CRTCEN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CRTDAT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGCLR")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGSIZ")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGFLV")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGSNT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CSWGHT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CSLGTH")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CSWDTH")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CSHGHT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CSCUBE")+"}]");
                        log4jParamters_tDBInput_21.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_21", "tDBInput_1", "tAS400Input");
				talendJobLogProcess(globalMap);
			}
	...
	final String decryptedPassword_tDBInput_21 = context.jda_password; 
				...
				String url_tDBInput_21 = "jdbc:as400://" + context.jda_host_name + "/" + context.jda_mm_lib + ";" + "prompt=false";
				
	    		log.debug("tDBInput_21 - Driver ClassName: "+driverClass_tDBInput_21+".");
			
	    		log.debug("tDBInput_21 - Connection attempt to '" + url_tDBInput_21 + "' with the username '" + dbUser_tDBInput_21 + "'.");
 ...
 */
	...
	currentComponent="tFileOutputDelimited_15";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row30","tDBInput_21","tDBInput_1","tAS400Input","tFileOutputDelimited_15","tFileOutputDelimited_1","tFileOutputDelimited"
    			...
    			if(log.isTraceEnabled()){
                    ...
                    StringBuilder sb_tFileOutputDelimited_15 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_15.append(
                            row30.INUMBR.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_15.append(OUT_DELIM_tFileOutputDelimited_15);
                            if(row30.TAGAMT != null) {
                        sb_tFileOutputDelimited_15.append(
                            row30.TAGAMT.setScale(2, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_15.append(OUT_DELIM_tFileOutputDelimited_15);
                        ...
                        sb_tFileOutputDelimited_15.append(
                            row30.TASNUM.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_15.append(OUT_DELIM_tFileOutputDelimited_15);
                        ...
                        sb_tFileOutputDelimited_15.append(
                            row30.SUBSKU.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_15.append(OUT_DELIM_tFileOutputDelimited_15);
                            if(row30.CMPSKU != null) {
                        sb_tFileOutputDelimited_15.append(
                            row30.CMPSKU.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_15.append(OUT_DELIM_tFileOutputDelimited_15);
                            if(row30.UPSSKU != null) {
                        sb_tFileOutputDelimited_15.append(
                            row30.UPSSKU.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_15.append(OUT_DELIM_tFileOutputDelimited_15);
                            if(row30.SAVSKU != null) {
                        sb_tFileOutputDelimited_15.append(
                            row30.SAVSKU.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_15.append(OUT_DELIM_tFileOutputDelimited_15);
                        ...
                        sb_tFileOutputDelimited_15.append(
                            row30.TADYEX.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_15.append(OUT_DELIM_tFileOutputDelimited_15);
                        sb_tFileOutputDelimited_15.append(
                        ...
                        sb_tFileOutputDelimited_15.append(
                            row30.CSWGHT.setScale(3, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_15.append(OUT_DELIM_tFileOutputDelimited_15);
                            if(row30.CSLGTH != null) {
                        sb_tFileOutputDelimited_15.append(
                            row30.CSLGTH.setScale(1, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_15.append(OUT_DELIM_tFileOutputDelimited_15);
                            if(row30.CSWDTH != null) {
                        sb_tFileOutputDelimited_15.append(
                            row30.CSWDTH.setScale(1, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_15.append(OUT_DELIM_tFileOutputDelimited_15);
                            if(row30.CSHGHT != null) {
                        sb_tFileOutputDelimited_15.append(
                            row30.CSHGHT.setScale(1, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_15.append(OUT_DELIM_tFileOutputDelimited_15);
                            if(row30.CSCUBE != null) {
                        sb_tFileOutputDelimited_15.append(
                            row30.CSCUBE.setScale(3, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
		...
		resourceMap.put("finish_tFileOutputDelimited_15", true);
				...
				log.debug("tFileOutputDelimited_15 - Written records count: " + nb_line_tFileOutputDelimited_15 + " .");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row30",2,0,
			 			"tDBInput_21","tDBInput_1","tAS400Input","tFileOutputDelimited_15","tFileOutputDelimited_1","tFileOutputDelimited","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tDBInput_21:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
INZTAGStruct INZTAG = new INZTAGStruct();
	...
	currentComponent="tDBOutput_16";
		...
		int tos_count_tDBOutput_16 = 0;
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_16", "tDBOutput_1", "tSnowflakeOutput");
				talendJobLogProcess(globalMap);
			}
...
@SuppressWarnings("unchecked")
java.util.Map<String, Object> restRequest_tDBOutput_16 = (java.util.Map<String, Object>)globalMap.get("restRequest");
String currentTRestRequestOperation_tDBOutput_16 = (String)(restRequest_tDBOutput_16 != null ? restRequest_tDBOutput_16.get("OPERATION") : null);

org.talend.components.api.component.ComponentDefinition def_tDBOutput_16 =
...
org.talend.components.snowflake.tsnowflakeoutput.TSnowflakeOutputProperties props_tDBOutput_16 =
        (org.talend.components.snowflake.tsnowflakeoutput.TSnowflakeOutputProperties) def_tDBOutput_16.createRuntimeProperties();
 		                    ...
 		                    props_tDBOutput_16.setValue("convertColumnsAndTableToUppercase",
 		                    true);
 		                    
 		                    props_tDBOutput_16.setValue("convertEmptyStringsToNull",
 		                    false);
 		                    
 		                    props_tDBOutput_16.setValue("useSchemaDatePattern",
 		                    false);
 		                    
 		                    props_tDBOutput_16.setValue("dieOnError",
 		                    false);
 		                    ...
 		                    props_tDBOutput_16.connection.setValue("useCustomRegion",
 		                    false);
 		                    
 		                    props_tDBOutput_16.connection.userPassword.setValue("useAuth",
 		                    false);
 		                    
 		                    props_tDBOutput_16.connection.referencedComponent.setValue("referenceType",
 		                        org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE);
 		                    
 		                    props_tDBOutput_16.connection.referencedComponent.setValue("componentInstanceId",
 		                    "tDBConnection_1");
 		                    
 		                    props_tDBOutput_16.connection.referencedComponent.setValue("referenceDefinitionName",
 		                    "tSnowflakeConnection");
 		                    
 		                    props_tDBOutput_16.table.setValue("tableName",
 		                    "ITEM_MASTER_TAG_ALONG_FILE_INZTAG");
 		                    
 		                    props_tDBOutput_16.table.connection.setValue("region",
 		                        org.talend.components.snowflake.SnowflakeRegion.AWS_US_EAST_1);
 		                    
 		                    props_tDBOutput_16.table.connection.setValue("useCustomRegion",
 		                    false);
 		                    
 		                    props_tDBOutput_16.table.connection.userPassword.setValue("useAuth",
 		                    false);
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_16_2_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"TAGAMT\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":6,\"talend.field.scale\":2,\"talend.field.dbType\":3,\"talend.field.dbColumnName\":\"TAGAMT\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TAGFRM\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":35,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TAGFRM\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TAGAUM\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":8,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TAGAUM\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TASUOM\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":15,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TASUOM\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TAGSRV\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":35,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TAGSRV\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TASNUM\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":4,\"talend.field.scale\":0,\"talend.field.dbType\":-5,\"talend.field.dbColumnName\":\"TASNUM\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TAGVIT\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":20,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TAGVIT\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TAGCTG\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":15,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TAGCTG\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"SUBSKU\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":9,\"talend.field.scale\":0,\"talend.field.dbType\":-5,\"talend.field.dbColumnName\":\"SUBSKU\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CMPSKU\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":9,\"talend.field.scale\":0,\"talend.field.dbType\":-5,\"talend.field.dbColumnName\":\"CMPSKU\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"UPSSKU\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":9,\"talend.field.scale\":0,\"talend.field.dbType\":-5,\"talend.field.dbColumnName\":\"UPSSKU\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"SAVSKU\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":9,\"talend.field.scale\":0,\"talend.field.dbType\":-5,\"talend.field.dbColumnName\":\"SAVSKU\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"IMGNM1\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":15,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"IMGNM1\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"IMGNM2\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":15,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"IMGNM2\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"IMGNM3\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":15,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"IMGNM3\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"IMGNM4\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":15,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"IMGNM4\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"IMGNM5\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":15,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"IMGNM5\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TAGAUT\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":50,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TAGAUT\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TASHLF\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":1,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TASHLF\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TADYEX\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":3,\"talend.field.scale\":0,\"talend.field.dbType\":-5,\"talend.field.dbColumnName\":\"TADYEX\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CRTCEN\",\"type\":[\"double\",\"null\"],\"default\":\"\",\"talend.field.dbType\":8,\"talend.field.dbColumnName\":\"CRTCEN\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CRTDAT\",\"type\":[\"double\",\"null\"],\"default\":\"\",\"talend.field.dbType\":8,\"talend.field.dbColumnName\":\"CRTDAT\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TAGCLR\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":30,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TAGCLR\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TAGSIZ\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":20,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TAGSIZ\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TAGFLV\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":40,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TAGFLV\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TAGSNT\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":30,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"TAGSNT\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CSWGHT\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":7,\"talend.field.scale\":3,\"talend.field.dbType\":3,\"talend.field.dbColumnName\":\"CSWGHT\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CSLGTH\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":5,\"talend.field.scale\":1,\"talend.field.dbType\":3,\"talend.field.dbColumnName\":\"CSLGTH\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CSWDTH\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":5,\"talend.field.scale\":1,\"talend.field.dbType\":3,\"talend.field.dbColumnName\":\"CSWDTH\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CSHGHT\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":5,\"talend.field.scale\":1,\"talend.field.dbType\":3,\"talend.field.dbColumnName\":\"CSHGHT\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CSCUBE\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":9,\"talend.field.scale\":3,\"talend.field.dbType\":3,\"talend.field.dbColumnName\":\"CSCUBE\",\"talend.field.default\":\"\"},{",s);
    ...
    if (org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE == props_tDBOutput_16.connection.referencedComponent.referenceType.getValue()) {
        final String referencedComponentInstanceId_tDBOutput_16 = props_tDBOutput_16.connection.referencedComponent.componentInstanceId.getStringValue();
        if (referencedComponentInstanceId_tDBOutput_16 != null) {
            org.talend.daikon.properties.Properties referencedComponentProperties_tDBOutput_16 = (org.talend.daikon.properties.Properties) globalMap.get(
                referencedComponentInstanceId_tDBOutput_16 + "_COMPONENT_RUNTIME_PROPERTIES");
            props_tDBOutput_16.connection.referencedComponent.setReference(referencedComponentProperties_tDBOutput_16);
        }
    }
    if (org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE == props_tDBOutput_16.table.connection.referencedComponent.referenceType.getValue()) {
        final String referencedComponentInstanceId_tDBOutput_16 = props_tDBOutput_16.table.connection.referencedComponent.componentInstanceId.getStringValue();
        if (referencedComponentInstanceId_tDBOutput_16 != null) {
            org.talend.daikon.properties.Properties referencedComponentProperties_tDBOutput_16 = (org.talend.daikon.properties.Properties) globalMap.get(
                referencedComponentInstanceId_tDBOutput_16 + "_COMPONENT_RUNTIME_PROPERTIES");
            props_tDBOutput_16.table.connection.referencedComponent.setReference(referencedComponentProperties_tDBOutput_16);
        }
    }
...
org.talend.daikon.runtime.RuntimeInfo runtime_info_tDBOutput_16 = def_tDBOutput_16.getRuntimeInfo(
    org.talend.components.api.component.runtime.ExecutionEngine.DI, props_tDBOutput_16, topology_tDBOutput_16);
java.util.Set<org.talend.components.api.component.ConnectorTopology> supported_connector_topologies_tDBOutput_16 = def_tDBOutput_16.getSupportedConnectorTopologies();

org.talend.components.api.component.runtime.RuntimableRuntime componentRuntime_tDBOutput_16 = (org.talend.components.api.component.runtime.RuntimableRuntime)(Class.forName(runtime_info_tDBOutput_16.getRuntimeClassName()).newInstance());
org.talend.daikon.properties.ValidationResult initVr_tDBOutput_16 = componentRuntime_tDBOutput_16.initialize(container_tDBOutput_16, props_tDBOutput_16);
...
if(componentRuntime_tDBOutput_16 instanceof org.talend.components.api.component.runtime.SourceOrSink) {
	...
	if (doesNodeBelongToRequest_tDBOutput_16) {
        org.talend.daikon.properties.ValidationResult vr_tDBOutput_16 = sourceOrSink_tDBOutput_16.validate(container_tDBOutput_16);
    ...
    if (sourceOrSink_tDBOutput_16 instanceof org.talend.components.api.component.runtime.Sink) {
    	org.talend.components.api.component.runtime.Sink sink_tDBOutput_16 =
            	(org.talend.components.api.component.runtime.Sink)sourceOrSink_tDBOutput_16;
        org.talend.components.api.component.runtime.WriteOperation writeOperation_tDBOutput_16 = sink_tDBOutput_16.createWriteOperation();
        if (doesNodeBelongToRequest_tDBOutput_16) {
    ...
    for (org.talend.components.api.component.Connector currentConnector : props_tDBOutput_16.getAvailableConnectors(null, false)) {
    ...
    incomingEnforcer_tDBOutput_16 = new org.talend.codegen.enforcer.IncomingSchemaEnforcer(designSchema_tDBOutput_16);
 ...
 */
	...
	currentComponent="tMap_9";
		...
		int tos_count_tMap_9 = 0;
			...
			if(enableLogStash) {
				talendJobLog.addCM("tMap_9", "tMap_1", "tMap");
				talendJobLogProcess(globalMap);
			}
 ...
 */
	...
	currentComponent="tFileInputDelimited_10";
		...
		int tos_count_tFileInputDelimited_10 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileInputDelimited_10{
                    ...
                    log4jParamters_tFileInputDelimited_10.append("Parameters:");
                            log4jParamters_tFileInputDelimited_10.append("FILENAME" + " = " + "\"/data/talend/data_repository/INZTAG.zip\"");
                        ...
                        log4jParamters_tFileInputDelimited_10.append(" | ");
                            log4jParamters_tFileInputDelimited_10.append("TRIMSELECT" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("INUMBR")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGAMT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGFRM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGAUM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TASUOM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGSRV")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TASNUM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGVIT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGCTG")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("SUBSKU")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CMPSKU")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("UPSSKU")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("SAVSKU")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IMGNM1")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IMGNM2")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IMGNM3")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IMGNM4")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IMGNM5")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGAUT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TASHLF")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TADYEX")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CRTCEN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CRTDAT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGCLR")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGSIZ")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGFLV")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAGSNT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CSWGHT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CSLGTH")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CSWDTH")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CSHGHT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CSCUBE")+"}]");
                        log4jParamters_tFileInputDelimited_10.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tFileInputDelimited_10", "tFileInputDelimited_1", "tFileInputDelimited");
				talendJobLogProcess(globalMap);
			}
				...
				try{
						...
						try {
							if(filename_tFileInputDelimited_10 instanceof java.io.InputStream){
								zis_tFileInputDelimited_10 = new java.util.zip.ZipInputStream(new java.io.BufferedInputStream((java.io.InputStream)filename_tFileInputDelimited_10));
							}else{
								zis_tFileInputDelimited_10 = new java.util.zip.ZipInputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(String.valueOf(filename_tFileInputDelimited_10))));
							}
						} catch(java.lang.Exception e) {
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",e.getMessage());
							...
							try {
								fid_tFileInputDelimited_10 = new org.talend.fileprocess.FileInputDelimited(zis_tFileInputDelimited_10, "ISO-8859-15","|","\n",false,1,0,
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",ex_tFileInputDelimited_10.getMessage());
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"INUMBR", "row12", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",ex_tFileInputDelimited_10.getMessage());
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TAGAMT", "row12", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",ex_tFileInputDelimited_10.getMessage());
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TASNUM", "row12", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",ex_tFileInputDelimited_10.getMessage());
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"SUBSKU", "row12", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",ex_tFileInputDelimited_10.getMessage());
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CMPSKU", "row12", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",ex_tFileInputDelimited_10.getMessage());
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"UPSSKU", "row12", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",ex_tFileInputDelimited_10.getMessage());
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"SAVSKU", "row12", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",ex_tFileInputDelimited_10.getMessage());
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TADYEX", "row12", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",ex_tFileInputDelimited_10.getMessage());
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CRTCEN", "row12", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",ex_tFileInputDelimited_10.getMessage());
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CRTDAT", "row12", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",ex_tFileInputDelimited_10.getMessage());
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CSWGHT", "row12", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",ex_tFileInputDelimited_10.getMessage());
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CSLGTH", "row12", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",ex_tFileInputDelimited_10.getMessage());
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CSWDTH", "row12", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",ex_tFileInputDelimited_10.getMessage());
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CSHGHT", "row12", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",ex_tFileInputDelimited_10.getMessage());
									rowstate_tFileInputDelimited_10.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CSCUBE", "row12", temp, ex_tFileInputDelimited_10), ex_tFileInputDelimited_10));
								}
...
globalMap.put("tFileInputDelimited_10_ERROR_MESSAGE",e.getMessage());
			...
			log.debug("tFileInputDelimited_10 - Retrieving the record " + fid_tFileInputDelimited_10.getRowNumber() + ".");
...
if(row12 != null) { 
	...
	currentComponent="tMap_9";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row12","tFileInputDelimited_10","tFileInputDelimited_1","tFileInputDelimited","tMap_9","tMap_1","tMap"
...
INZTAG = INZTAG_tmp;
log.debug("tMap_9 - Outputting the record " + count_INZTAG_tMap_9 + " of the output table 'INZTAG'.");
...
if(INZTAG != null) { 
	...
	currentComponent="tDBOutput_16";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"INZTAG","tMap_9","tMap_1","tMap","tDBOutput_16","tDBOutput_1","tSnowflakeOutput"
        ...
        if (incomingEnforcer_tDBOutput_16 != null) {
            incomingEnforcer_tDBOutput_16.createNewRecord();
                ...
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("INUMBR") != null){
                    incomingEnforcer_tDBOutput_16.put("INUMBR", INZTAG.INUMBR);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("TAGAMT") != null){
                    incomingEnforcer_tDBOutput_16.put("TAGAMT", INZTAG.TAGAMT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("TAGFRM") != null){
                    incomingEnforcer_tDBOutput_16.put("TAGFRM", INZTAG.TAGFRM);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("TAGAUM") != null){
                    incomingEnforcer_tDBOutput_16.put("TAGAUM", INZTAG.TAGAUM);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("TASUOM") != null){
                    incomingEnforcer_tDBOutput_16.put("TASUOM", INZTAG.TASUOM);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("TAGSRV") != null){
                    incomingEnforcer_tDBOutput_16.put("TAGSRV", INZTAG.TAGSRV);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("TASNUM") != null){
                    incomingEnforcer_tDBOutput_16.put("TASNUM", INZTAG.TASNUM);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("TAGVIT") != null){
                    incomingEnforcer_tDBOutput_16.put("TAGVIT", INZTAG.TAGVIT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("TAGCTG") != null){
                    incomingEnforcer_tDBOutput_16.put("TAGCTG", INZTAG.TAGCTG);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("SUBSKU") != null){
                    incomingEnforcer_tDBOutput_16.put("SUBSKU", INZTAG.SUBSKU);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("CMPSKU") != null){
                    incomingEnforcer_tDBOutput_16.put("CMPSKU", INZTAG.CMPSKU);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("UPSSKU") != null){
                    incomingEnforcer_tDBOutput_16.put("UPSSKU", INZTAG.UPSSKU);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("SAVSKU") != null){
                    incomingEnforcer_tDBOutput_16.put("SAVSKU", INZTAG.SAVSKU);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("IMGNM1") != null){
                    incomingEnforcer_tDBOutput_16.put("IMGNM1", INZTAG.IMGNM1);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("IMGNM2") != null){
                    incomingEnforcer_tDBOutput_16.put("IMGNM2", INZTAG.IMGNM2);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("IMGNM3") != null){
                    incomingEnforcer_tDBOutput_16.put("IMGNM3", INZTAG.IMGNM3);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("IMGNM4") != null){
                    incomingEnforcer_tDBOutput_16.put("IMGNM4", INZTAG.IMGNM4);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("IMGNM5") != null){
                    incomingEnforcer_tDBOutput_16.put("IMGNM5", INZTAG.IMGNM5);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("TAGAUT") != null){
                    incomingEnforcer_tDBOutput_16.put("TAGAUT", INZTAG.TAGAUT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("TASHLF") != null){
                    incomingEnforcer_tDBOutput_16.put("TASHLF", INZTAG.TASHLF);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("TADYEX") != null){
                    incomingEnforcer_tDBOutput_16.put("TADYEX", INZTAG.TADYEX);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("CRTCEN") != null){
                    incomingEnforcer_tDBOutput_16.put("CRTCEN", INZTAG.CRTCEN);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("CRTDAT") != null){
                    incomingEnforcer_tDBOutput_16.put("CRTDAT", INZTAG.CRTDAT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("TAGCLR") != null){
                    incomingEnforcer_tDBOutput_16.put("TAGCLR", INZTAG.TAGCLR);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("TAGSIZ") != null){
                    incomingEnforcer_tDBOutput_16.put("TAGSIZ", INZTAG.TAGSIZ);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("TAGFLV") != null){
                    incomingEnforcer_tDBOutput_16.put("TAGFLV", INZTAG.TAGFLV);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("TAGSNT") != null){
                    incomingEnforcer_tDBOutput_16.put("TAGSNT", INZTAG.TAGSNT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("CSWGHT") != null){
                    incomingEnforcer_tDBOutput_16.put("CSWGHT", INZTAG.CSWGHT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("CSLGTH") != null){
                    incomingEnforcer_tDBOutput_16.put("CSLGTH", INZTAG.CSLGTH);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("CSWDTH") != null){
                    incomingEnforcer_tDBOutput_16.put("CSWDTH", INZTAG.CSWDTH);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("CSHGHT") != null){
                    incomingEnforcer_tDBOutput_16.put("CSHGHT", INZTAG.CSHGHT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("CSCUBE") != null){
                    incomingEnforcer_tDBOutput_16.put("CSCUBE", INZTAG.CSCUBE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_16 != null && incomingEnforcer_tDBOutput_16.getRuntimeSchema().getField("LOAD_DATE") != null){
...
// ###############################      
				log.debug("tMap_9 - Written records count in the table 'INZTAG': " + count_INZTAG_tMap_9 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row12",2,0,
			 			"tFileInputDelimited_10","tFileInputDelimited_1","tFileInputDelimited","tMap_9","tMap_1","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
...
resourceMap.put("finish_tDBOutput_16", Boolean.TRUE);
    ...
    if (writer_tDBOutput_16 != null) {
        org.talend.components.api.component.runtime.Result resultObject_tDBOutput_16 = (org.talend.components.api.component.runtime.Result)writer_tDBOutput_16.close();
        resultMap_tDBOutput_16 = writer_tDBOutput_16.getWriteOperation().finalize(java.util.Arrays.<org.talend.components.api.component.runtime.Result>asList(resultObject_tDBOutput_16), container_tDBOutput_16);
    }
if(resultMap_tDBOutput_16!=null) {
	for(java.util.Map.Entry<String,Object> entry_tDBOutput_16 : resultMap_tDBOutput_16.entrySet()) {
		...
		case org.talend.components.api.component.ComponentDefinition.RETURN_ERROR_MESSAGE :
			container_tDBOutput_16.setComponentData("tDBOutput_16", "ERROR_MESSAGE", entry_tDBOutput_16.getValue());
			break;
		case org.talend.components.api.component.ComponentDefinition.RETURN_TOTAL_RECORD_COUNT :
			container_tDBOutput_16.setComponentData("tDBOutput_16", "NB_LINE", entry_tDBOutput_16.getValue());
			break;
		case org.talend.components.api.component.ComponentDefinition.RETURN_SUCCESS_RECORD_COUNT :
			container_tDBOutput_16.setComponentData("tDBOutput_16", "NB_SUCCESS", entry_tDBOutput_16.getValue());
			break;
		case org.talend.components.api.component.ComponentDefinition.RETURN_REJECT_RECORD_COUNT :
			container_tDBOutput_16.setComponentData("tDBOutput_16", "NB_REJECT", entry_tDBOutput_16.getValue());
			break;
		default :
            StringBuilder studio_key_tDBOutput_16 = new StringBuilder();
            for (int i_tDBOutput_16 = 0; i_tDBOutput_16 < entry_tDBOutput_16.getKey().length(); i_tDBOutput_16++) {
			...
			container_tDBOutput_16.setComponentData("tDBOutput_16", studio_key_tDBOutput_16.toString().toUpperCase(java.util.Locale.ENGLISH), entry_tDBOutput_16.getValue());
			break;
		}
	}
}

			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"INZTAG",2,0,
			 			"tMap_9","tMap_1","tMap","tDBOutput_16","tDBOutput_1","tSnowflakeOutput","output")) {
						talendJobLogProcess(globalMap);
					}
...
if(resourceMap.get("finish_tDBOutput_16")==null){
    if(resourceMap.get("writer_tDBOutput_16")!=null){
		try {
			((org.talend.components.api.component.runtime.Writer)resourceMap.get("writer_tDBOutput_16")).close();
		} catch (java.io.IOException e_tDBOutput_16) {
			String errorMessage_tDBOutput_16 = "failed to release the resource in tDBOutput_16 :" + e_tDBOutput_16.getMessage();
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileDelete_1{
                    ...
                    log4jParamters_tFileDelete_1.append("Parameters:");
                            log4jParamters_tFileDelete_1.append("PATH" + " = " + "\"/data/talend/data_repository/INZTAG.zip\"");
                ...
                class BytesLimit65535_tFileOutputDelimited_1{
                    ...
                    log4jParamters_tFileOutputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
                            log4jParamters_tFileOutputDelimited_1.append("FILENAME" + " = " + "\"/data/talend/data_repository/MSTFLD.csv\"");
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("/data/talend/data_repository/MSTFLD.csv")).getAbsolutePath().replace("\\","/");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("ITANAM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ITAVAL")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ITADSC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ITADEF")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row34","tDBInput_1","tDBInput_1","tAS400Input","tFileOutputDelimited_1","tFileOutputDelimited_1","tFileOutputDelimited"
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_1_2_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"ITANAM\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":6,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"ITANAM\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ITAVAL\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":6,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"ITAVAL\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ITADSC\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":35,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"ITADSC\",\"talend.field.default\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ITADEF\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"talend.field.length\":1,\"talend.field.dbType\":12,\"talend.field.dbColumnName\":\"ITADEF\",\"talend.field.default\":\"\"},{",s);
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                            log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "\"/data/talend/data_repository/MSTFLD.zip\"");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("TRIMSELECT" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("ITANAM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ITAVAL")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ITADSC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ITADEF")+"}]");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
...
if(row14 != null) { 
	...
	currentComponent="tMap_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row14","tFileInputDelimited_1","tFileInputDelimited_1","tFileInputDelimited","tMap_1","tMap_1","tMap"
...
MSTFLD = MSTFLD_tmp;
log.debug("tMap_1 - Outputting the record " + count_MSTFLD_tMap_1 + " of the output table 'MSTFLD'.");
...
if(MSTFLD != null) { 
	...
	currentComponent="tDBOutput_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"MSTFLD","tMap_1","tMap_1","tMap","tDBOutput_1","tDBOutput_1","tSnowflakeOutput"
        ...
        if (incomingEnforcer_tDBOutput_1 != null) {
            incomingEnforcer_tDBOutput_1.createNewRecord();
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("ITANAM") != null){
                    incomingEnforcer_tDBOutput_1.put("ITANAM", MSTFLD.ITANAM);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("ITAVAL") != null){
                    incomingEnforcer_tDBOutput_1.put("ITAVAL", MSTFLD.ITAVAL);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("ITADSC") != null){
                    incomingEnforcer_tDBOutput_1.put("ITADSC", MSTFLD.ITADSC);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("ITADEF") != null){
	...
	for(java.util.Map.Entry<String,Object> entry_tDBOutput_1 : resultMap_tDBOutput_1.entrySet()) {
		...
		default :
			...
			break;
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"MSTFLD",2,0,
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileDelete_2{
                    ...
                    log4jParamters_tFileDelete_2.append("Parameters:");
                            log4jParamters_tFileDelete_2.append("PATH" + " = " + "\"/data/talend/data_repository/MSTFLD.zip\"");
                ...
                class BytesLimit65535_tFileOutputDelimited_2{
                    ...
                    log4jParamters_tFileOutputDelimited_2.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_2.append(" | ");
                            log4jParamters_tFileOutputDelimited_2.append("FILENAME" + " = " + "\"/data/talend/data_repository/MSTITA.csv\"");
                        log4jParamters_tFileOutputDelimited_2.append(" | ");
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File("/data/talend/data_repository/MSTITA.csv")).getAbsolutePath().replace("\\","/");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("IASNUM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ISTYLN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("INUMBR")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ITANAM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ITAVAL")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
 ...
 */
	...
	currentComponent="tFileOutputDelimited_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row36","tDBInput_2","tDBInput_2","tAS400Input","tFileOutputDelimited_2","tFileOutputDelimited_2","tFileOutputDelimited"
    			...
    			if(log.isTraceEnabled()){
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_2.append(
                            row36.IASNUM.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_3_2_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"IASNUM\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"talend.field.precision\":6,\"talend.field.scale\":0,\"talend.field.dbType\":-5,\"talend.field.dbColumnName\":\"IASNUM\",\"talend.field.default\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"INUMBR\",\"type\":[\"double\",\"null\"],\"default\":\"\",\"talend.field.dbType\":8,\"talend.field.dbColumnName\":\"INUMBR\",\"talend.field.default\":\"\"},{",s);
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileInputDelimited_2{
                    ...
                    log4jParamters_tFileInputDelimited_2.append("Parameters:");
                            log4jParamters_tFileInputDelimited_2.append("FILENAME" + " = " + "\"/data/talend/data_repository/MSTITA.zip\"");
                        ...
                        log4jParamters_tFileInputDelimited_2.append(" | ");
                            log4jParamters_tFileInputDelimited_2.append("TRIMSELECT" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("IASNUM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ISTYLN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("INUMBR")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ITANAM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ITAVAL")+"}]");
                        log4jParamters_tFileInputDelimited_2.append(" | ");
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"IASNUM", "row15", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"INUMBR", "row15", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
if(row15 != null) { 
	...
	currentComponent="tMap_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row15","tFileInputDelimited_2","tFileInputDelimited_2","tFileInputDelimited","tMap_2","tMap_2","tMap"
...
MSTITA = MSTITA_tmp;
log.debug("tMap_2 - Outputting the record " + count_MSTITA_tMap_2 + " of the output table 'MSTITA'.");
...
if(MSTITA != null) { 
	...
	currentComponent="tDBOutput_3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"MSTITA","tMap_2","tMap_2","tMap","tDBOutput_3","tDBOutput_2","tSnowflakeOutput"
        ...
        if (incomingEnforcer_tDBOutput_3 != null) {
            incomingEnforcer_tDBOutput_3.createNewRecord();
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("IASNUM") != null){
                    incomingEnforcer_tDBOutput_3.put("IASNUM", MSTITA.IASNUM);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("ISTYLN") != null){
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("ITANAM") != null){
                    incomingEnforcer_tDBOutput_3.put("ITANAM", MSTITA.ITANAM);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_3 != null && incomingEnforcer_tDBOutput_3.getRuntimeSchema().getField("ITAVAL") != null){
	...
	for(java.util.Map.Entry<String,Object> entry_tDBOutput_3 : resultMap_tDBOutput_3.entrySet()) {
		...
		default :
			...
			break;
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"MSTITA",2,0,
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileDelete_3{
                    ...
                    log4jParamters_tFileDelete_3.append("Parameters:");
                            log4jParamters_tFileDelete_3.append("PATH" + " = " + "\"/data/talend/data_repository/MSTITA.zip\"");
                ...
                class BytesLimit65535_tFileOutputDelimited_3{
                    ...
                    log4jParamters_tFileOutputDelimited_3.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_3.append(" | ");
                            log4jParamters_tFileOutputDelimited_3.append("FILENAME" + " = " + "\"/data/talend/data_repository/SETDTL.csv\"");
                        log4jParamters_tFileOutputDelimited_3.append(" | ");
...
String fileName_tFileOutputDelimited_3 = "";
    fileName_tFileOutputDelimited_3 = (new java.io.File("/data/talend/data_repository/SETDTL.csv")).getAbsolutePath().replace("\\","/");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_3{
                    ...
                    log4jParamters_tDBInput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("ISETNO")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ICMPNO")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ISETQT")+"}]");
                        log4jParamters_tDBInput_3.append(" | ");
 ...
 */
	...
	currentComponent="tFileOutputDelimited_3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row28","tDBInput_3","tDBInput_3","tAS400Input","tFileOutputDelimited_3","tFileOutputDelimited_3","tFileOutputDelimited"
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileInputDelimited_3{
                    ...
                    log4jParamters_tFileInputDelimited_3.append("Parameters:");
                            log4jParamters_tFileInputDelimited_3.append("FILENAME" + " = " + "\"/data/talend/data_repository/SETDTL.zip\"");
                        ...
                        log4jParamters_tFileInputDelimited_3.append(" | ");
                            log4jParamters_tFileInputDelimited_3.append("TRIMSELECT" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("ISETNO")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ICMPNO")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ISETQT")+"}]");
                        log4jParamters_tFileInputDelimited_3.append(" | ");
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ISETNO", "row9", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ICMPNO", "row9", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ISETQT", "row9", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
if(row9 != null) { 
	...
	currentComponent="tMap_3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row9","tFileInputDelimited_3","tFileInputDelimited_3","tFileInputDelimited","tMap_3","tMap_3","tMap"
...
SETDTL = SETDTL_tmp;
log.debug("tMap_3 - Outputting the record " + count_SETDTL_tMap_3 + " of the output table 'SETDTL'.");
...
if(SETDTL != null) { 
	...
	currentComponent="tDBOutput_4";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"SETDTL","tMap_3","tMap_3","tMap","tDBOutput_4","tDBOutput_2","tSnowflakeOutput"
        ...
        if (incomingEnforcer_tDBOutput_4 != null) {
            incomingEnforcer_tDBOutput_4.createNewRecord();
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_4 != null && incomingEnforcer_tDBOutput_4.getRuntimeSchema().getField("ISETNO") != null){
                    incomingEnforcer_tDBOutput_4.put("ISETNO", SETDTL.ISETNO);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_4 != null && incomingEnforcer_tDBOutput_4.getRuntimeSchema().getField("ICMPNO") != null){
                    incomingEnforcer_tDBOutput_4.put("ICMPNO", SETDTL.ICMPNO);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_4 != null && incomingEnforcer_tDBOutput_4.getRuntimeSchema().getField("ISETQT") != null){
                    incomingEnforcer_tDBOutput_4.put("ISETQT", SETDTL.ISETQT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_4 != null && incomingEnforcer_tDBOutput_4.getRuntimeSchema().getField("LOAD_DATE") != null){
		...
		default :
			...
			break;
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"SETDTL",2,0,
			 			"tMap_3","tMap_3","tMap","tDBOutput_4","tDBOutput_2","tSnowflakeOutput","output")) {
						talendJobLogProcess(globalMap);
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileDelete_4{
                    ...
                    log4jParamters_tFileDelete_4.append("Parameters:");
                            log4jParamters_tFileDelete_4.append("PATH" + " = " + "\"/data/talend/data_repository/SETDTL.zip\"");
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'TTAALLCL2' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-06-29T15:07:18.763393200Z");
        ...
        try {
            ...
            java.io.InputStream inContext = TTAALLCL2.class.getClassLoader().getResourceAsStream("at_talend_jobs/ttaallcl2_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = TTAALLCL2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
/************************************************************************************************
 *     757874 characters generated by Talend Cloud Data Management Platform 
 *     on the June 29, 2023 at 11:07:18 AM EDT
 ************************************************************************************************/