...
globalMap.put("tFileUnarchive_1_ERROR_MESSAGE",e.getMessage());
	...
	final String decryptedPassword_tFileUnarchive_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:4RQnFgHBz2OGpmFTm4RGd2IIxJ9D4XAefkPfYQ==");
...
public void tFileList_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileList_2{
                    ...
                    log4jParamters_tFileList_2.append("Parameters:");
                            log4jParamters_tFileList_2.append("DIRECTORY" + " = " + "\"//wva-sql-etl/sftp/ftp_files/koerber_data/\"");
                        ...
                        log4jParamters_tFileList_2.append(" | ");
                            log4jParamters_tFileList_2.append("FILES" + " = " + "[{FILEMASK="+("\"Vitamin Shoppe EDW All Modes Shipment Detail \"+TalendDate.formatDate(\"MM-dd-yyyy\",TalendDate.getCurrentDate())+\".xlsx\"")+"}]");
                        log4jParamters_tFileList_2.append(" | ");
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_2 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_2.add("Vitamin Shoppe EDW All Modes Shipment Detail "+TalendDate.formatDate("MM-dd-yyyy",TalendDate.getCurrentDate())+".xlsx");  
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileCopy_1{
                    ...
                    log4jParamters_tFileCopy_1.append("Parameters:");
                            log4jParamters_tFileCopy_1.append("FILENAME" + " = " + "((String)globalMap.get(\"tFileList_2_CURRENT_FILEPATH\"))");
                        log4jParamters_tFileCopy_1.append(" | ");
                            log4jParamters_tFileCopy_1.append("ENABLE_COPY_DIRECTORY" + " = " + "false");
                        log4jParamters_tFileCopy_1.append(" | ");
                            log4jParamters_tFileCopy_1.append("DESTINATION" + " = " + "\"//wva-sql-etl/sftp/ftp_files/Employee_List/\"");
                        log4jParamters_tFileCopy_1.append(" | ");
 ...
 */
	...
	currentComponent="tFileCopy_1";
		...
		if (!srcFile_tFileCopy_1.getPath().equals(desFile_tFileCopy_1.getPath())  ) {
				...
				try {
					org.talend.FileCopy.copyFile(srcFile_tFileCopy_1.getPath(), desFile_tFileCopy_1.getPath(), false, true);
				} catch (Exception e) {
                ...
                class BytesLimit65535_tFileOutputDelimited_1{
                    ...
                    log4jParamters_tFileOutputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
                            log4jParamters_tFileOutputDelimited_1.append("FILENAME" + " = " + "\"//wva-sql-etl/sftp/ftp_files/koerber_data/out.csv\"");
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("//wva-sql-etl/sftp/ftp_files/koerber_data/out.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileInputExcel_1{
                    ...
                    log4jParamters_tFileInputExcel_1.append("Parameters:");
                        ...
                        log4jParamters_tFileInputExcel_1.append(" | ");
                            log4jParamters_tFileInputExcel_1.append("PASSWORD" + " = " + String.valueOf("enc:routine.encryption.key.v1:EQ5Gbm4KgBufVxmvzoz79VKDJiDSpbeAqDwMEw==").substring(0, 4) + "...");     
                        log4jParamters_tFileInputExcel_1.append(" | ");
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:yVAD0B+AxZFiAuOTJW/QKwlIDecq5CdgNvW2ow==");
				...
				if(8<actual_end_column_tFileInputExcel_1){
					try{
						if(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1))){
							row1.Invoice_Date = row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getDateCellValue();
						}
						else{
...
globalMap.put("tFileInputExcel_1_ERROR_MESSAGE",e.getMessage());
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				if(9<actual_end_column_tFileInputExcel_1){
					try{
						if(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1))){
							row1.Ship_Date = row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getDateCellValue();
						}
						else{
                            java.util.Date tempDate_tFileInputExcel_1 = ParserUtils.parseTo_Date(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], "dd-MM-yyyy");
                            if(tempDate_tFileInputExcel_1.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_1.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
...
globalMap.put("tFileInputExcel_1_ERROR_MESSAGE",e.getMessage());
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				if(10<actual_end_column_tFileInputExcel_1){
					try{
						if(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1))){
							row1.Delivery_Date = row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getDateCellValue();
						}
						else{
                            java.util.Date tempDate_tFileInputExcel_1 = ParserUtils.parseTo_Date(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], "dd-MM-yyyy");
                            if(tempDate_tFileInputExcel_1.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_1.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
...
globalMap.put("tFileInputExcel_1_ERROR_MESSAGE",e.getMessage());
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Actual_Weight__Invoiced_ = ParserUtils.parseTo_Double(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Bill_Weight__Invoiced_ = ParserUtils.parseTo_Double(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Total_Charges = ParserUtils.parseTo_Double(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Line_Haul = ParserUtils.parseTo_Double(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row1.Line_Haul = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Fuel_Surcharge = ParserUtils.parseTo_Double(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Fuel_Discount_Amount = ParserUtils.parseTo_Double(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Discount = ParserUtils.parseTo_Double(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row1.Discount = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Accessorials = ParserUtils.parseTo_Double(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Adjustments = ParserUtils.parseTo_Double(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Total_Due_Amount = ParserUtils.parseTo_Double(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Internal_Key_1 = ParserUtils.parseTo_Double(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
...
if(row1 != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row1","tFileInputExcel_1","tFileInputExcel_1","tFileInputExcel","tFileOutputDelimited_1","tFileOutputDelimited_1","tFileOutputDelimited"
    			...
    			if(log.isTraceEnabled()){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row1.Invoice_Date, "dd-MM-yyyy")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.Ship_Date != null) {
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row1.Ship_Date, "dd-MM-yyyy")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row1.Mode__Invoiced_
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.Service_Level__Invoiced_ != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.Service_Level__Invoiced_
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row1.Shipper_Company
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.Shipper_Address_1 != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.Shipper_Address_1
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row1.Shipper_Postal_Code
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.Shipper_Country != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.Shipper_Country
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row1.Receiver_Company
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.Receiver_Address_1 != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.Receiver_Address_1
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row1.Receiver_Postal_Code
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.Receiver_Country != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.Receiver_Country
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.Actual_Weight__Invoiced_ != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.Actual_Weight__Invoiced_
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.Bill_Weight__Invoiced_ != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.Bill_Weight__Invoiced_
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
		...
		resourceMap.put("finish_tFileOutputDelimited_1", true);
				...
				log.debug("tFileOutputDelimited_1 - Written records count: " + nb_line_tFileOutputDelimited_1 + " .");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row1",2,0,
			 			"tFileInputExcel_1","tFileInputExcel_1","tFileInputExcel","tFileOutputDelimited_1","tFileOutputDelimited_1","tFileOutputDelimited","output")) {
						talendJobLogProcess(globalMap);
					}
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'koerber_data_into_snowflake' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-05-19T13:02:13.410833400Z");
...
/************************************************************************************************
 *     257218 characters generated by Talend Cloud Data Management Platform 
 *     on the May 19, 2023 at 9:02:13 AM EDT
 ************************************************************************************************/