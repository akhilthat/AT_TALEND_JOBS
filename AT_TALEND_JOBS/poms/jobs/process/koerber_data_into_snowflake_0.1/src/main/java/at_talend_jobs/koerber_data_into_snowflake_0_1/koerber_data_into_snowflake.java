				...
				for (int i_tFileList_3 = 0; i_tFileList_3 < list_tFileList_3.size(); i_tFileList_3++) {
					...
					props_tDBOutput_1.connection.userPassword.setValue("password",
							routines.system.PasswordEncryptUtil.decryptPassword(
									"enc:routine.encryption.key.v1:lCterPbiHT1tsELmGWIOzycv297tkCS65e6B46Uu86SR9k211DFH"));
					...
					props_tDBOutput_1.table.connection.userPassword.setValue("password",
							routines.system.PasswordEncryptUtil.decryptPassword(
									"enc:routine.encryption.key.v1:fxe2fijzIs6T5W3jBZ5D0awoKyXBzH+cmEm3b/VYhIaF4p8iJDVz"));
...
// ###############################
						...
						class BytesLimit65535_tFileInputExcel_1 {
							public void limitLog4jByte() throws Exception {
								...
								log4jParamters_tFileInputExcel_1.append("PASSWORD" + " = " + String.valueOf(
										"enc:routine.encryption.key.v1:kEnZqUYBjos061dAHOM4vaH7Qwgs8xHck9VBbA==")
										.substring(0, 4) + "...");
								log4jParamters_tFileInputExcel_1.append(" | ");
					...
					final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:sGK1tdF80wLEVIMbnEnJlp60Zuor6as/u9x5dg==");
...
// finally of generic
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-05-19T15:11:47.029252600Z");
 ...
 * May 19, 2023 at 11:11:47 AM EDT
 ************************************************************************************************/