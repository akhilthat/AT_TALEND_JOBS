			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tFTPConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFTPConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:eUD/LyUXd9GOqPRmZ4FXQJJ3wQDUH1KJ5iwG8UhfkunSIGSDJ7nwjcaO")
									.substring(0, 4) + "...");
							log4jParamters_tFTPConnection_1.append(" | ");
				...
				class MyUserInfo implements com.jcraft.jsch.UserInfo, com.jcraft.jsch.UIKeyboardInteractive {
					...
					String decryptedPassphrase_tFTPConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
							"enc:routine.encryption.key.v1:Wk5FJ1DtEFeAlQt9MX1/TTveLLt2ehHi77ZGXxnTZrCyFw==");
					...
					public String getPassword() {
						...
						final String decryptedPassword_tFTPConnection_1 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:utie/f8o/IfIJIBczjNfB5EmI+zh+GeK7Xhnsq/TpQrL1B+W0tjby3es");
				...
				do {
					...
					final String decryptedPassword_tFTPConnection_1 = routines.system.PasswordEncryptUtil
							.decryptPassword(
									"enc:routine.encryption.key.v1:mOrXvyNbF5BT8QAi8z8uDPI8pR6WTbKKgLOE0DWihbVzuBD5WAh5kzhY");
	...
	public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				maskList_tFileList_1.add("Vitamin Shoppe EDW All Modes Shipment Detail "
						+ TalendDate.formatDate("MM-dd-yyyy", TalendDate.getCurrentDate()) + ".zip");
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					if (tmpFileURL_tFileUnarchive_1.endsWith(".tar.gz")
						...
						final String decryptedPassword_tFileUnarchive_1 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:Bt/+gfC1ix58UwtcuYzVAnfNL1y+kr9aqzSjag==");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tFileList_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileList_3
									.append("DIRECTORY" + " = " + "\"//wva-sql-etl/sftp/ftp_files/Employee_List/\"");
				...
				for (int i_tFileList_3 = 0; i_tFileList_3 < list_tFileList_3.size(); i_tFileList_3++) {
						...
						class BytesLimit65535_tFileInputExcel_1 {
							public void limitLog4jByte() throws Exception {
								...
								log4jParamters_tFileInputExcel_1.append("PASSWORD" + " = " + String.valueOf(
										"enc:routine.encryption.key.v1:72I5VDeyopLizSvggNBxtK33l6+LuwyJApNm8w==")
										.substring(0, 4) + "...");
								log4jParamters_tFileInputExcel_1.append(" | ");
								...
								log4jParamters_tFileInputExcel_1.append("TRIMSELECT" + " = " + "[{TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Scac_Code") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("TVSI_Vendor_ID") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Carrier_Name") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Account__") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Invoice__") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("PRO_____Tracking__") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("BOL__") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
										+ ("Bill_Option") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
										+ ("Invoice_Date") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
										+ ("Ship_Date") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
										+ ("Delivery_Date") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
										+ ("Mode__Invoiced_") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
										+ ("Service_Level__Invoiced_") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
										+ ("Invoice_Method") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
										+ ("GL_Code") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("PO__")
										+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("Reference1") + "}, {TRIM="
										+ ("false") + ", SCHEMA_COLUMN=" + ("Reference2") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Reference3") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Reference4") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Zone__Invoiced_") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Shipper_Name") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Shipper_Company") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Shipper_Address_1") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Shipper_City") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Shipper_State") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Shipper_Postal_Code") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Shipper_Country") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Receiver_Name") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Receiver_Company") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Receiver_Address_1") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Receiver_City") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Receiver_State") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Receiver_Postal_Code") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Receiver_Country") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Actual_Weight__Invoiced_") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Bill_Weight__Invoiced_") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Total_Charges") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Line_Haul") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Fuel_Surcharge") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Fuel_Discount_Amount") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Discount") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Accessorials") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Adjustments") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Total_Due_Amount") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Invoice_Status") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Adjustment_Reason") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Internal_Key_1") + "}, {TRIM=" + ("false")
										+ ", SCHEMA_COLUMN=" + ("Nsp_Invoice_Details_Id") + "}]");
								log4jParamters_tFileInputExcel_1.append(" | ");
					...
					final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:KKHOGbm7WDGkWT7vscwHNsjwMlhAYjuMNsLB+g==");
					...
					try {
						...
						sheetList_tFileInputExcel_1.addAll(
								regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "sheet1", false));
...
// Start of branch "row1"
								if (row1 != null) {
									...
									if (row1.Ship_Date != null) {
										sb_tFileOutputDelimited_1
												.append(FormatterUtils.format_Date(row1.Ship_Date, "dd-MM-yyyy"));
									}
									sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
									if (row1.Delivery_Date != null) {
										sb_tFileOutputDelimited_1
												.append(FormatterUtils.format_Date(row1.Delivery_Date, "dd-MM-yyyy"));
									}
									sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							log.debug(
									"tFileInputExcel_1 - Retrieved records count: " + nb_line_tFileInputExcel_1 + " .");
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-05-19T13:07:36.543989400Z");
...
/************************************************************************************************
 * 298493 characters generated by Talend Cloud Data Management Platform on the
 * May 19, 2023 at 9:07:36 AM EDT
 ************************************************************************************************/