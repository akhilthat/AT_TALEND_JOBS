...
package at_talend_jobs.merchant_analytics_refresh_0_1;
...
/**
 * Job: merchant_analytics_refresh Purpose: <br>
 * Description: <br>
 * 
 * @author thati, akhil
 ...
 * @status
 */
public class merchant_analytics_refresh implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "merchant_analytics_refresh.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(merchant_analytics_refresh.class);
	...
	private final String jobName = "merchant_analytics_refresh";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					merchant_analytics_refresh.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(merchant_analytics_refresh.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_1.setValue("db", "SF_MSTR_PROD");

				props_tDBConnection_1.setValue("schemaName", "SF_PROD");
				...
				props_tDBConnection_1.userPassword.setValue("userId", "arsalan_aziz");

				props_tDBConnection_1.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:T+tAzeSxhoFVjRE2CaoJhqznPwitevd7aco4W7zkFPDyPXbRLF1lyQ=="));
...
// finally of generic
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_AT_TALEND_JOBS_merchant_analytics_refresh = new byte[0];
		static byte[] commonByteArray_AT_TALEND_JOBS_merchant_analytics_refresh = new byte[0];

		public Boolean BFR_SP_out;

		public Boolean getBFR_SP_out() {
			return this.BFR_SP_out;
		}

		public Boolean BFR_SP_outIsNullable() {
			return true;
		}

		public Boolean BFR_SP_outIsKey() {
			return false;
		}

		public Integer BFR_SP_outLength() {
			return null;
		}

		public Integer BFR_SP_outPrecision() {
			return null;
		}

		public String BFR_SP_outDefault() {

			return null;

		}

		public String BFR_SP_outComment() {

			return "";

		}

		public String BFR_SP_outPattern() {

			return "";

		}

		public String BFR_SP_outOriginalDbColumnName() {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_AT_TALEND_JOBS_merchant_analytics_refresh) {
				...
				try {
					...
					length = dis.readByte();
					if (length == -1) {
						this.BFR_SP_out = null;
					} else {
						this.BFR_SP_out = dis.readBoolean();
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.BFR_SP_out == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.BFR_SP_out);
				}
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("BFR_SP_out=" + String.valueOf(BFR_SP_out));
			sb.append("]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				org.talend.components.snowflake.tsnowflakerow.TSnowflakeRowProperties props_tDBRow_4 = (org.talend.components.snowflake.tsnowflakerow.TSnowflakeRowProperties) def_tDBRow_4
						.createRuntimeProperties();
				props_tDBRow_4.setValue("query", "\ncall STORE_BFR_DATAMART_RPC_REFRESH();\n\n");
				...
				class SchemaSettingTool_tDBRow_4_1_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"tDBRow_4\",\"fields\":[{", s);

						a("\"name\":\"BFR_SP_out\",\"type\":[\"boolean\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"BFR_SP_out\",\"talend.field.dbColumnName\":\"BFR_SP_out\",\"di.column.talendType\":\"id_Boolean\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"BFR_SP_out\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tDBRow_4\",\"di.table.label\":\"tDBRow_4\"}",
								s);
				...
				class SchemaSettingTool_tDBRow_4_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"BFR_SP_out\",\"type\":[\"boolean\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"BFR_SP_out\",\"talend.field.dbColumnName\":\"BFR_SP_out\",\"di.column.talendType\":\"id_Boolean\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"BFR_SP_out\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"errorCode\",\"type\":\"string\",\"talend.isLocked\":\"false\",\"talend.field.generated\":\"true\",\"talend.field.length\":\"255\"},{",
								s);

						a("\"name\":\"errorMessage\",\"type\":\"string\",\"talend.isLocked\":\"false\",\"talend.field.generated\":\"true\",\"talend.field.length\":\"255\"}],\"di.table.name\":\"tDBRow_4\",\"di.table.label\":\"tDBRow_4\"}",
								s);
				...
				if (sourceOrSink_tDBRow_4 instanceof org.talend.components.api.component.runtime.Source) {
					org.talend.components.api.component.runtime.Source source_tDBRow_4 = (org.talend.components.api.component.runtime.Source) sourceOrSink_tDBRow_4;
					reader_tDBRow_4 = source_tDBRow_4.createReader(container_tDBRow_4);
					reader_tDBRow_4 = new org.talend.codegen.flowvariables.runtime.FlowVariablesReader(reader_tDBRow_4,
							container_tDBRow_4);

					boolean multi_output_is_allowed_tDBRow_4 = false;
					org.talend.components.api.component.Connector c_tDBRow_4 = null;
					for (org.talend.components.api.component.Connector currentConnector : props_tDBRow_4
					...
					org.talend.codegen.enforcer.OutgoingSchemaEnforcer outgoingEnforcer_tDBRow_4 = org.talend.codegen.enforcer.EnforcerCreator
							.createOutgoingEnforcer(schema_tDBRow_4, false);
					...
					for (; available_tDBRow_4; available_tDBRow_4 = reader_tDBRow_4.advance()) {
						...
						try {
							...
							if (factory_tDBRow_4 == null) {
								factory_tDBRow_4 = (org.talend.daikon.avro.converter.IndexedRecordConverter<Object, ? extends org.apache.avro.generic.IndexedRecord>) new org.talend.daikon.avro.AvroRegistry()
							...
							row1.BFR_SP_out = (Boolean) (columnValue_0_tDBRow_4);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row1", "tDBRow_4", "tDBRow_4", "tSnowflakeRow", "tJavaRow_4", "tJavaRow_4",
									"tJavaRow"
							...
							System.out.println("call STORE_BFR_DATAMART_RPC_REFRESH() status: " + row1.BFR_SP_out);
...
// end of generic
				...
				if (resultMap_tDBRow_4 != null) {
					for (java.util.Map.Entry<String, Object> entry_tDBRow_4 : resultMap_tDBRow_4.entrySet()) {
						...
						default:
							...
							container_tDBRow_4.setComponentData("tDBRow_4",
									studio_key_tDBRow_4.toString().toUpperCase(java.util.Locale.ENGLISH),
									entry_tDBRow_4.getValue());
							break;
						}
					}
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0, "tDBRow_4",
						"tDBRow_4", "tSnowflakeRow", "tJavaRow_4", "tJavaRow_4", "tJavaRow", "output")) {
					talendJobLogProcess(globalMap);
				}
...
// finally of generic
				...
				if (resourceMap.get("finish_tDBRow_4") == null) {
					if (resourceMap.get("reader_tDBRow_4") != null) {
						try {
							((org.talend.components.api.component.runtime.Reader) resourceMap.get("reader_tDBRow_4"))
									.close();
						} catch (java.io.IOException e_tDBRow_4) {
							String errorMessage_tDBRow_4 = "failed to release the resource in tDBRow_4 :"
									+ e_tDBRow_4.getMessage();
							System.err.println(errorMessage_tDBRow_4);
						}
					}
				}
	...
	public static void main(String[] args) {
		final merchant_analytics_refresh merchant_analytics_refreshClass = new merchant_analytics_refresh();

		int exitCode = merchant_analytics_refreshClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'merchant_analytics_refresh' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'merchant_analytics_refresh' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_Kp014BFzEeyHiN8CS12bJg");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-06-02T02:59:44.814542600Z");
		...
		try {
			...
			java.io.InputStream inContext = merchant_analytics_refresh.class.getClassLoader().getResourceAsStream(
					"at_talend_jobs/merchant_analytics_refresh_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = merchant_analytics_refresh.class.getClassLoader()
		...
		log.info("TalendJob: 'merchant_analytics_refresh' - Started.");
		...
		new Thread() {
			public void run() {
				...
				} catch (java.lang.Error e_tDBRow_4) {
					globalMap.put("tDBRow_4_SUBPROCESS_STATE", -1);
					((java.util.Map) threadLocal.get()).put("status", "failure");
					throw e_tDBRow_4;
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : merchant_analytics_refresh");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'merchant_analytics_refresh' - Finished - status: " + status + " returnCode: "
				+ returnCode);
...
/************************************************************************************************
 * 104175 characters generated by Talend Cloud Data Management Platform on the
 * June 1, 2023 at 10:59:44 PM EDT
 ************************************************************************************************/