...
public class PRICE_DETAIL_BY_LOC_SKU_PRCDTL implements TalendJob {
	static {System.setProperty("TalendJob.log", "PRICE_DETAIL_BY_LOC_SKU_PRCDTL.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(PRICE_DETAIL_BY_LOC_SKU_PRCDTL.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_LjBkwNm6EeuE0KkKg4NQQA", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(PRICE_DETAIL_BY_LOC_SKU_PRCDTL.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_PRICE_DETAIL_BY_LOC_SKU_PRCDTL, 0, length, utf8Charset);
		}
		return strReturn;
	}
                ...
                class BytesLimit65535_tFileOutputDelimited_1{
                    ...
                    log4jParamters_tFileOutputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
                            log4jParamters_tFileOutputDelimited_1.append("FILENAME" + " = " + "\"/data/talend/data_repository/PRCDTL.csv\"");
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("/data/talend/data_repository/PRCDTL.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row4","tDBInput_1","tDBInput_1","tAS400Input","tFileOutputDelimited_1","tFileOutputDelimited_1","tFileOutputDelimited"
...
if(row3 != null) { 
	...
	currentComponent="tMap_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row3","tFileInputDelimited_1","tFileInputDelimited_1","tFileInputDelimited","tMap_1","tMap_1","tMap"
...
PRCDTL = PRCDTL_tmp;
log.debug("tMap_1 - Outputting the record " + count_PRCDTL_tMap_1 + " of the output table 'PRCDTL'.");
...
if(PRCDTL != null) { 
	...
	currentComponent="tDBOutput_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"PRCDTL","tMap_1","tMap_1","tMap","tDBOutput_1","tDBOutput_1","tSnowflakeOutput"
...
if(row12 != null) { 
	...
	currentComponent="tJavaRow_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row12","tDBRow_5","tDBRow_5","tSnowflakeRow","tJavaRow_1","tJavaRow_1","tJavaRow"
    ...
    System.out.println("table PROD_DATA.INVENTORY.PRICE_DETAIL_BY_LOC_SKU_PRCDTL status: "+ row12.X_DASH_DET); 
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileDelete_1{
                    ...
                    log4jParamters_tFileDelete_1.append("Parameters:");
                            log4jParamters_tFileDelete_1.append("PATH" + " = " + "\"/data/talend/data_repository/PRCDTL.zip\"");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tSendMail_2{
                    ...
                    log4jParamters_tSendMail_2.append("Parameters:");
                        ...
                        log4jParamters_tSendMail_2.append(" | ");
                            log4jParamters_tSendMail_2.append("MESSAGE" + " = " + "jobName + \"  Failed!!!, this email is triggered from PRICE_DETAIL_BY_LOC_SKU_PRCDTL Subjob because its missing data \" ");
                        log4jParamters_tSendMail_2.append(" | ");
 ...
 */
	...
	String message_tSendMail_2 = ((jobName + "  Failed!!!, this email is triggered from PRICE_DETAIL_BY_LOC_SKU_PRCDTL Subjob because its missing data " ) == null || "".equals(jobName + "  Failed!!!, this email is triggered from PRICE_DETAIL_BY_LOC_SKU_PRCDTL Subjob because its missing data " )) ? "\"\"" : (jobName + "  Failed!!!, this email is triggered from PRICE_DETAIL_BY_LOC_SKU_PRCDTL Subjob because its missing data " ) ;
...
org.talend.components.snowflake.SnowflakeConnectionProperties props_tDBConnection_2 =
        (org.talend.components.snowflake.SnowflakeConnectionProperties) def_tDBConnection_2.createRuntimeProperties();
 		                    ...
 		                    "Talend_user");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:hifKz6ggc7zkDHVeHCnV1KJSJGJ7sw7YgrBueyMOqTLQUb/g"));
...
public void tDBConnection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_3{
                    ...
                    log4jParamters_tDBConnection_3.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_3.append(" | ");
                            log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:hdu5DeIaGxecWtYH3i+MQzj7Ua5133bIy820jcy6Tpp0CA==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_3.append(" | ");
	...
	final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:AwDep75tzFGiSUjavFAZVjR52dIH8bDrn70qOOiPoaXhsw==");
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'PRICE_DETAIL_BY_LOC_SKU_PRCDTL' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-06-27T03:03:56.845746500Z");
        ...
        try {
            ...
            java.io.InputStream inContext = PRICE_DETAIL_BY_LOC_SKU_PRCDTL.class.getClassLoader().getResourceAsStream("at_talend_jobs/price_detail_by_loc_sku_prcdtl_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = PRICE_DETAIL_BY_LOC_SKU_PRCDTL.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_2.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : PRICE_DETAIL_BY_LOC_SKU_PRCDTL");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'PRICE_DETAIL_BY_LOC_SKU_PRCDTL' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     457585 characters generated by Talend Cloud Data Management Platform 
 *     on the June 26, 2023 at 11:03:56 PM EDT
 ************************************************************************************************/