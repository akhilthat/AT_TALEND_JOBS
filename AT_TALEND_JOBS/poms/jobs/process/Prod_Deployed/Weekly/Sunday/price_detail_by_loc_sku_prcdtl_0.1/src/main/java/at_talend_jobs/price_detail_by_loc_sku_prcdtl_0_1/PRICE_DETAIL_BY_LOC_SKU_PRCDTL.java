		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tSendMail_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tSendMail_2.append("MESSAGE" + " = "
									+ "jobName + \"  Failed!!!, this email is triggered from PRICE_DETAIL_BY_LOC_SKU_PRCDTL Subjob because its missing data \" ");
							log4jParamters_tSendMail_2.append(" | ");
				...
				String message_tSendMail_2 = ((jobName
						+ "  Failed!!!, this email is triggered from PRICE_DETAIL_BY_LOC_SKU_PRCDTL Subjob because its missing data ") == null
						|| "".equals(jobName
								+ "  Failed!!!, this email is triggered from PRICE_DETAIL_BY_LOC_SKU_PRCDTL Subjob because its missing data "))
										? "\"\""
										: (jobName
												+ "  Failed!!!, this email is triggered from PRICE_DETAIL_BY_LOC_SKU_PRCDTL Subjob because its missing data ");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_2.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:Xux4AU9GoWL2da1dcFtFlcZpz8EULFCN89iKpv4ans7bzTYu"));
...
// finally of generic
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:xHuaaMw2963DwS5kNnm4FmPmic4eqVlrVJPflL8e/9BP/g==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_3.append(" | ");
				...
				final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:GA13l44tBDu5vqF0+ZFgMebPZs2G461bkrU/YzAF583fWA==");
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-07-10T14:30:40.115469100Z");
...
/************************************************************************************************
 * 457726 characters generated by Talend Cloud Data Management Platform on the
 * July 10, 2023 at 10:30:40 AM EDT
 ************************************************************************************************/