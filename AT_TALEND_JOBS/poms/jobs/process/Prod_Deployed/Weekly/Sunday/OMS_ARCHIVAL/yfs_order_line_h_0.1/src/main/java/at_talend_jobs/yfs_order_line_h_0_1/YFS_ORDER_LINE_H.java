...
public class YFS_ORDER_LINE_H implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "YFS_ORDER_LINE_H.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(YFS_ORDER_LINE_H.class);
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_1.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:NdUWt9MKtNT6yT7RirgwN9N1Z8oRqgR1MBy/vwjLHaOh93sN"));
...
// finally of generic
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:1vkmfUTjtCVM650fEzWfju7ZM+Lbj+2/p7YJhV0qQsf5DKpdReI=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_3.append(" | ");
				...
				final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:TBJXWxDrVLbbN8quYpQstmWTU2NrTsGGGMAb0sg7y5oAAVMDBHw=");
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-06-14T15:30:12.620416200Z");
		...
		try {
			...
			java.io.InputStream inContext = YFS_ORDER_LINE_H.class.getClassLoader()
					.getResourceAsStream("at_talend_jobs/yfs_order_line_h_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = YFS_ORDER_LINE_H.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : YFS_ORDER_LINE_H");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 97081 characters generated by Talend Cloud Data Management Platform on the
 * June 14, 2023 at 11:30:12 AM EDT
 ************************************************************************************************/