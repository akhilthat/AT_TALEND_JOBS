...
package at_talend_jobs.yfs_tax_breakup_h_0_1;
...
/**
 * Job: YFS_TAX_BREAKUP_H Purpose: <br>
 * Description:  <br>
 * @author thati, akhil
 * @version 8.0.1.20230418_1502-patch
 * @status 
 */
public class YFS_TAX_BREAKUP_H implements TalendJob {
	static {System.setProperty("TalendJob.log", "YFS_TAX_BREAKUP_H.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(YFS_TAX_BREAKUP_H.class);
...
public String getSF_warehouse(){
	...
	private final String jobName = "YFS_TAX_BREAKUP_H";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_KvRgAOv3Eeui_7U8UwU2ug", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				YFS_TAX_BREAKUP_H.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(YFS_TAX_BREAKUP_H.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
org.talend.components.snowflake.SnowflakeConnectionProperties props_tDBConnection_1 =
        (org.talend.components.snowflake.SnowflakeConnectionProperties) def_tDBConnection_1.createRuntimeProperties();
 		                    ...
 		                    "Talend_user");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:PHSaBVAOUfuKz+8eYA4nqzSLgzJOiMMRH29oTS/Bg6iPhs4n"));
...
public void tDBConnection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_3{
                    ...
                    log4jParamters_tDBConnection_3.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_3.append(" | ");
                            log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:a8ZscEgOKpU7bS5eoekzer6cBUdrwwF84KtVrTMwJ9n4aLAMn3s=").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_3.append(" | ");
	...
	final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:7i6eUMYqI2JI8iBwxOCgOAc3nczkRa75EX68Gvps/9VzLWdBZ24=");
...
org.talend.components.snowflake.tsnowflakerow.TSnowflakeRowProperties props_tDBRow_1 =
        (org.talend.components.snowflake.tsnowflakerow.TSnowflakeRowProperties) def_tDBRow_1.createRuntimeProperties();
 		                    ...
 		                    "\nDelete from YFS_TAX_BREAKUP_H\nwhere MODIFYTS >= cast(substr(convert_timezone('America/New_York', DATEADD(DAY, -7, cu"
+"rrent_timestamp())),0,10) as TIMESTAMPNTZ);\n\n");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AT_TALEND_JOBS_YFS_TAX_BREAKUP_H = new byte[0];
    static byte[] commonByteArray_AT_TALEND_JOBS_YFS_TAX_BREAKUP_H = new byte[0];

	
			    public String TAX_BREAKUP_KEY;

				public String getTAX_BREAKUP_KEY () {
					return this.TAX_BREAKUP_KEY;
				}

				public Boolean TAX_BREAKUP_KEYIsNullable(){
				    return false;
				}
				public Boolean TAX_BREAKUP_KEYIsKey(){
				    return false;
				}
				public Integer TAX_BREAKUP_KEYLength(){
				    return null;
				}
				public Integer TAX_BREAKUP_KEYPrecision(){
				    return null;
				}
				public String TAX_BREAKUP_KEYDefault(){
				
					return null;
				
				}
				public String TAX_BREAKUP_KEYComment(){
				
				    return "";
				
				}
				public String TAX_BREAKUP_KEYPattern(){
				
					return "";
				
				}
				public String TAX_BREAKUP_KEYOriginalDbColumnName(){
				
					return "TAX_BREAKUP_KEY";
				...
				public Boolean HEADER_KEYIsNullable(){
				    return false;
				}
				public Boolean HEADER_KEYIsKey(){
				    return false;
				}
				public Integer HEADER_KEYLength(){
				    return null;
				}
				public Integer HEADER_KEYPrecision(){
				    return null;
				}
				public String HEADER_KEYDefault(){
				
					return null;
				
				}
				public String HEADER_KEYComment(){
				
				    return "";
				
				}
				public String HEADER_KEYPattern(){
				
					return "";
				
				}
				public String HEADER_KEYOriginalDbColumnName(){
				...
				public Boolean LINE_KEYIsNullable(){
				    return false;
				}
				public Boolean LINE_KEYIsKey(){
				    return false;
				}
				public Integer LINE_KEYLength(){
				    return null;
				}
				public Integer LINE_KEYPrecision(){
				    return null;
				}
				public String LINE_KEYDefault(){
				
					return null;
				
				}
				public String LINE_KEYComment(){
				
				    return "";
				
				}
				public String LINE_KEYPattern(){
				
					return "";
				
				}
				public String LINE_KEYOriginalDbColumnName(){
				...
				public Boolean CHARGE_CATEGORYIsNullable(){
				    return false;
				}
				public Boolean CHARGE_CATEGORYIsKey(){
				    return false;
				}
				public Integer CHARGE_CATEGORYLength(){
				    return null;
				}
				public Integer CHARGE_CATEGORYPrecision(){
				    return null;
				}
				public String CHARGE_CATEGORYDefault(){
				
					return null;
				
				}
				public String CHARGE_CATEGORYComment(){
				
				    return "";
				
				}
				public String CHARGE_CATEGORYPattern(){
				
					return "";
				
				}
				public String CHARGE_CATEGORYOriginalDbColumnName(){
				...
				public Boolean CHARGE_NAMEIsNullable(){
				    return false;
				}
				public Boolean CHARGE_NAMEIsKey(){
				    return false;
				}
				public Integer CHARGE_NAMELength(){
				    return null;
				}
				public Integer CHARGE_NAMEPrecision(){
				    return null;
				}
				public String CHARGE_NAMEDefault(){
				
					return null;
				
				}
				public String CHARGE_NAMEComment(){
				
				    return "";
				
				}
				public String CHARGE_NAMEPattern(){
				
					return "";
				
				}
				public String CHARGE_NAMEOriginalDbColumnName(){
				...
				public Boolean TAX_NAMEIsNullable(){
				    return false;
				}
				public Boolean TAX_NAMEIsKey(){
				    return false;
				}
				public Integer TAX_NAMELength(){
				    return null;
				}
				public Integer TAX_NAMEPrecision(){
				    return null;
				}
				public String TAX_NAMEDefault(){
				
					return null;
				
				}
				public String TAX_NAMEComment(){
				
				    return "";
				
				}
				public String TAX_NAMEPattern(){
				
					return "";
				
				}
				public String TAX_NAMEOriginalDbColumnName(){
				...
				public Boolean TAX_PERCENTAGEIsNullable(){
				    return false;
				}
				public Boolean TAX_PERCENTAGEIsKey(){
				    return false;
				}
				public Integer TAX_PERCENTAGELength(){
				    return null;
				}
				public Integer TAX_PERCENTAGEPrecision(){
				    return null;
				}
				public String TAX_PERCENTAGEDefault(){
				
					return "";
				
				}
				public String TAX_PERCENTAGEComment(){
				
				    return "";
				
				}
				public String TAX_PERCENTAGEPattern(){
				
					return "";
				
				}
				public String TAX_PERCENTAGEOriginalDbColumnName(){
			    ...
			    public BigDecimal INVOICED_TAX;

				public BigDecimal getINVOICED_TAX () {
					return this.INVOICED_TAX;
				}

				public Boolean INVOICED_TAXIsNullable(){
				    return false;
				}
				public Boolean INVOICED_TAXIsKey(){
				    return false;
				}
				public Integer INVOICED_TAXLength(){
				    return null;
				}
				public Integer INVOICED_TAXPrecision(){
				    return null;
				}
				public String INVOICED_TAXDefault(){
				
					return "";
				
				}
				public String INVOICED_TAXComment(){
				
				    return "";
				
				}
				public String INVOICED_TAXPattern(){
				
					return "";
				
				}
				public String INVOICED_TAXOriginalDbColumnName(){
			    ...
			    public String EXTN_TAX_PER_UNIT;

				public String getEXTN_TAX_PER_UNIT () {
					return this.EXTN_TAX_PER_UNIT;
				}

				public Boolean EXTN_TAX_PER_UNITIsNullable(){
				    return true;
				}
				public Boolean EXTN_TAX_PER_UNITIsKey(){
				    return false;
				}
				public Integer EXTN_TAX_PER_UNITLength(){
				    return null;
				}
				public Integer EXTN_TAX_PER_UNITPrecision(){
				    return null;
				}
				public String EXTN_TAX_PER_UNITDefault(){
				
					return null;
				
				}
				public String EXTN_TAX_PER_UNITComment(){
				
				    return "";
				
				}
				public String EXTN_TAX_PER_UNITPattern(){
				
					return "";
				
				}
				public String EXTN_TAX_PER_UNITOriginalDbColumnName(){
				
					return "EXTN_TAX_PER_UNIT";
				
				}

				
			    public String EXTN_TAX_AREA_ID;

				public String getEXTN_TAX_AREA_ID () {
					return this.EXTN_TAX_AREA_ID;
				}

				public Boolean EXTN_TAX_AREA_IDIsNullable(){
				    return true;
				}
				public Boolean EXTN_TAX_AREA_IDIsKey(){
				    return false;
				}
				public Integer EXTN_TAX_AREA_IDLength(){
				    return null;
				}
				public Integer EXTN_TAX_AREA_IDPrecision(){
				    return null;
				}
				public String EXTN_TAX_AREA_IDDefault(){
				
					return null;
				
				}
				public String EXTN_TAX_AREA_IDComment(){
				
				    return "";
				
				}
				public String EXTN_TAX_AREA_IDPattern(){
				
					return "";
				
				}
				public String EXTN_TAX_AREA_IDOriginalDbColumnName(){
				
					return "EXTN_TAX_AREA_ID";
				
				}

				
			    public String EXTN_TAX_TYPE;

				public String getEXTN_TAX_TYPE () {
					return this.EXTN_TAX_TYPE;
				}

				public Boolean EXTN_TAX_TYPEIsNullable(){
				    return true;
				}
				public Boolean EXTN_TAX_TYPEIsKey(){
				    return false;
				}
				public Integer EXTN_TAX_TYPELength(){
				    return null;
				}
				public Integer EXTN_TAX_TYPEPrecision(){
				    return null;
				}
				public String EXTN_TAX_TYPEDefault(){
				
					return null;
				
				}
				public String EXTN_TAX_TYPEComment(){
				
				    return "";
				
				}
				public String EXTN_TAX_TYPEPattern(){
				
					return "";
				
				}
				public String EXTN_TAX_TYPEOriginalDbColumnName(){
				
					return "EXTN_TAX_TYPE";
				
				}

				
			    public String EXTN_GROUP_ID;

				public String getEXTN_GROUP_ID () {
					return this.EXTN_GROUP_ID;
				}

				public Boolean EXTN_GROUP_IDIsNullable(){
				    return true;
				}
				public Boolean EXTN_GROUP_IDIsKey(){
				    return false;
				}
				public Integer EXTN_GROUP_IDLength(){
				    return null;
				}
				public Integer EXTN_GROUP_IDPrecision(){
				    return null;
				}
				public String EXTN_GROUP_IDDefault(){
				
					return null;
				
				}
				public String EXTN_GROUP_IDComment(){
				
				    return "";
				
				}
				public String EXTN_GROUP_IDPattern(){
				
					return "";
				
				}
				public String EXTN_GROUP_IDOriginalDbColumnName(){
				
					return "EXTN_GROUP_ID";
				
				}

				
			    public String EXTN_ZONE_ID;

				public String getEXTN_ZONE_ID () {
					return this.EXTN_ZONE_ID;
				}

				public Boolean EXTN_ZONE_IDIsNullable(){
				    return true;
				}
				public Boolean EXTN_ZONE_IDIsKey(){
				    return false;
				}
				public Integer EXTN_ZONE_IDLength(){
				    return null;
				}
				public Integer EXTN_ZONE_IDPrecision(){
				    return null;
				}
				public String EXTN_ZONE_IDDefault(){
				
					return null;
				
				}
				public String EXTN_ZONE_IDComment(){
				
				    return "";
				
				}
				public String EXTN_ZONE_IDPattern(){
				
					return "";
				
				}
				public String EXTN_ZONE_IDOriginalDbColumnName(){
			    ...
			    public String EXTN_IS_OVERRIDE_ZONE;

				public String getEXTN_IS_OVERRIDE_ZONE () {
					return this.EXTN_IS_OVERRIDE_ZONE;
				}

				public Boolean EXTN_IS_OVERRIDE_ZONEIsNullable(){
				    return true;
				}
				public Boolean EXTN_IS_OVERRIDE_ZONEIsKey(){
				    return false;
				}
				public Integer EXTN_IS_OVERRIDE_ZONELength(){
				    return null;
				}
				public Integer EXTN_IS_OVERRIDE_ZONEPrecision(){
				    return null;
				}
				public String EXTN_IS_OVERRIDE_ZONEDefault(){
				
					return null;
				
				}
				public String EXTN_IS_OVERRIDE_ZONEComment(){
				
				    return "";
				
				}
				public String EXTN_IS_OVERRIDE_ZONEPattern(){
				
					return "";
				
				}
				public String EXTN_IS_OVERRIDE_ZONEOriginalDbColumnName(){
				
					return "EXTN_IS_OVERRIDE_ZONE";
				
				}

				
			    public String EXTN_IS_MANUAL;

				public String getEXTN_IS_MANUAL () {
					return this.EXTN_IS_MANUAL;
				}

				public Boolean EXTN_IS_MANUALIsNullable(){
				    return true;
				}
				public Boolean EXTN_IS_MANUALIsKey(){
				    return false;
				}
				public Integer EXTN_IS_MANUALLength(){
				    return null;
				}
				public Integer EXTN_IS_MANUALPrecision(){
				    return null;
				}
				public String EXTN_IS_MANUALDefault(){
				
					return null;
				
				}
				public String EXTN_IS_MANUALComment(){
				
				    return "";
				
				}
				public String EXTN_IS_MANUALPattern(){
				
					return "";
				
				}
				public String EXTN_IS_MANUALOriginalDbColumnName(){
				
					return "EXTN_IS_MANUAL";
				
				}

				
			    public String EXTN_RULE_ID;

				public String getEXTN_RULE_ID () {
					return this.EXTN_RULE_ID;
				}

				public Boolean EXTN_RULE_IDIsNullable(){
				    return true;
				}
				public Boolean EXTN_RULE_IDIsKey(){
				    return false;
				}
				public Integer EXTN_RULE_IDLength(){
				    return null;
				}
				public Integer EXTN_RULE_IDPrecision(){
				    return null;
				}
				public String EXTN_RULE_IDDefault(){
				
					return null;
				
				}
				public String EXTN_RULE_IDComment(){
				
				    return "";
				
				}
				public String EXTN_RULE_IDPattern(){
				
					return "";
				
				}
				public String EXTN_RULE_IDOriginalDbColumnName(){
			    ...
			    public String EXTN_IS_TRAN_LEVEL;

				public String getEXTN_IS_TRAN_LEVEL () {
					return this.EXTN_IS_TRAN_LEVEL;
				}

				public Boolean EXTN_IS_TRAN_LEVELIsNullable(){
				    return true;
				}
				public Boolean EXTN_IS_TRAN_LEVELIsKey(){
				    return false;
				}
				public Integer EXTN_IS_TRAN_LEVELLength(){
				    return null;
				}
				public Integer EXTN_IS_TRAN_LEVELPrecision(){
				    return null;
				}
				public String EXTN_IS_TRAN_LEVELDefault(){
				
					return null;
				
				}
				public String EXTN_IS_TRAN_LEVELComment(){
				
				    return "";
				
				}
				public String EXTN_IS_TRAN_LEVELPattern(){
				
					return "";
				
				}
				public String EXTN_IS_TRAN_LEVELOriginalDbColumnName(){
				
					return "EXTN_IS_TRAN_LEVEL";
				
				}

				
			    public String EXTN_REFERENCE_1;

				public String getEXTN_REFERENCE_1 () {
					return this.EXTN_REFERENCE_1;
				}

				public Boolean EXTN_REFERENCE_1IsNullable(){
				    return true;
				}
				public Boolean EXTN_REFERENCE_1IsKey(){
				    return false;
				}
				public Integer EXTN_REFERENCE_1Length(){
				    return null;
				}
				public Integer EXTN_REFERENCE_1Precision(){
				    return null;
				}
				public String EXTN_REFERENCE_1Default(){
				
					return null;
				
				}
				public String EXTN_REFERENCE_1Comment(){
				
				    return "";
				
				}
				public String EXTN_REFERENCE_1Pattern(){
				
					return "";
				
				}
				public String EXTN_REFERENCE_1OriginalDbColumnName(){
				
					return "EXTN_REFERENCE_1";
				
				}

				
			    public String EXTN_REFERENCE_2;

				public String getEXTN_REFERENCE_2 () {
					return this.EXTN_REFERENCE_2;
				}

				public Boolean EXTN_REFERENCE_2IsNullable(){
				    return true;
				}
				public Boolean EXTN_REFERENCE_2IsKey(){
				    return false;
				}
				public Integer EXTN_REFERENCE_2Length(){
				    return null;
				}
				public Integer EXTN_REFERENCE_2Precision(){
				    return null;
				}
				public String EXTN_REFERENCE_2Default(){
				
					return null;
				
				}
				public String EXTN_REFERENCE_2Comment(){
				
				    return "";
				
				}
				public String EXTN_REFERENCE_2Pattern(){
				
					return "";
				
				}
				public String EXTN_REFERENCE_2OriginalDbColumnName(){
				
					return "EXTN_REFERENCE_2";
				
				}

				
			    public String EXTN_REFERENCE_3;

				public String getEXTN_REFERENCE_3 () {
					return this.EXTN_REFERENCE_3;
				}

				public Boolean EXTN_REFERENCE_3IsNullable(){
				    return true;
				}
				public Boolean EXTN_REFERENCE_3IsKey(){
				    return false;
				}
				public Integer EXTN_REFERENCE_3Length(){
				    return null;
				}
				public Integer EXTN_REFERENCE_3Precision(){
				    return null;
				}
				public String EXTN_REFERENCE_3Default(){
				
					return null;
				
				}
				public String EXTN_REFERENCE_3Comment(){
				
				    return "";
				
				}
				public String EXTN_REFERENCE_3Pattern(){
				
					return "";
				
				}
				public String EXTN_REFERENCE_3OriginalDbColumnName(){
				
					return "EXTN_REFERENCE_3";
			    ...
			    public String EXTN_REMAINING_TAX_PER_LINE;

				public String getEXTN_REMAINING_TAX_PER_LINE () {
					return this.EXTN_REMAINING_TAX_PER_LINE;
				}

				public Boolean EXTN_REMAINING_TAX_PER_LINEIsNullable(){
				    return true;
				}
				public Boolean EXTN_REMAINING_TAX_PER_LINEIsKey(){
				    return false;
				}
				public Integer EXTN_REMAINING_TAX_PER_LINELength(){
				    return null;
				}
				public Integer EXTN_REMAINING_TAX_PER_LINEPrecision(){
				    return null;
				}
				public String EXTN_REMAINING_TAX_PER_LINEDefault(){
				
					return null;
				
				}
				public String EXTN_REMAINING_TAX_PER_LINEComment(){
				
				    return "";
				
				}
				public String EXTN_REMAINING_TAX_PER_LINEPattern(){
				
					return "";
				
				}
				public String EXTN_REMAINING_TAX_PER_LINEOriginalDbColumnName(){
				
					return "EXTN_REMAINING_TAX_PER_LINE";
				
				}

				
			    public String EXTN_COUNTY;

				public String getEXTN_COUNTY () {
					return this.EXTN_COUNTY;
				}

				public Boolean EXTN_COUNTYIsNullable(){
				    return true;
				}
				public Boolean EXTN_COUNTYIsKey(){
				    return false;
				}
				public Integer EXTN_COUNTYLength(){
				    return null;
				}
				public Integer EXTN_COUNTYPrecision(){
				    return null;
				}
				public String EXTN_COUNTYDefault(){
				
					return null;
				
				}
				public String EXTN_COUNTYComment(){
				
				    return "";
				
				}
				public String EXTN_COUNTYPattern(){
				
					return "";
				
				}
				public String EXTN_COUNTYOriginalDbColumnName(){
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AT_TALEND_JOBS_YFS_TAX_BREAKUP_H.length) {
				if(length < 1024 && commonByteArray_AT_TALEND_JOBS_YFS_TAX_BREAKUP_H.length == 0) {
   					commonByteArray_AT_TALEND_JOBS_YFS_TAX_BREAKUP_H = new byte[1024];
				} else {
   					commonByteArray_AT_TALEND_JOBS_YFS_TAX_BREAKUP_H = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AT_TALEND_JOBS_YFS_TAX_BREAKUP_H, 0, length);
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_YFS_TAX_BREAKUP_H, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AT_TALEND_JOBS_YFS_TAX_BREAKUP_H, 0, length);
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_YFS_TAX_BREAKUP_H, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AT_TALEND_JOBS_YFS_TAX_BREAKUP_H) {

        	try {

        		int length = 0;
		
					this.TAX_BREAKUP_KEY = readString(dis);
					
					this.HEADER_KEY = readString(dis);
					
					this.LINE_KEY = readString(dis);
					
					this.RECORD_TYPE = readString(dis);
					
					this.CHARGE_CATEGORY = readString(dis);
					
					this.CHARGE_NAME = readString(dis);
					
					this.TAX_NAME = readString(dis);
					
					this.TAXABLE_FLAG = readString(dis);
					
						this.TAX_PERCENTAGE = (BigDecimal) dis.readObject();
					
						this.TAX = (BigDecimal) dis.readObject();
					
						this.INVOICED_TAX = (BigDecimal) dis.readObject();
					...
					this.EXTN_TAX_PER_UNIT = readString(dis);
					
					this.EXTN_TAX_AREA_ID = readString(dis);
					
					this.EXTN_TAX_TYPE = readString(dis);
					
					this.EXTN_GROUP_ID = readString(dis);
					
					this.EXTN_ZONE_ID = readString(dis);
					
					this.EXTN_IS_OVERRIDE_ZONE = readString(dis);
					
					this.EXTN_IS_MANUAL = readString(dis);
					
					this.EXTN_RULE_ID = readString(dis);
					
					this.EXTN_IS_TRAN_LEVEL = readString(dis);
					
					this.EXTN_REFERENCE_1 = readString(dis);
					
					this.EXTN_REFERENCE_2 = readString(dis);
					
					this.EXTN_REFERENCE_3 = readString(dis);
					
					this.EXTN_IS_TAX_CALCULATED = readString(dis);
					
					this.EXTN_VERTEX_ENGINE = readString(dis);
					
					this.EXTN_REMAINING_TAX_PER_LINE = readString(dis);
					
					this.EXTN_COUNTY = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.TAX_BREAKUP_KEY,dos);
					
					// String
				
						writeString(this.HEADER_KEY,dos);
					
					// String
				
						writeString(this.LINE_KEY,dos);
					...
					// String
						...
						writeString(this.CHARGE_CATEGORY,dos);
					
					// String
				
						writeString(this.CHARGE_NAME,dos);
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.TAX_PERCENTAGE);
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.INVOICED_TAX);
					...
					// String
						...
						writeString(this.EXTN_TAX_PER_UNIT,dos);
					
					// String
				
						writeString(this.EXTN_TAX_AREA_ID,dos);
					
					// String
				
						writeString(this.EXTN_TAX_TYPE,dos);
					
					// String
				
						writeString(this.EXTN_GROUP_ID,dos);
					
					// String
				
						writeString(this.EXTN_ZONE_ID,dos);
					
					// String
				
						writeString(this.EXTN_IS_OVERRIDE_ZONE,dos);
					
					// String
				
						writeString(this.EXTN_IS_MANUAL,dos);
					
					// String
				
						writeString(this.EXTN_RULE_ID,dos);
					
					// String
				
						writeString(this.EXTN_IS_TRAN_LEVEL,dos);
					
					// String
				
						writeString(this.EXTN_REFERENCE_1,dos);
					
					// String
				
						writeString(this.EXTN_REFERENCE_2,dos);
					
					// String
				
						writeString(this.EXTN_REFERENCE_3,dos);
					...
					// String
						...
						writeString(this.EXTN_REMAINING_TAX_PER_LINE,dos);
					
					// String
				
						writeString(this.EXTN_COUNTY,dos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("TAX_BREAKUP_KEY="+TAX_BREAKUP_KEY);
		sb.append(",HEADER_KEY="+HEADER_KEY);
		sb.append(",LINE_KEY="+LINE_KEY);
		sb.append(",RECORD_TYPE="+RECORD_TYPE);
		sb.append(",CHARGE_CATEGORY="+CHARGE_CATEGORY);
		sb.append(",CHARGE_NAME="+CHARGE_NAME);
		sb.append(",TAX_NAME="+TAX_NAME);
		sb.append(",TAXABLE_FLAG="+TAXABLE_FLAG);
		sb.append(",TAX_PERCENTAGE="+String.valueOf(TAX_PERCENTAGE));
		sb.append(",TAX="+String.valueOf(TAX));
		sb.append(",INVOICED_TAX="+String.valueOf(INVOICED_TAX));
		...
		sb.append(",EXTN_TAX_PER_UNIT="+EXTN_TAX_PER_UNIT);
		sb.append(",EXTN_TAX_AREA_ID="+EXTN_TAX_AREA_ID);
		sb.append(",EXTN_TAX_TYPE="+EXTN_TAX_TYPE);
		sb.append(",EXTN_GROUP_ID="+EXTN_GROUP_ID);
		sb.append(",EXTN_ZONE_ID="+EXTN_ZONE_ID);
		sb.append(",EXTN_IS_OVERRIDE_ZONE="+EXTN_IS_OVERRIDE_ZONE);
		sb.append(",EXTN_IS_MANUAL="+EXTN_IS_MANUAL);
		sb.append(",EXTN_RULE_ID="+EXTN_RULE_ID);
		sb.append(",EXTN_IS_TRAN_LEVEL="+EXTN_IS_TRAN_LEVEL);
		sb.append(",EXTN_REFERENCE_1="+EXTN_REFERENCE_1);
		sb.append(",EXTN_REFERENCE_2="+EXTN_REFERENCE_2);
		sb.append(",EXTN_REFERENCE_3="+EXTN_REFERENCE_3);
		sb.append(",EXTN_IS_TAX_CALCULATED="+EXTN_IS_TAX_CALCULATED);
		sb.append(",EXTN_VERTEX_ENGINE="+EXTN_VERTEX_ENGINE);
		sb.append(",EXTN_REMAINING_TAX_PER_LINE="+EXTN_REMAINING_TAX_PER_LINE);
		sb.append(",EXTN_COUNTY="+EXTN_COUNTY);
	    sb.append("]");
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        				...
        				if(TAX_BREAKUP_KEY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(TAX_BREAKUP_KEY);
            			}
        			...
        			sb.append("|");
        				...
        				if(CHARGE_CATEGORY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(CHARGE_CATEGORY);
            			}
        			...
        			sb.append("|");
        				...
        				if(INVOICED_TAX == null){
        					sb.append("<null>");
        				}else{
            				sb.append(INVOICED_TAX);
            			}
        			...
        			sb.append("|");
        				...
        				if(EXTN_TAX_PER_UNIT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(EXTN_TAX_PER_UNIT);
            			}
            		
        			sb.append("|");
        		
        				if(EXTN_TAX_AREA_ID == null){
        					sb.append("<null>");
        				}else{
            				sb.append(EXTN_TAX_AREA_ID);
            			}
            		
        			sb.append("|");
        		
        				if(EXTN_TAX_TYPE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(EXTN_TAX_TYPE);
            			}
            		
        			sb.append("|");
        		
        				if(EXTN_GROUP_ID == null){
        					sb.append("<null>");
        				}else{
            				sb.append(EXTN_GROUP_ID);
            			}
            		
        			sb.append("|");
        		
        				if(EXTN_ZONE_ID == null){
        					sb.append("<null>");
        				}else{
            				sb.append(EXTN_ZONE_ID);
            			}
            		
        			sb.append("|");
        		
        				if(EXTN_IS_OVERRIDE_ZONE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(EXTN_IS_OVERRIDE_ZONE);
            			}
            		
        			sb.append("|");
        		
        				if(EXTN_IS_MANUAL == null){
        					sb.append("<null>");
        				}else{
            				sb.append(EXTN_IS_MANUAL);
            			}
            		
        			sb.append("|");
        		
        				if(EXTN_RULE_ID == null){
        					sb.append("<null>");
        				}else{
            				sb.append(EXTN_RULE_ID);
            			}
            		
        			sb.append("|");
        		
        				if(EXTN_IS_TRAN_LEVEL == null){
        					sb.append("<null>");
        				}else{
            				sb.append(EXTN_IS_TRAN_LEVEL);
            			}
            		
        			sb.append("|");
        		
        				if(EXTN_REFERENCE_1 == null){
        					sb.append("<null>");
        				}else{
            				sb.append(EXTN_REFERENCE_1);
            			}
            		
        			sb.append("|");
        		
        				if(EXTN_REFERENCE_2 == null){
        					sb.append("<null>");
        				}else{
            				sb.append(EXTN_REFERENCE_2);
            			}
            		
        			sb.append("|");
        		
        				if(EXTN_REFERENCE_3 == null){
        					sb.append("<null>");
        				}else{
            				sb.append(EXTN_REFERENCE_3);
            			}
        			...
        			sb.append("|");
        				...
        				if(EXTN_REMAINING_TAX_PER_LINE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(EXTN_REMAINING_TAX_PER_LINE);
            			}
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_1_2_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"TAX_BREAKUP_KEY\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TAX_BREAKUP_KEY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TAX_BREAKUP_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TAX_BREAKUP_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"HEADER_KEY\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"HEADER_KEY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"HEADER_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"HEADER_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"LINE_KEY\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"LINE_KEY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"LINE_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"LINE_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"RECORD_TYPE\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"RECORD_TYPE\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"RECORD_TYPE\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"RECORD_TYPE\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CHARGE_CATEGORY\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CHARGE_CATEGORY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"CHARGE_CATEGORY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CHARGE_CATEGORY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CHARGE_NAME\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CHARGE_NAME\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"CHARGE_NAME\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CHARGE_NAME\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"TAX_NAME\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TAX_NAME\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"TAX_NAME\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TAX_NAME\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"TAX_PERCENTAGE\",\"type\":{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"TAX_PERCENTAGE\",\"talend.field.dbColumnName\":\"TAX_PERCENTAGE\",\"di.column.talendType\":\"id_BigDecimal\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"TAX_PERCENTAGE\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"INVOICED_TAX\",\"type\":{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"INVOICED_TAX\",\"talend.field.dbColumnName\":\"INVOICED_TAX\",\"di.column.talendType\":\"id_BigDecimal\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"INVOICED_TAX\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"REFERENCE1\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"REFERENCE1\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"REFERENCE1\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"REFERENCE1\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"REFERENCE2\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"REFERENCE2\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"REFERENCE2\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"REFERENCE2\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"REFERENCE3\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"REFERENCE3\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"REFERENCE3\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"REFERENCE3\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"EXTN_TAX_PER_UNIT\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"EXTN_TAX_PER_UNIT\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"EXTN_TAX_PER_UNIT\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"EXTN_TAX_PER_UNIT\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"EXTN_TAX_AREA_ID\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"EXTN_TAX_AREA_ID\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"EXTN_TAX_AREA_ID\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"EXTN_TAX_AREA_ID\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"EXTN_TAX_TYPE\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"EXTN_TAX_TYPE\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"EXTN_TAX_TYPE\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"EXTN_TAX_TYPE\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"EXTN_GROUP_ID\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"EXTN_GROUP_ID\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"EXTN_GROUP_ID\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"EXTN_GROUP_ID\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"EXTN_ZONE_ID\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"EXTN_ZONE_ID\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"EXTN_ZONE_ID\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"EXTN_ZONE_ID\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"EXTN_IS_OVERRIDE_ZONE\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"EXTN_IS_OVERRIDE_ZONE\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"EXTN_IS_OVERRIDE_ZONE\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"EXTN_IS_OVERRIDE_ZONE\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"EXTN_IS_MANUAL\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"EXTN_IS_MANUAL\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"EXTN_IS_MANUAL\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"EXTN_IS_MANUAL\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"EXTN_RULE_ID\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"EXTN_RULE_ID\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"EXTN_RULE_ID\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"EXTN_RULE_ID\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"EXTN_IS_TRAN_LEVEL\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"EXTN_IS_TRAN_LEVEL\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"EXTN_IS_TRAN_LEVEL\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"EXTN_IS_TRAN_LEVEL\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"EXTN_REFERENCE_1\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"EXTN_REFERENCE_1\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"EXTN_REFERENCE_1\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"EXTN_REFERENCE_1\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"EXTN_REFERENCE_2\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"EXTN_REFERENCE_2\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"EXTN_REFERENCE_2\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"EXTN_REFERENCE_2\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"EXTN_REFERENCE_3\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"EXTN_REFERENCE_3\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"EXTN_REFERENCE_3\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"EXTN_REFERENCE_3\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"EXTN_REMAINING_TAX_PER_LINE\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"EXTN_REMAINING_TAX_PER_LINE\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"EXTN_REMAINING_TAX_PER_LINE\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"EXTN_REMAINING_TAX_PER_LINE\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"EXTN_COUNTY\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"EXTN_COUNTY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"EXTN_COUNTY\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"EXTN_COUNTY\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tDBOutput_1\",\"di.table.label\":\"tDBOutput_1\"}",s);
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"  select * from STERLING.YFS_TAX_BREAKUP_H where TO_CHAR(MODIFYTS, 'YYYY-MM-DD HH:MI:SS') >= TO_CHAR((sysdate - 7), 'YYYY-MM-DD HH:MI:SS')    \"");
                        log4jParamters_tDBInput_1.append(" | ");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("TAX_BREAKUP_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("HEADER_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LINE_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("RECORD_TYPE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CHARGE_CATEGORY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CHARGE_NAME")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAX_NAME")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAXABLE_FLAG")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAX_PERCENTAGE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("TAX")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("INVOICED_TAX")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("REFERENCE1")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("REFERENCE2")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("REFERENCE3")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATETS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYTS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATEUSERID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYUSERID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATEPROGID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYPROGID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LOCKID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXTN_TAX_PER_UNIT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXTN_TAX_AREA_ID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXTN_TAX_TYPE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXTN_GROUP_ID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXTN_ZONE_ID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXTN_IS_OVERRIDE_ZONE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXTN_IS_MANUAL")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXTN_RULE_ID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXTN_IS_TRAN_LEVEL")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXTN_REFERENCE_1")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXTN_REFERENCE_2")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXTN_REFERENCE_3")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXTN_IS_TAX_CALCULATED")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXTN_VERTEX_ENGINE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXTN_REMAINING_TAX_PER_LINE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXTN_COUNTY")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
		    ...
		    String dbquery_tDBInput_1 = "\nselect * from STERLING.YFS_TAX_BREAKUP_H where TO_CHAR(MODIFYTS, 'YYYY-MM-DD HH:MI:SS') >= TO_CHAR((sysdate - 7), 'YY"
+"YY-MM-DD HH:MI:SS')\n\n";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row1.TAX_BREAKUP_KEY = null;
							} else {
	                         		
        	row1.TAX_BREAKUP_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.HEADER_KEY = null;
							} else {
	                         		
        	row1.HEADER_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.LINE_KEY = null;
							} else {
	                         		
        	row1.LINE_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.RECORD_TYPE = null;
							} else {
	                         		
        	row1.RECORD_TYPE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.CHARGE_CATEGORY = null;
							} else {
	                         		
        	row1.CHARGE_CATEGORY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.CHARGE_NAME = null;
							} else {
	                         		
        	row1.CHARGE_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.TAX_NAME = null;
							} else {
	                         		
        	row1.TAX_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.TAXABLE_FLAG = null;
							} else {
	                         		
        	row1.TAXABLE_FLAG = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.TAX_PERCENTAGE = null;
							} else {
		                          
					if(rs_tDBInput_1.getObject(9) != null) {
						row1.TAX_PERCENTAGE = rs_tDBInput_1.getBigDecimal(9);
					} else {
					...
					if(rs_tDBInput_1.getObject(10) != null) {
						row1.TAX = rs_tDBInput_1.getBigDecimal(10);
					} else {
 	                	...
 	                	throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.INVOICED_TAX = null;
							} else {
		                          
					if(rs_tDBInput_1.getObject(11) != null) {
						row1.INVOICED_TAX = rs_tDBInput_1.getBigDecimal(11);
					} else {
        	...
        	row1.REFERENCE1 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 13) {
								row1.REFERENCE2 = null;
							} else {
	                         		
        	row1.REFERENCE2 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								row1.REFERENCE3 = null;
							} else {
	                         		
        	row1.REFERENCE3 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 15) {
								row1.CREATETS = null;
							} else {
										
			row1.CREATETS = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 15);
		                    }
							if(colQtyInRs_tDBInput_1 < 16) {
								row1.MODIFYTS = null;
							} else {
										
			row1.MODIFYTS = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 16);
		                    }
							if(colQtyInRs_tDBInput_1 < 17) {
								row1.CREATEUSERID = null;
							} else {
	                         		
        	row1.CREATEUSERID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 17, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 18) {
								row1.MODIFYUSERID = null;
							} else {
	                         		
        	row1.MODIFYUSERID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 18, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 19) {
								row1.CREATEPROGID = null;
							} else {
	                         		
        	row1.CREATEPROGID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 19, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 20) {
								row1.MODIFYPROGID = null;
							} else {
	                         		
        	row1.MODIFYPROGID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 20, false);
		                    }
					...
					if(rs_tDBInput_1.getObject(21) != null) {
						row1.LOCKID = rs_tDBInput_1.getBigDecimal(21);
					} else {
 	                	...
 	                	throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tDBInput_1 < 22) {
								row1.EXTN_TAX_PER_UNIT = null;
							} else {
	                         		
        	row1.EXTN_TAX_PER_UNIT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 22, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 23) {
								row1.EXTN_TAX_AREA_ID = null;
							} else {
	                         		
        	row1.EXTN_TAX_AREA_ID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 23, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 24) {
								row1.EXTN_TAX_TYPE = null;
							} else {
	                         		
        	row1.EXTN_TAX_TYPE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 24, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 25) {
								row1.EXTN_GROUP_ID = null;
							} else {
	                         		
        	row1.EXTN_GROUP_ID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 25, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 26) {
								row1.EXTN_ZONE_ID = null;
							} else {
	                         		
        	row1.EXTN_ZONE_ID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 26, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 27) {
								row1.EXTN_IS_OVERRIDE_ZONE = null;
							} else {
	                         		
        	row1.EXTN_IS_OVERRIDE_ZONE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 27, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 28) {
								row1.EXTN_IS_MANUAL = null;
							} else {
	                         		
        	row1.EXTN_IS_MANUAL = routines.system.JDBCUtil.getString(rs_tDBInput_1, 28, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 29) {
								row1.EXTN_RULE_ID = null;
							} else {
	                         		
        	row1.EXTN_RULE_ID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 29, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 30) {
								row1.EXTN_IS_TRAN_LEVEL = null;
							} else {
	                         		
        	row1.EXTN_IS_TRAN_LEVEL = routines.system.JDBCUtil.getString(rs_tDBInput_1, 30, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 31) {
								row1.EXTN_REFERENCE_1 = null;
							} else {
	                         		
        	row1.EXTN_REFERENCE_1 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 31, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 32) {
								row1.EXTN_REFERENCE_2 = null;
							} else {
	                         		
        	row1.EXTN_REFERENCE_2 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 32, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 33) {
								row1.EXTN_REFERENCE_3 = null;
							} else {
	                         		
        	row1.EXTN_REFERENCE_3 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 33, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 34) {
								row1.EXTN_IS_TAX_CALCULATED = null;
							} else {
	                         		
        	row1.EXTN_IS_TAX_CALCULATED = routines.system.JDBCUtil.getString(rs_tDBInput_1, 34, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 35) {
								row1.EXTN_VERTEX_ENGINE = null;
							} else {
	                         		
        	row1.EXTN_VERTEX_ENGINE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 35, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 36) {
								row1.EXTN_REMAINING_TAX_PER_LINE = null;
							} else {
	                         		
        	row1.EXTN_REMAINING_TAX_PER_LINE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 36, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 37) {
								row1.EXTN_COUNTY = null;
							} else {
	                         		
        	row1.EXTN_COUNTY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 37, false);
		                    }
	...
	currentComponent="tDBOutput_1";
        ...
        if (incomingEnforcer_tDBOutput_1 != null) {
            incomingEnforcer_tDBOutput_1.createNewRecord();
                ...
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("TAX_BREAKUP_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("TAX_BREAKUP_KEY", row1.TAX_BREAKUP_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("HEADER_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("HEADER_KEY", row1.HEADER_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("LINE_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("LINE_KEY", row1.LINE_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("RECORD_TYPE") != null){
                    incomingEnforcer_tDBOutput_1.put("RECORD_TYPE", row1.RECORD_TYPE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CHARGE_CATEGORY") != null){
                    incomingEnforcer_tDBOutput_1.put("CHARGE_CATEGORY", row1.CHARGE_CATEGORY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CHARGE_NAME") != null){
                    incomingEnforcer_tDBOutput_1.put("CHARGE_NAME", row1.CHARGE_NAME);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("TAX_NAME") != null){
                    incomingEnforcer_tDBOutput_1.put("TAX_NAME", row1.TAX_NAME);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("TAX_PERCENTAGE") != null){
                    incomingEnforcer_tDBOutput_1.put("TAX_PERCENTAGE", row1.TAX_PERCENTAGE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("INVOICED_TAX") != null){
                    incomingEnforcer_tDBOutput_1.put("INVOICED_TAX", row1.INVOICED_TAX);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                ...
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("REFERENCE3") != null){
                    incomingEnforcer_tDBOutput_1.put("REFERENCE3", row1.REFERENCE3);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("EXTN_TAX_PER_UNIT") != null){
                    incomingEnforcer_tDBOutput_1.put("EXTN_TAX_PER_UNIT", row1.EXTN_TAX_PER_UNIT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("EXTN_TAX_AREA_ID") != null){
                    incomingEnforcer_tDBOutput_1.put("EXTN_TAX_AREA_ID", row1.EXTN_TAX_AREA_ID);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("EXTN_TAX_TYPE") != null){
                    incomingEnforcer_tDBOutput_1.put("EXTN_TAX_TYPE", row1.EXTN_TAX_TYPE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("EXTN_GROUP_ID") != null){
                    incomingEnforcer_tDBOutput_1.put("EXTN_GROUP_ID", row1.EXTN_GROUP_ID);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("EXTN_ZONE_ID") != null){
                    incomingEnforcer_tDBOutput_1.put("EXTN_ZONE_ID", row1.EXTN_ZONE_ID);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("EXTN_IS_OVERRIDE_ZONE") != null){
                    incomingEnforcer_tDBOutput_1.put("EXTN_IS_OVERRIDE_ZONE", row1.EXTN_IS_OVERRIDE_ZONE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("EXTN_IS_MANUAL") != null){
                    incomingEnforcer_tDBOutput_1.put("EXTN_IS_MANUAL", row1.EXTN_IS_MANUAL);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("EXTN_RULE_ID") != null){
                    incomingEnforcer_tDBOutput_1.put("EXTN_RULE_ID", row1.EXTN_RULE_ID);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("EXTN_IS_TRAN_LEVEL") != null){
                    incomingEnforcer_tDBOutput_1.put("EXTN_IS_TRAN_LEVEL", row1.EXTN_IS_TRAN_LEVEL);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("EXTN_REFERENCE_1") != null){
                    incomingEnforcer_tDBOutput_1.put("EXTN_REFERENCE_1", row1.EXTN_REFERENCE_1);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("EXTN_REFERENCE_2") != null){
                    incomingEnforcer_tDBOutput_1.put("EXTN_REFERENCE_2", row1.EXTN_REFERENCE_2);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("EXTN_REFERENCE_3") != null){
                    incomingEnforcer_tDBOutput_1.put("EXTN_REFERENCE_3", row1.EXTN_REFERENCE_3);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("EXTN_REMAINING_TAX_PER_LINE") != null){
                    incomingEnforcer_tDBOutput_1.put("EXTN_REMAINING_TAX_PER_LINE", row1.EXTN_REMAINING_TAX_PER_LINE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("EXTN_COUNTY") != null){
                    incomingEnforcer_tDBOutput_1.put("EXTN_COUNTY", row1.EXTN_COUNTY);
                }
 ...
 */
    ...
    public static void main(String[] args){
        final YFS_TAX_BREAKUP_H YFS_TAX_BREAKUP_HClass = new YFS_TAX_BREAKUP_H();

        int exitCode = YFS_TAX_BREAKUP_HClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'YFS_TAX_BREAKUP_H' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'YFS_TAX_BREAKUP_H' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_KvRgAOv3Eeui_7U8UwU2ug");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-06-18T03:13:29.494607100Z");
        ...
        try {
            ...
            java.io.InputStream inContext = YFS_TAX_BREAKUP_H.class.getClassLoader().getResourceAsStream("at_talend_jobs/yfs_tax_breakup_h_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = YFS_TAX_BREAKUP_H.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'YFS_TAX_BREAKUP_H' - Started.");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : YFS_TAX_BREAKUP_H");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'YFS_TAX_BREAKUP_H' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     240127 characters generated by Talend Cloud Data Management Platform 
 *     on the June 17, 2023 at 11:13:29 PM EDT
 ************************************************************************************************/