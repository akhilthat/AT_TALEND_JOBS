...
public class YFS_TAX_BREAKUP_H implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "YFS_TAX_BREAKUP_H.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(YFS_TAX_BREAKUP_H.class);
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_1.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:quT38EP8DvQluXCJ2LlPovy6kl4WTDXz6vkTkBS3srSC7pTi"));
...
// finally of generic
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:NZ6mLS6bw601jfyt2YP72zvwK0kAlDqF2jLMGhsnx1lrEEllDjU=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_3.append(" | ");
				...
				final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:qmvL35LpsDTiKkQPLS8/n32//49KJ+WeoqoBkLHW8JOykG/phng=");
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-06-14T15:27:33.794220900Z");
		...
		try {
			...
			java.io.InputStream inContext = YFS_TAX_BREAKUP_H.class.getClassLoader()
					.getResourceAsStream("at_talend_jobs/yfs_tax_breakup_h_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = YFS_TAX_BREAKUP_H.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : YFS_TAX_BREAKUP_H");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 97101 characters generated by Talend Cloud Data Management Platform on the
 * June 14, 2023 at 11:27:33 AM EDT
 ************************************************************************************************/