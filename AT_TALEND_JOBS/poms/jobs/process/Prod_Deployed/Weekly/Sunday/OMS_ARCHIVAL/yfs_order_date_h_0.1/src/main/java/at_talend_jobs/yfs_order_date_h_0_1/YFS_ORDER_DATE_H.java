...
public class YFS_ORDER_DATE_H implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "YFS_ORDER_DATE_H.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(YFS_ORDER_DATE_H.class);
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_2.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:+SLfnwrx1VO4nzJxhtNn57NIAFS4ij7KgtsHzRABNibZXTYY"));
...
// finally of generic
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:vD1L/rBw9ZVYbUXtjB7rAr0ZvNEG0QbtCRAxPx7eugZsBbak0Nw=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_3.append(" | ");
				...
				final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:tYo/KYWXdBEfIhsKWgdQXtIkFp4ppw4Do7mCvza1uitAf/mh++E=");
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-06-14T15:32:05.701007Z");
		...
		try {
			...
			java.io.InputStream inContext = YFS_ORDER_DATE_H.class.getClassLoader()
					.getResourceAsStream("at_talend_jobs/yfs_order_date_h_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = YFS_ORDER_DATE_H.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : YFS_ORDER_DATE_H");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 97078 characters generated by Talend Cloud Data Management Platform on the
 * June 14, 2023 at 11:32:05 AM EDT
 ************************************************************************************************/