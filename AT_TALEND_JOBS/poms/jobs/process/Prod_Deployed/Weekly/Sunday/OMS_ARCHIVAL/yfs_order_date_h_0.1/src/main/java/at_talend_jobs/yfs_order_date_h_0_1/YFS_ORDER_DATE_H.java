...
package at_talend_jobs.yfs_order_date_h_0_1;
...
/**
 * Job: YFS_ORDER_DATE_H Purpose: <br>
 * Description:  <br>
 * @author thati, akhil
 * @version 8.0.1.20230418_1502-patch
 * @status 
 */
public class YFS_ORDER_DATE_H implements TalendJob {
	static {System.setProperty("TalendJob.log", "YFS_ORDER_DATE_H.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(YFS_ORDER_DATE_H.class);
...
public String getSF_warehouse(){
	...
	private final String jobName = "YFS_ORDER_DATE_H";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_JoXb8OvvEeui_7U8UwU2ug", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				YFS_ORDER_DATE_H.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(YFS_ORDER_DATE_H.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
org.talend.components.snowflake.SnowflakeConnectionProperties props_tDBConnection_2 =
        (org.talend.components.snowflake.SnowflakeConnectionProperties) def_tDBConnection_2.createRuntimeProperties();
 		                    ...
 		                    "Talend_user");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:3+OayetBRqsI2hAFH3Qkm1KFZZD8UTkbtk10x6yu5SGfYsFB"));
...
public void tDBConnection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_3{
                    ...
                    log4jParamters_tDBConnection_3.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_3.append(" | ");
                            log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:PGRc6FbXuhSYd9eLdrCrseGdpMoB29p2TyZcjkUevQHT1iOru0M=").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_3.append(" | ");
	...
	final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:B5GljUmOm4q0ZJVPR+h3ShCsvFyZ//ncomWJTFIUxI7OyXMQhs8=");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AT_TALEND_JOBS_YFS_ORDER_DATE_H = new byte[0];
    static byte[] commonByteArray_AT_TALEND_JOBS_YFS_ORDER_DATE_H = new byte[0];

	
			    public String ORDER_DATE_KEY;

				public String getORDER_DATE_KEY () {
					return this.ORDER_DATE_KEY;
				}

				public Boolean ORDER_DATE_KEYIsNullable(){
				    return false;
				}
				public Boolean ORDER_DATE_KEYIsKey(){
				    return false;
				}
				public Integer ORDER_DATE_KEYLength(){
				    return null;
				}
				public Integer ORDER_DATE_KEYPrecision(){
				    return null;
				}
				public String ORDER_DATE_KEYDefault(){
				
					return null;
				
				}
				public String ORDER_DATE_KEYComment(){
				
				    return "";
				
				}
				public String ORDER_DATE_KEYPattern(){
				
					return "";
				
				}
				public String ORDER_DATE_KEYOriginalDbColumnName(){
			    ...
			    public String DATE_TYPE_ID;

				public String getDATE_TYPE_ID () {
					return this.DATE_TYPE_ID;
				}

				public Boolean DATE_TYPE_IDIsNullable(){
				    return false;
				}
				public Boolean DATE_TYPE_IDIsKey(){
				    return false;
				}
				public Integer DATE_TYPE_IDLength(){
				    return null;
				}
				public Integer DATE_TYPE_IDPrecision(){
				    return null;
				}
				public String DATE_TYPE_IDDefault(){
				
					return null;
				
				}
				public String DATE_TYPE_IDComment(){
				
				    return "";
				
				}
				public String DATE_TYPE_IDPattern(){
				
					return "";
				
				}
				public String DATE_TYPE_IDOriginalDbColumnName(){
				...
				public Boolean REQUESTED_DATEIsNullable(){
				    return false;
				}
				public Boolean REQUESTED_DATEIsKey(){
				    return false;
				}
				public Integer REQUESTED_DATELength(){
				    return null;
				}
				public Integer REQUESTED_DATEPrecision(){
				    return null;
				}
				public String REQUESTED_DATEDefault(){
				
					return null;
				
				}
				public String REQUESTED_DATEComment(){
				
				    return "";
				
				}
				public String REQUESTED_DATEPattern(){
				
					return "yyyy-MM-dd'T'HH:mm:ss";
				
				}
				public String REQUESTED_DATEOriginalDbColumnName(){
			    ...
			    public java.util.Date EXPECTED_DATE;

				public java.util.Date getEXPECTED_DATE () {
					return this.EXPECTED_DATE;
				}

				public Boolean EXPECTED_DATEIsNullable(){
				    return false;
				}
				public Boolean EXPECTED_DATEIsKey(){
				    return false;
				}
				public Integer EXPECTED_DATELength(){
				    return null;
				}
				public Integer EXPECTED_DATEPrecision(){
				    return null;
				}
				public String EXPECTED_DATEDefault(){
				
					return null;
				
				}
				public String EXPECTED_DATEComment(){
				
				    return "";
				
				}
				public String EXPECTED_DATEPattern(){
				
					return "yyyy-MM-dd'T'HH:mm:ss";
				
				}
				public String EXPECTED_DATEOriginalDbColumnName(){
				...
				public Boolean ACTUAL_DATEIsNullable(){
				    return false;
				}
				public Boolean ACTUAL_DATEIsKey(){
				    return false;
				}
				public Integer ACTUAL_DATELength(){
				    return null;
				}
				public Integer ACTUAL_DATEPrecision(){
				    return null;
				}
				public String ACTUAL_DATEDefault(){
				
					return null;
				
				}
				public String ACTUAL_DATEComment(){
				
				    return "";
				
				}
				public String ACTUAL_DATEPattern(){
				
					return "yyyy-MM-dd'T'HH:mm:ss";
				
				}
				public String ACTUAL_DATEOriginalDbColumnName(){
			    ...
			    public java.util.Date COMMITTED_DATE;

				public java.util.Date getCOMMITTED_DATE () {
					return this.COMMITTED_DATE;
				}

				public Boolean COMMITTED_DATEIsNullable(){
				    return false;
				}
				public Boolean COMMITTED_DATEIsKey(){
				    return false;
				}
				public Integer COMMITTED_DATELength(){
				    return null;
				}
				public Integer COMMITTED_DATEPrecision(){
				    return null;
				}
				public String COMMITTED_DATEDefault(){
				
					return null;
				
				}
				public String COMMITTED_DATEComment(){
				
				    return "";
				
				}
				public String COMMITTED_DATEPattern(){
				
					return "yyyy-MM-dd'T'HH:mm:ss";
				
				}
				public String COMMITTED_DATEOriginalDbColumnName(){
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AT_TALEND_JOBS_YFS_ORDER_DATE_H.length) {
				if(length < 1024 && commonByteArray_AT_TALEND_JOBS_YFS_ORDER_DATE_H.length == 0) {
   					commonByteArray_AT_TALEND_JOBS_YFS_ORDER_DATE_H = new byte[1024];
				} else {
   					commonByteArray_AT_TALEND_JOBS_YFS_ORDER_DATE_H = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AT_TALEND_JOBS_YFS_ORDER_DATE_H, 0, length);
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_YFS_ORDER_DATE_H, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AT_TALEND_JOBS_YFS_ORDER_DATE_H, 0, length);
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_YFS_ORDER_DATE_H, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AT_TALEND_JOBS_YFS_ORDER_DATE_H) {

        	try {

        		int length = 0;
		
					this.ORDER_DATE_KEY = readString(dis);
					...
					this.DATE_TYPE_ID = readString(dis);
					
					this.REQUESTED_DATE = readDate(dis);
					
					this.EXPECTED_DATE = readDate(dis);
					
					this.ACTUAL_DATE = readDate(dis);
					
					this.COMMITTED_DATE = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.ORDER_DATE_KEY,dos);
					...
					// String
						...
						writeString(this.DATE_TYPE_ID,dos);
					...
					// java.util.Date
						...
						writeDate(this.EXPECTED_DATE,dos);
					
					// java.util.Date
				
						writeDate(this.ACTUAL_DATE,dos);
					
					// java.util.Date
				
						writeDate(this.COMMITTED_DATE,dos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("ORDER_DATE_KEY="+ORDER_DATE_KEY);
		...
		sb.append(",DATE_TYPE_ID="+DATE_TYPE_ID);
		sb.append(",REQUESTED_DATE="+String.valueOf(REQUESTED_DATE));
		sb.append(",EXPECTED_DATE="+String.valueOf(EXPECTED_DATE));
		sb.append(",ACTUAL_DATE="+String.valueOf(ACTUAL_DATE));
		sb.append(",COMMITTED_DATE="+String.valueOf(COMMITTED_DATE));
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_1_2_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"ORDER_DATE_KEY\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ORDER_DATE_KEY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"ORDER_DATE_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ORDER_DATE_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"ORDER_RELEASE_KEY\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ORDER_RELEASE_KEY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"ORDER_RELEASE_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ORDER_RELEASE_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"DATE_TYPE_ID\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"DATE_TYPE_ID\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"DATE_TYPE_ID\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"DATE_TYPE_ID\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"REQUESTED_DATE\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"},\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"REQUESTED_DATE\",\"talend.field.dbColumnName\":\"REQUESTED_DATE\",\"di.column.talendType\":\"id_Date\",\"talend.field.pattern\":\"yyyy-MM-dd'T'HH:mm:ss\",\"di.column.relationshipType\":\"\",\"di.prop.di.column.logicalType\":\"timestamp-millis\",\"di.table.label\":\"REQUESTED_DATE\",\"di.prop.di.date.timestamp\":\"true\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"EXPECTED_DATE\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"},\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"EXPECTED_DATE\",\"talend.field.dbColumnName\":\"EXPECTED_DATE\",\"di.column.talendType\":\"id_Date\",\"talend.field.pattern\":\"yyyy-MM-dd'T'HH:mm:ss\",\"di.column.relationshipType\":\"\",\"di.prop.di.column.logicalType\":\"timestamp-millis\",\"di.table.label\":\"EXPECTED_DATE\",\"di.prop.di.date.timestamp\":\"true\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ACTUAL_DATE\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"},\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ACTUAL_DATE\",\"talend.field.dbColumnName\":\"ACTUAL_DATE\",\"di.column.talendType\":\"id_Date\",\"talend.field.pattern\":\"yyyy-MM-dd'T'HH:mm:ss\",\"di.column.relationshipType\":\"\",\"di.prop.di.column.logicalType\":\"timestamp-millis\",\"di.table.label\":\"ACTUAL_DATE\",\"di.prop.di.date.timestamp\":\"true\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"COMMITTED_DATE\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"},\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"COMMITTED_DATE\",\"talend.field.dbColumnName\":\"COMMITTED_DATE\",\"di.column.talendType\":\"id_Date\",\"talend.field.pattern\":\"yyyy-MM-dd'T'HH:mm:ss\",\"di.column.relationshipType\":\"\",\"di.prop.di.column.logicalType\":\"timestamp-millis\",\"di.table.label\":\"COMMITTED_DATE\",\"di.prop.di.date.timestamp\":\"true\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"LOCKID\",\"type\":{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"default\":\"0\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"LOCKID\",\"talend.field.default\":\"0\",\"talend.field.dbColumnName\":\"LOCKID\",\"di.column.talendType\":\"id_BigDecimal\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"LOCKID\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tDBOutput_1\",\"di.table.label\":\"tDBOutput_1\"}",s);
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"  select * from STERLING.YFS_ORDER_DATE_H where TO_CHAR(MODIFYTS, 'YYYY-MM-DD HH:MI:SS') >= TO_CHAR((sysdate - 7), 'YYYY-MM-DD HH:MI:SS')    \"");
                        log4jParamters_tDBInput_1.append(" | ");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("ORDER_DATE_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ORDER_HEADER_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ORDER_LINE_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ORDER_RELEASE_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DATE_TYPE_ID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("REQUESTED_DATE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EXPECTED_DATE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ACTUAL_DATE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("COMMITTED_DATE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATETS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYTS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATEUSERID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYUSERID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATEPROGID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYPROGID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LOCKID")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
		    ...
		    String dbquery_tDBInput_1 = "\nselect * from STERLING.YFS_ORDER_DATE_H where TO_CHAR(MODIFYTS, 'YYYY-MM-DD HH:MI:SS') >= TO_CHAR((sysdate - 7), 'YYY"
+"Y-MM-DD HH:MI:SS')\n\n";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row1.ORDER_DATE_KEY = null;
							} else {
	                         		
        	row1.ORDER_DATE_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
        	...
        	row1.ORDER_LINE_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.ORDER_RELEASE_KEY = null;
							} else {
	                         		
        	row1.ORDER_RELEASE_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.DATE_TYPE_ID = null;
							} else {
	                         		
        	row1.DATE_TYPE_ID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.REQUESTED_DATE = null;
							} else {
										
			row1.REQUESTED_DATE = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 6);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.EXPECTED_DATE = null;
							} else {
										
			row1.EXPECTED_DATE = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 7);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.ACTUAL_DATE = null;
							} else {
										
			row1.ACTUAL_DATE = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 8);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.COMMITTED_DATE = null;
							} else {
										
			row1.COMMITTED_DATE = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 9);
		                    }
        	...
        	row1.MODIFYPROGID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 15, false);
					...
					if(rs_tDBInput_1.getObject(16) != null) {
						row1.LOCKID = rs_tDBInput_1.getBigDecimal(16);
					} else {
	...
	currentComponent="tDBOutput_1";
        ...
        if (incomingEnforcer_tDBOutput_1 != null) {
            incomingEnforcer_tDBOutput_1.createNewRecord();
                ...
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("ORDER_DATE_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("ORDER_DATE_KEY", row1.ORDER_DATE_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("DATE_TYPE_ID") != null){
                    incomingEnforcer_tDBOutput_1.put("DATE_TYPE_ID", row1.DATE_TYPE_ID);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("REQUESTED_DATE") != null){
                    incomingEnforcer_tDBOutput_1.put("REQUESTED_DATE", row1.REQUESTED_DATE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("EXPECTED_DATE") != null){
                    incomingEnforcer_tDBOutput_1.put("EXPECTED_DATE", row1.EXPECTED_DATE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("ACTUAL_DATE") != null){
                    incomingEnforcer_tDBOutput_1.put("ACTUAL_DATE", row1.ACTUAL_DATE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("COMMITTED_DATE") != null){
                    incomingEnforcer_tDBOutput_1.put("COMMITTED_DATE", row1.COMMITTED_DATE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
 ...
 */
    ...
    public static void main(String[] args){
        final YFS_ORDER_DATE_H YFS_ORDER_DATE_HClass = new YFS_ORDER_DATE_H();

        int exitCode = YFS_ORDER_DATE_HClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'YFS_ORDER_DATE_H' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'YFS_ORDER_DATE_H' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_JoXb8OvvEeui_7U8UwU2ug");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-06-18T03:39:38.021176900Z");
        ...
        try {
            ...
            java.io.InputStream inContext = YFS_ORDER_DATE_H.class.getClassLoader().getResourceAsStream("at_talend_jobs/yfs_order_date_h_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = YFS_ORDER_DATE_H.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'YFS_ORDER_DATE_H' - Started.");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : YFS_ORDER_DATE_H");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'YFS_ORDER_DATE_H' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     188493 characters generated by Talend Cloud Data Management Platform 
 *     on the June 17, 2023 at 11:39:38 PM EDT
 ************************************************************************************************/