...
public class YFS_ORDER_HOLD_TYPE_LOG_H implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "YFS_ORDER_HOLD_TYPE_LOG_H.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(YFS_ORDER_HOLD_TYPE_LOG_H.class);
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_1.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:0Q3dMi73cbB2sFZOYsG+U4RhzKXjF45JFcEEPT5Wn2ZYUnxK"));
...
// finally of generic
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:nZao4fIVrkGrPncgr+EZ12iHGS5X0KY2V0qWcxM01duPHBB9dWU=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_3.append(" | ");
				...
				final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Yp2R5HZDgSRoVMfszwjlK5NHSIrYILWILfpfgPMQdQSnEotltfg=");
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-06-14T15:30:47.761191Z");
		...
		try {
			...
			java.io.InputStream inContext = YFS_ORDER_HOLD_TYPE_LOG_H.class.getClassLoader().getResourceAsStream(
					"at_talend_jobs/yfs_order_hold_type_log_h_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = YFS_ORDER_HOLD_TYPE_LOG_H.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : YFS_ORDER_HOLD_TYPE_LOG_H");
		}
		if (enableLogStash) {
		...
		log.info(
				"TalendJob: 'YFS_ORDER_HOLD_TYPE_LOG_H' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 97258 characters generated by Talend Cloud Data Management Platform on the
 * June 14, 2023 at 11:30:47 AM EDT
 ************************************************************************************************/