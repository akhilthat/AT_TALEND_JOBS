...
public class YFS_ORDER_HEADER_H implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "YFS_ORDER_HEADER_H.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(YFS_ORDER_HEADER_H.class);
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_1.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:/tnXWIqoDV0JLqmCO3pX8Xo0QINWq+fLhL8YkKKHi/tcJJCU"));
...
// finally of generic
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:Sx4AQzgMBPW2wMcv3FvBEI8r5vLTkhv8IrLZ0zq9QZm/x7/xNZM=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_3.append(" | ");
				...
				final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:m1f+xzvjEdBMQ6sOzkzS7J04o9+ODiMZWLZ9jkWDLmldRYv0Huc=");
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-06-14T15:31:29.408434800Z");
		...
		try {
			...
			java.io.InputStream inContext = YFS_ORDER_HEADER_H.class.getClassLoader().getResourceAsStream(
					"at_talend_jobs/yfs_order_header_h_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = YFS_ORDER_HEADER_H.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : YFS_ORDER_HEADER_H");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 97121 characters generated by Talend Cloud Data Management Platform on the
 * June 14, 2023 at 11:31:29 AM EDT
 ************************************************************************************************/