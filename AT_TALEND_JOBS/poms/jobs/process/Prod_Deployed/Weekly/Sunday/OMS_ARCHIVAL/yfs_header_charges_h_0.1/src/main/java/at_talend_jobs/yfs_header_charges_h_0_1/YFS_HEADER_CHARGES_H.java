...
public class YFS_HEADER_CHARGES_H implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "YFS_HEADER_CHARGES_H.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(YFS_HEADER_CHARGES_H.class);
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_1.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:rPrfo1uSbJ7+5s+hsRe4zVsP88DFHdQaKnmjcU4GedGnpUTx"));
...
// finally of generic
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:L/9jZDGbkmdVLhmGxbQIIXVgDN0fX4U0lb3I/O4dVNeAx2HRhYI=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_3.append(" | ");
				...
				final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:uXHoSEBXKnBT4OpPPnWdYhkT6Wh7noO40GGpGfy4ONM8M+yCf2w=");
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-06-14T15:33:45.568179200Z");
		...
		try {
			...
			java.io.InputStream inContext = YFS_HEADER_CHARGES_H.class.getClassLoader().getResourceAsStream(
					"at_talend_jobs/yfs_header_charges_h_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = YFS_HEADER_CHARGES_H.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : YFS_HEADER_CHARGES_H");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 97161 characters generated by Talend Cloud Data Management Platform on the
 * June 14, 2023 at 11:33:45 AM EDT
 ************************************************************************************************/