...
package at_talend_jobs.yfs_header_charges_h_0_1;
...
/**
 * Job: YFS_HEADER_CHARGES_H Purpose: <br>
 * Description:  <br>
 * @author thati, akhil
 * @version 8.0.1.20230418_1502-patch
 * @status 
 */
public class YFS_HEADER_CHARGES_H implements TalendJob {
	static {System.setProperty("TalendJob.log", "YFS_HEADER_CHARGES_H.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(YFS_HEADER_CHARGES_H.class);
...
public String getSF_warehouse(){
	...
	private final String jobName = "YFS_HEADER_CHARGES_H";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_-CUV8OlpEeu_j5YptPMFjw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				YFS_HEADER_CHARGES_H.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(YFS_HEADER_CHARGES_H.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
org.talend.components.snowflake.SnowflakeConnectionProperties props_tDBConnection_1 =
        (org.talend.components.snowflake.SnowflakeConnectionProperties) def_tDBConnection_1.createRuntimeProperties();
 		                    ...
 		                    "Talend_user");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:B0w+2zgMhKzKwnL7k9bo1N2Cj7s05hN/TTI/G9KrMj0bfsRA"));
...
public void tDBConnection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_3{
                    ...
                    log4jParamters_tDBConnection_3.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_3.append(" | ");
                            log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:Zb5DhaIp8dn6K2YK219mMkm/neXcvlnPDZdsPaccD2KRKR2Lyzg=").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_3.append(" | ");
	...
	final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ageepECMO6f+WdDZCFlUgFN++UN2ZeEHMtFwBCR32988hlHUPbA=");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AT_TALEND_JOBS_YFS_HEADER_CHARGES_H = new byte[0];
    static byte[] commonByteArray_AT_TALEND_JOBS_YFS_HEADER_CHARGES_H = new byte[0];

	
			    public String HEADER_CHARGES_KEY;

				public String getHEADER_CHARGES_KEY () {
					return this.HEADER_CHARGES_KEY;
				}

				public Boolean HEADER_CHARGES_KEYIsNullable(){
				    return false;
				}
				public Boolean HEADER_CHARGES_KEYIsKey(){
				    return false;
				}
				public Integer HEADER_CHARGES_KEYLength(){
				    return null;
				}
				public Integer HEADER_CHARGES_KEYPrecision(){
				    return null;
				}
				public String HEADER_CHARGES_KEYDefault(){
				
					return null;
				
				}
				public String HEADER_CHARGES_KEYComment(){
				
				    return "";
				
				}
				public String HEADER_CHARGES_KEYPattern(){
				
					return "";
				
				}
				public String HEADER_CHARGES_KEYOriginalDbColumnName(){
				
					return "HEADER_CHARGES_KEY";
				...
				public Boolean CHARGEIsNullable(){
				    return false;
				}
				public Boolean CHARGEIsKey(){
				    return false;
				}
				public Integer CHARGELength(){
				    return null;
				}
				public Integer CHARGEPrecision(){
				    return null;
				}
				public String CHARGEDefault(){
				...
				public String CHARGEOriginalDbColumnName(){
			    ...
			    public BigDecimal INVOICED_CHARGE;

				public BigDecimal getINVOICED_CHARGE () {
					return this.INVOICED_CHARGE;
				}

				public Boolean INVOICED_CHARGEIsNullable(){
				    return false;
				}
				public Boolean INVOICED_CHARGEIsKey(){
				    return false;
				}
				public Integer INVOICED_CHARGELength(){
				    return null;
				}
				public Integer INVOICED_CHARGEPrecision(){
				    return null;
				}
				public String INVOICED_CHARGEDefault(){
				
					return "";
				
				}
				public String INVOICED_CHARGEComment(){
				
				    return "";
				
				}
				public String INVOICED_CHARGEPattern(){
				
					return "";
				
				}
				public String INVOICED_CHARGEOriginalDbColumnName(){
				
					return "INVOICED_CHARGE";
				
				}

				
			    public BigDecimal ORIGINAL_CHARGE;

				public BigDecimal getORIGINAL_CHARGE () {
					return this.ORIGINAL_CHARGE;
				}

				public Boolean ORIGINAL_CHARGEIsNullable(){
				    return false;
				}
				public Boolean ORIGINAL_CHARGEIsKey(){
				    return false;
				}
				public Integer ORIGINAL_CHARGELength(){
				    return null;
				}
				public Integer ORIGINAL_CHARGEPrecision(){
				    return null;
				}
				public String ORIGINAL_CHARGEDefault(){
				
					return "";
				
				}
				public String ORIGINAL_CHARGEComment(){
				
				    return "";
				
				}
				public String ORIGINAL_CHARGEPattern(){
				
					return "";
				
				}
				public String ORIGINAL_CHARGEOriginalDbColumnName(){
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AT_TALEND_JOBS_YFS_HEADER_CHARGES_H.length) {
				if(length < 1024 && commonByteArray_AT_TALEND_JOBS_YFS_HEADER_CHARGES_H.length == 0) {
   					commonByteArray_AT_TALEND_JOBS_YFS_HEADER_CHARGES_H = new byte[1024];
				} else {
   					commonByteArray_AT_TALEND_JOBS_YFS_HEADER_CHARGES_H = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AT_TALEND_JOBS_YFS_HEADER_CHARGES_H, 0, length);
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_YFS_HEADER_CHARGES_H, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AT_TALEND_JOBS_YFS_HEADER_CHARGES_H, 0, length);
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_YFS_HEADER_CHARGES_H, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AT_TALEND_JOBS_YFS_HEADER_CHARGES_H) {

        	try {

        		int length = 0;
		
					this.HEADER_CHARGES_KEY = readString(dis);
					...
					this.REFERENCE = readString(dis);
						...
						this.CHARGE = (BigDecimal) dis.readObject();
					
						this.INVOICED_CHARGE = (BigDecimal) dis.readObject();
					
						this.ORIGINAL_CHARGE = (BigDecimal) dis.readObject();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.HEADER_CHARGES_KEY,dos);
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.CHARGE);
					
					// BigDecimal
				
       			    	dos.writeObject(this.INVOICED_CHARGE);
					
					// BigDecimal
				
       			    	dos.writeObject(this.ORIGINAL_CHARGE);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("HEADER_CHARGES_KEY="+HEADER_CHARGES_KEY);
		...
		sb.append(",CHARGE="+String.valueOf(CHARGE));
		sb.append(",INVOICED_CHARGE="+String.valueOf(INVOICED_CHARGE));
		sb.append(",ORIGINAL_CHARGE="+String.valueOf(ORIGINAL_CHARGE));
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        				...
        				if(HEADER_CHARGES_KEY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(HEADER_CHARGES_KEY);
            			}
        			...
        			sb.append("|");
        				...
        				if(INVOICED_CHARGE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(INVOICED_CHARGE);
            			}
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_1_2_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"HEADER_CHARGES_KEY\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"HEADER_CHARGES_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"HEADER_CHARGES_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"HEADER_KEY\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"HEADER_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"HEADER_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"RECORD_TYPE\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"RECORD_TYPE\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"RECORD_TYPE\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CHARGE_CATEGORY\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"CHARGE_CATEGORY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CHARGE_CATEGORY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CHARGE_NAME\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"CHARGE_NAME\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CHARGE_NAME\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"REFERENCE\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"REFERENCE\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"REFERENCE\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CHARGE\",\"type\":{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"default\":\"\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"CHARGE\",\"di.column.talendType\":\"id_BigDecimal\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CHARGE\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"INVOICED_CHARGE\",\"type\":{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"default\":\"\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"INVOICED_CHARGE\",\"di.column.talendType\":\"id_BigDecimal\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"INVOICED_CHARGE\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ORIGINAL_CHARGE\",\"type\":{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"default\":\"\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"ORIGINAL_CHARGE\",\"di.column.talendType\":\"id_BigDecimal\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ORIGINAL_CHARGE\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"IS_MANUAL\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"IS_MANUAL\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"IS_MANUAL\",\"di.column.relatedEntity\":\"\"},{",s);
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"  select * from STERLING.YFS_HEADER_CHARGES_H where TO_CHAR(MODIFYTS, 'YYYY-MM-DD HH:MI:SS') >= TO_CHAR((sysdate - 7), 'YYYY-MM-DD HH:MI:SS')    \"");
                        log4jParamters_tDBInput_1.append(" | ");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("HEADER_CHARGES_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("HEADER_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("RECORD_TYPE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CHARGE_CATEGORY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CHARGE_NAME")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("REFERENCE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CHARGE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("INVOICED_CHARGE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ORIGINAL_CHARGE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IS_MANUAL")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATETS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYTS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATEUSERID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYUSERID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATEPROGID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYPROGID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LOCKID")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
		    ...
		    String dbquery_tDBInput_1 = "\nselect * from STERLING.YFS_HEADER_CHARGES_H where TO_CHAR(MODIFYTS, 'YYYY-MM-DD HH:MI:SS') >= TO_CHAR((sysdate - 7), "
+"'YYYY-MM-DD HH:MI:SS')\n\n";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row1.HEADER_CHARGES_KEY = null;
							} else {
	                         		
        	row1.HEADER_CHARGES_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
        	...
        	row1.RECORD_TYPE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.CHARGE_CATEGORY = null;
							} else {
	                         		
        	row1.CHARGE_CATEGORY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.CHARGE_NAME = null;
							} else {
	                         		
        	row1.CHARGE_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.REFERENCE = null;
							} else {
	                         		
        	row1.REFERENCE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
					...
					if(rs_tDBInput_1.getObject(7) != null) {
						row1.CHARGE = rs_tDBInput_1.getBigDecimal(7);
					} else {
 	                	...
 	                	throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.INVOICED_CHARGE = null;
							} else {
		                          
					if(rs_tDBInput_1.getObject(8) != null) {
						row1.INVOICED_CHARGE = rs_tDBInput_1.getBigDecimal(8);
					} else {
 	                	...
 	                	throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.ORIGINAL_CHARGE = null;
							} else {
		                          
					if(rs_tDBInput_1.getObject(9) != null) {
						row1.ORIGINAL_CHARGE = rs_tDBInput_1.getBigDecimal(9);
					} else {
        	...
        	row1.IS_MANUAL = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.CREATETS = null;
							} else {
										
			row1.CREATETS = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 11);
		                    }
							if(colQtyInRs_tDBInput_1 < 12) {
								row1.MODIFYTS = null;
							} else {
										
			row1.MODIFYTS = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 12);
		                    }
							if(colQtyInRs_tDBInput_1 < 13) {
								row1.CREATEUSERID = null;
							} else {
	                         		
        	row1.CREATEUSERID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								row1.MODIFYUSERID = null;
							} else {
	                         		
        	row1.MODIFYUSERID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 15) {
								row1.CREATEPROGID = null;
							} else {
	                         		
        	row1.CREATEPROGID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 15, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 16) {
								row1.MODIFYPROGID = null;
							} else {
	                         		
        	row1.MODIFYPROGID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 16, false);
		                    }
					...
					if(rs_tDBInput_1.getObject(17) != null) {
						row1.LOCKID = rs_tDBInput_1.getBigDecimal(17);
					} else {
	...
	currentComponent="tDBOutput_1";
        ...
        if (incomingEnforcer_tDBOutput_1 != null) {
            incomingEnforcer_tDBOutput_1.createNewRecord();
                ...
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("HEADER_CHARGES_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("HEADER_CHARGES_KEY", row1.HEADER_CHARGES_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("REFERENCE") != null){
                    incomingEnforcer_tDBOutput_1.put("REFERENCE", row1.REFERENCE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CHARGE") != null){
                    incomingEnforcer_tDBOutput_1.put("CHARGE", row1.CHARGE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("INVOICED_CHARGE") != null){
                    incomingEnforcer_tDBOutput_1.put("INVOICED_CHARGE", row1.INVOICED_CHARGE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("ORIGINAL_CHARGE") != null){
                    incomingEnforcer_tDBOutput_1.put("ORIGINAL_CHARGE", row1.ORIGINAL_CHARGE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
 ...
 */
    ...
    public static void main(String[] args){
        final YFS_HEADER_CHARGES_H YFS_HEADER_CHARGES_HClass = new YFS_HEADER_CHARGES_H();

        int exitCode = YFS_HEADER_CHARGES_HClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'YFS_HEADER_CHARGES_H' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'YFS_HEADER_CHARGES_H' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_-CUV8OlpEeu_j5YptPMFjw");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-06-18T03:43:09.317886400Z");
        ...
        try {
            ...
            java.io.InputStream inContext = YFS_HEADER_CHARGES_H.class.getClassLoader().getResourceAsStream("at_talend_jobs/yfs_header_charges_h_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = YFS_HEADER_CHARGES_H.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'YFS_HEADER_CHARGES_H' - Started.");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : YFS_HEADER_CHARGES_H");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'YFS_HEADER_CHARGES_H' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     189888 characters generated by Talend Cloud Data Management Platform 
 *     on the June 17, 2023 at 11:43:09 PM EDT
 ************************************************************************************************/