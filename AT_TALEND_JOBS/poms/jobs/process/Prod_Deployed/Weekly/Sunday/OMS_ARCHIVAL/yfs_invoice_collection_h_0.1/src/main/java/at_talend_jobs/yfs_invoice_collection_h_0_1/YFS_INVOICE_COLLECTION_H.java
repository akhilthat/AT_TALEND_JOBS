...
package at_talend_jobs.yfs_invoice_collection_h_0_1;
...
/**
 * Job: YFS_INVOICE_COLLECTION_H Purpose: <br>
 * Description:  <br>
 * @author thati, akhil
 * @version 8.0.1.20230418_1502-patch
 * @status 
 */
public class YFS_INVOICE_COLLECTION_H implements TalendJob {
	static {System.setProperty("TalendJob.log", "YFS_INVOICE_COLLECTION_H.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(YFS_INVOICE_COLLECTION_H.class);
...
public String getSF_warehouse(){
	...
	private final String jobName = "YFS_INVOICE_COLLECTION_H";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_cE6d0OM-EeuY4K47TSORtw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				YFS_INVOICE_COLLECTION_H.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(YFS_INVOICE_COLLECTION_H.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
org.talend.components.snowflake.SnowflakeConnectionProperties props_tDBConnection_1 =
        (org.talend.components.snowflake.SnowflakeConnectionProperties) def_tDBConnection_1.createRuntimeProperties();
 		                    ...
 		                    "Talend_user");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:fYiGda1qAjeg/iwQE39ste9uuYK/uN5hkxv78j1jT3fcCtQZ"));
...
public void tDBConnection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_3{
                    ...
                    log4jParamters_tDBConnection_3.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_3.append(" | ");
                            log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:K457dsT4bcSQV8+nBL3+NAQOEgfaz1q588CxRb8qjLtn5lA/JZA=").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_3.append(" | ");
	...
	final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:UeUdwwvE8bHtCRl3HZr5wcJ6AmH/lWJ7VQRLKKOtxaL5dYZ+/ps=");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AT_TALEND_JOBS_YFS_INVOICE_COLLECTION_H = new byte[0];
    static byte[] commonByteArray_AT_TALEND_JOBS_YFS_INVOICE_COLLECTION_H = new byte[0];

	
			    public String INVOICE_COLLECTION_KEY;

				public String getINVOICE_COLLECTION_KEY () {
					return this.INVOICE_COLLECTION_KEY;
				}

				public Boolean INVOICE_COLLECTION_KEYIsNullable(){
				    return false;
				}
				public Boolean INVOICE_COLLECTION_KEYIsKey(){
				    return false;
				}
				public Integer INVOICE_COLLECTION_KEYLength(){
				    return null;
				}
				public Integer INVOICE_COLLECTION_KEYPrecision(){
				    return null;
				}
				public String INVOICE_COLLECTION_KEYDefault(){
				
					return null;
				
				}
				public String INVOICE_COLLECTION_KEYComment(){
				
				    return "";
				
				}
				public String INVOICE_COLLECTION_KEYPattern(){
				
					return "";
				
				}
				public String INVOICE_COLLECTION_KEYOriginalDbColumnName(){
				
					return "INVOICE_COLLECTION_KEY";
			    ...
			    public BigDecimal AMOUNT_COLLECTED;

				public BigDecimal getAMOUNT_COLLECTED () {
					return this.AMOUNT_COLLECTED;
				}

				public Boolean AMOUNT_COLLECTEDIsNullable(){
				    return false;
				}
				public Boolean AMOUNT_COLLECTEDIsKey(){
				    return false;
				}
				public Integer AMOUNT_COLLECTEDLength(){
				    return null;
				}
				public Integer AMOUNT_COLLECTEDPrecision(){
				    return null;
				}
				public String AMOUNT_COLLECTEDDefault(){
				
					return "";
				
				}
				public String AMOUNT_COLLECTEDComment(){
				
				    return "";
				
				}
				public String AMOUNT_COLLECTEDPattern(){
				
					return "";
				
				}
				public String AMOUNT_COLLECTEDOriginalDbColumnName(){
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AT_TALEND_JOBS_YFS_INVOICE_COLLECTION_H.length) {
				if(length < 1024 && commonByteArray_AT_TALEND_JOBS_YFS_INVOICE_COLLECTION_H.length == 0) {
   					commonByteArray_AT_TALEND_JOBS_YFS_INVOICE_COLLECTION_H = new byte[1024];
				} else {
   					commonByteArray_AT_TALEND_JOBS_YFS_INVOICE_COLLECTION_H = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AT_TALEND_JOBS_YFS_INVOICE_COLLECTION_H, 0, length);
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_YFS_INVOICE_COLLECTION_H, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AT_TALEND_JOBS_YFS_INVOICE_COLLECTION_H, 0, length);
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_YFS_INVOICE_COLLECTION_H, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AT_TALEND_JOBS_YFS_INVOICE_COLLECTION_H) {

        	try {

        		int length = 0;
		
					this.INVOICE_COLLECTION_KEY = readString(dis);
					
					this.ORDER_INVOICE_KEY = readString(dis);
					
					this.CHARGE_TRANSACTION_KEY = readString(dis);
					
						this.AMOUNT_COLLECTED = (BigDecimal) dis.readObject();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.INVOICE_COLLECTION_KEY,dos);
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.AMOUNT_COLLECTED);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("INVOICE_COLLECTION_KEY="+INVOICE_COLLECTION_KEY);
		sb.append(",ORDER_INVOICE_KEY="+ORDER_INVOICE_KEY);
		sb.append(",CHARGE_TRANSACTION_KEY="+CHARGE_TRANSACTION_KEY);
		sb.append(",AMOUNT_COLLECTED="+String.valueOf(AMOUNT_COLLECTED));
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        				...
        				if(INVOICE_COLLECTION_KEY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(INVOICE_COLLECTION_KEY);
            			}
        			...
        			sb.append("|");
        				...
        				if(AMOUNT_COLLECTED == null){
        					sb.append("<null>");
        				}else{
            				sb.append(AMOUNT_COLLECTED);
            			}
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_1_2_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"INVOICE_COLLECTION_KEY\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"INVOICE_COLLECTION_KEY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"INVOICE_COLLECTION_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"INVOICE_COLLECTION_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"AMOUNT_COLLECTED\",\"type\":{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"AMOUNT_COLLECTED\",\"talend.field.dbColumnName\":\"AMOUNT_COLLECTED\",\"di.column.talendType\":\"id_BigDecimal\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"AMOUNT_COLLECTED\",\"di.column.relatedEntity\":\"\"},{",s);
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"  select * from STERLING.YFS_INVOICE_COLLECTION_H where TO_CHAR(MODIFYTS, 'YYYY-MM-DD HH:MI:SS') >= TO_CHAR((sysdate - 7), 'YYYY-MM-DD HH:MI:SS')    \"");
                        log4jParamters_tDBInput_1.append(" | ");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("INVOICE_COLLECTION_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ORDER_INVOICE_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CHARGE_TRANSACTION_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("AMOUNT_COLLECTED")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATETS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYTS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATEUSERID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYUSERID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATEPROGID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYPROGID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LOCKID")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
		    ...
		    String dbquery_tDBInput_1 = "\nselect * from STERLING.YFS_INVOICE_COLLECTION_H where TO_CHAR(MODIFYTS, 'YYYY-MM-DD HH:MI:SS') >= TO_CHAR((sysdate - "
+"7), 'YYYY-MM-DD HH:MI:SS')\n\n";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row1.INVOICE_COLLECTION_KEY = null;
							} else {
	                         		
        	row1.INVOICE_COLLECTION_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.ORDER_INVOICE_KEY = null;
							} else {
	                         		
        	row1.ORDER_INVOICE_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.CHARGE_TRANSACTION_KEY = null;
							} else {
	                         		
        	row1.CHARGE_TRANSACTION_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.AMOUNT_COLLECTED = null;
							} else {
		                          
					if(rs_tDBInput_1.getObject(4) != null) {
						row1.AMOUNT_COLLECTED = rs_tDBInput_1.getBigDecimal(4);
					} else {
			...
			row1.CREATETS = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 5);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.MODIFYTS = null;
							} else {
										
			row1.MODIFYTS = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 6);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.CREATEUSERID = null;
							} else {
	                         		
        	row1.CREATEUSERID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.MODIFYUSERID = null;
							} else {
	                         		
        	row1.MODIFYUSERID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.CREATEPROGID = null;
							} else {
	                         		
        	row1.CREATEPROGID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.MODIFYPROGID = null;
							} else {
	                         		
        	row1.MODIFYPROGID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
		                    }
					...
					if(rs_tDBInput_1.getObject(11) != null) {
						row1.LOCKID = rs_tDBInput_1.getBigDecimal(11);
					} else {
	...
	currentComponent="tDBOutput_1";
        ...
        if (incomingEnforcer_tDBOutput_1 != null) {
            incomingEnforcer_tDBOutput_1.createNewRecord();
                ...
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("INVOICE_COLLECTION_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("INVOICE_COLLECTION_KEY", row1.INVOICE_COLLECTION_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("AMOUNT_COLLECTED") != null){
                    incomingEnforcer_tDBOutput_1.put("AMOUNT_COLLECTED", row1.AMOUNT_COLLECTED);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
 ...
 */
    ...
    public static void main(String[] args){
        final YFS_INVOICE_COLLECTION_H YFS_INVOICE_COLLECTION_HClass = new YFS_INVOICE_COLLECTION_H();

        int exitCode = YFS_INVOICE_COLLECTION_HClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'YFS_INVOICE_COLLECTION_H' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'YFS_INVOICE_COLLECTION_H' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_cE6d0OM-EeuY4K47TSORtw");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-06-18T03:41:42.871654700Z");
        ...
        try {
            ...
            java.io.InputStream inContext = YFS_INVOICE_COLLECTION_H.class.getClassLoader().getResourceAsStream("at_talend_jobs/yfs_invoice_collection_h_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = YFS_INVOICE_COLLECTION_H.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'YFS_INVOICE_COLLECTION_H' - Started.");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : YFS_INVOICE_COLLECTION_H");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'YFS_INVOICE_COLLECTION_H' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     176963 characters generated by Talend Cloud Data Management Platform 
 *     on the June 17, 2023 at 11:41:42 PM EDT
 ************************************************************************************************/