...
public class YFS_INVOICE_COLLECTION_H implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "YFS_INVOICE_COLLECTION_H.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(YFS_INVOICE_COLLECTION_H.class);
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_1.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:AtROLZ8eKpogcPo4mLLOhD28eNFox88AOedo4xxhG8mEEDHj"));
...
// finally of generic
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:hAqEgXTitdnRV5DKaD9feeGXrSlDHoHH0+RasiveDbxCICDjeZc=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_3.append(" | ");
				...
				final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:HLNKpBsleYIsubJnJ6DqUsckt2awForQAq3va+dmcdkph87Yhtk=");
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-06-14T15:32:56.001781700Z");
		...
		try {
			...
			java.io.InputStream inContext = YFS_INVOICE_COLLECTION_H.class.getClassLoader().getResourceAsStream(
					"at_talend_jobs/yfs_invoice_collection_h_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = YFS_INVOICE_COLLECTION_H.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : YFS_INVOICE_COLLECTION_H");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 97241 characters generated by Talend Cloud Data Management Platform on the
 * June 14, 2023 at 11:32:56 AM EDT
 ************************************************************************************************/