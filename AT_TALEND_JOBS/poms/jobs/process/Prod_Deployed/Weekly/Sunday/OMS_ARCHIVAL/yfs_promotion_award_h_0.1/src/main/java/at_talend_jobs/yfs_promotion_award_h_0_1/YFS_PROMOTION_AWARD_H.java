...
public class YFS_PROMOTION_AWARD_H implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "YFS_PROMOTION_AWARD_H.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(YFS_PROMOTION_AWARD_H.class);
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_1.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:SXG1OXjtLmeA8iHXtr2LoEX4icWR3MsHVCeoX9Vkg9Ul0JpE"));
...
// finally of generic
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:0oW4wh8MgPv5kFlByjsL6074xUEPVQKhLPJapVrsQlGkIBhJ0BU=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_3.append(" | ");
				...
				final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:1KVtZSan6c6hTa79YxDDiIFf08tLKQiAorae90TowyyiGUTh2os=");
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-06-14T15:29:07.246782200Z");
		...
		try {
			...
			java.io.InputStream inContext = YFS_PROMOTION_AWARD_H.class.getClassLoader().getResourceAsStream(
					"at_talend_jobs/yfs_promotion_award_h_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = YFS_PROMOTION_AWARD_H.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : YFS_PROMOTION_AWARD_H");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 97181 characters generated by Talend Cloud Data Management Platform on the
 * June 14, 2023 at 11:29:07 AM EDT
 ************************************************************************************************/