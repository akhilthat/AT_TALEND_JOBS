...
package at_talend_jobs.yfs_promotion_award_h_0_1;
...
/**
 * Job: YFS_PROMOTION_AWARD_H Purpose: <br>
 * Description:  <br>
 * @author thati, akhil
 * @version 8.0.1.20230418_1502-patch
 * @status 
 */
public class YFS_PROMOTION_AWARD_H implements TalendJob {
	static {System.setProperty("TalendJob.log", "YFS_PROMOTION_AWARD_H.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(YFS_PROMOTION_AWARD_H.class);
...
public String getSF_warehouse(){
	...
	private final String jobName = "YFS_PROMOTION_AWARD_H";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_PFoqAOmLEeu_j5YptPMFjw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				YFS_PROMOTION_AWARD_H.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(YFS_PROMOTION_AWARD_H.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
org.talend.components.snowflake.SnowflakeConnectionProperties props_tDBConnection_1 =
        (org.talend.components.snowflake.SnowflakeConnectionProperties) def_tDBConnection_1.createRuntimeProperties();
 		                    ...
 		                    "Talend_user");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:iBtG0Af3okjPpXRHPfDbAA8pnohW1xo5ZfLLGmgaZHdJdM/P"));
...
public void tDBConnection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_3{
                    ...
                    log4jParamters_tDBConnection_3.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_3.append(" | ");
                            log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:H82hFWmpogOdzawiC6v6/V5bub7oaDp8b6ftzZ33cjWau3jg3l8=").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_3.append(" | ");
	...
	final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:CLsvB3Cqeevej9p/DiLFw6uakVBuSV1cCc1X5jMdFAFhw1vutgk=");
...
org.talend.components.snowflake.tsnowflakerow.TSnowflakeRowProperties props_tDBRow_1 =
        (org.talend.components.snowflake.tsnowflakerow.TSnowflakeRowProperties) def_tDBRow_1.createRuntimeProperties();
 		                    ...
 		                    "\nDelete from YFS_PROMOTION_AWARD_H\nwhere MODIFYTS >= cast(substr(convert_timezone('America/New_York', DATEADD(DAY, -7"
+", current_timestamp())),0,10) as TIMESTAMPNTZ);\n\n");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AT_TALEND_JOBS_YFS_PROMOTION_AWARD_H = new byte[0];
    static byte[] commonByteArray_AT_TALEND_JOBS_YFS_PROMOTION_AWARD_H = new byte[0];

	
			    public String PROMOTION_AWARD_KEY;

				public String getPROMOTION_AWARD_KEY () {
					return this.PROMOTION_AWARD_KEY;
				}

				public Boolean PROMOTION_AWARD_KEYIsNullable(){
				    return false;
				}
				public Boolean PROMOTION_AWARD_KEYIsKey(){
				    return false;
				}
				public Integer PROMOTION_AWARD_KEYLength(){
				    return null;
				}
				public Integer PROMOTION_AWARD_KEYPrecision(){
				    return null;
				}
				public String PROMOTION_AWARD_KEYDefault(){
				
					return null;
				
				}
				public String PROMOTION_AWARD_KEYComment(){
				
				    return "";
				
				}
				public String PROMOTION_AWARD_KEYPattern(){
				
					return "";
				
				}
				public String PROMOTION_AWARD_KEYOriginalDbColumnName(){
				
					return "PROMOTION_AWARD_KEY";
				...
				public Boolean PROMOTION_KEYIsNullable(){
				    return false;
				}
				public Boolean PROMOTION_KEYIsKey(){
				    return false;
				}
				public Integer PROMOTION_KEYLength(){
				    return null;
				}
				public Integer PROMOTION_KEYPrecision(){
				    return null;
				}
				public String PROMOTION_KEYDefault(){
				
					return null;
				
				}
				public String PROMOTION_KEYComment(){
				
				    return "";
				
				}
				public String PROMOTION_KEYPattern(){
				
					return "";
				
				}
				public String PROMOTION_KEYOriginalDbColumnName(){
				...
				public Boolean PROMOTION_IDIsNullable(){
				    return false;
				}
				public Boolean PROMOTION_IDIsKey(){
				    return false;
				}
				public Integer PROMOTION_IDLength(){
				    return null;
				}
				public Integer PROMOTION_IDPrecision(){
				    return null;
				}
				public String PROMOTION_IDDefault(){
				
					return null;
				
				}
				public String PROMOTION_IDComment(){
				
				    return "";
				
				}
				public String PROMOTION_IDPattern(){
				
					return "";
				
				}
				public String PROMOTION_IDOriginalDbColumnName(){
				...
				public Boolean AWARD_IDIsNullable(){
				    return false;
				}
				public Boolean AWARD_IDIsKey(){
				    return false;
				}
				public Integer AWARD_IDLength(){
				    return null;
				}
				public Integer AWARD_IDPrecision(){
				    return null;
				}
				public String AWARD_IDDefault(){
				
					return null;
				
				}
				public String AWARD_IDComment(){
				
				    return "";
				
				}
				public String AWARD_IDPattern(){
				
					return "";
				
				}
				public String AWARD_IDOriginalDbColumnName(){
				...
				public Boolean AWARD_TYPEIsNullable(){
				    return false;
				}
				public Boolean AWARD_TYPEIsKey(){
				    return false;
				}
				public Integer AWARD_TYPELength(){
				    return null;
				}
				public Integer AWARD_TYPEPrecision(){
				    return null;
				}
				public String AWARD_TYPEDefault(){
				
					return null;
				
				}
				public String AWARD_TYPEComment(){
				
				    return "";
				
				}
				public String AWARD_TYPEPattern(){
				
					return "";
				
				}
				public String AWARD_TYPEOriginalDbColumnName(){
			    ...
			    public BigDecimal AWARD_AMOUNT;

				public BigDecimal getAWARD_AMOUNT () {
					return this.AWARD_AMOUNT;
				}

				public Boolean AWARD_AMOUNTIsNullable(){
				    return false;
				}
				public Boolean AWARD_AMOUNTIsKey(){
				    return false;
				}
				public Integer AWARD_AMOUNTLength(){
				    return null;
				}
				public Integer AWARD_AMOUNTPrecision(){
				    return null;
				}
				public String AWARD_AMOUNTDefault(){
				
					return "";
				
				}
				public String AWARD_AMOUNTComment(){
				
				    return "";
				
				}
				public String AWARD_AMOUNTPattern(){
				
					return "";
				
				}
				public String AWARD_AMOUNTOriginalDbColumnName(){
			    ...
			    public String AWARD_APPLIED;

				public String getAWARD_APPLIED () {
					return this.AWARD_APPLIED;
				}

				public Boolean AWARD_APPLIEDIsNullable(){
				    return false;
				}
				public Boolean AWARD_APPLIEDIsKey(){
				    return false;
				}
				public Integer AWARD_APPLIEDLength(){
				    return null;
				}
				public Integer AWARD_APPLIEDPrecision(){
				    return null;
				}
				public String AWARD_APPLIEDDefault(){
				
					return null;
				
				}
				public String AWARD_APPLIEDComment(){
				
				    return "";
				
				}
				public String AWARD_APPLIEDPattern(){
				
					return "";
				
				}
				public String AWARD_APPLIEDOriginalDbColumnName(){
				
					return "AWARD_APPLIED";
				...
				public Boolean DENIAL_REASONIsNullable(){
				    return false;
				}
				public Boolean DENIAL_REASONIsKey(){
				    return false;
				}
				public Integer DENIAL_REASONLength(){
				    return null;
				}
				public Integer DENIAL_REASONPrecision(){
				    return null;
				}
				public String DENIAL_REASONDefault(){
				
					return null;
				
				}
				public String DENIAL_REASONComment(){
				
				    return "";
				
				}
				public String DENIAL_REASONPattern(){
				
					return "";
				
				}
				public String DENIAL_REASONOriginalDbColumnName(){
			    ...
			    public String POS_REASON_CODE;

				public String getPOS_REASON_CODE () {
					return this.POS_REASON_CODE;
				}

				public Boolean POS_REASON_CODEIsNullable(){
				    return false;
				}
				public Boolean POS_REASON_CODEIsKey(){
				    return false;
				}
				public Integer POS_REASON_CODELength(){
				    return null;
				}
				public Integer POS_REASON_CODEPrecision(){
				    return null;
				}
				public String POS_REASON_CODEDefault(){
				
					return null;
				
				}
				public String POS_REASON_CODEComment(){
				
				    return "";
				
				}
				public String POS_REASON_CODEPattern(){
				
					return "";
				
				}
				public String POS_REASON_CODEOriginalDbColumnName(){
				
					return "POS_REASON_CODE";
			    ...
			    public String IS_FREE_GIFT_AWARD;

				public String getIS_FREE_GIFT_AWARD () {
					return this.IS_FREE_GIFT_AWARD;
				}

				public Boolean IS_FREE_GIFT_AWARDIsNullable(){
				    return false;
				}
				public Boolean IS_FREE_GIFT_AWARDIsKey(){
				    return false;
				}
				public Integer IS_FREE_GIFT_AWARDLength(){
				    return null;
				}
				public Integer IS_FREE_GIFT_AWARDPrecision(){
				    return null;
				}
				public String IS_FREE_GIFT_AWARDDefault(){
				
					return null;
				
				}
				public String IS_FREE_GIFT_AWARDComment(){
				
				    return "";
				
				}
				public String IS_FREE_GIFT_AWARDPattern(){
				
					return "";
				
				}
				public String IS_FREE_GIFT_AWARDOriginalDbColumnName(){
				
					return "IS_FREE_GIFT_AWARD";
				
				}

				
			    public BigDecimal AWARD_QUANTITY;

				public BigDecimal getAWARD_QUANTITY () {
					return this.AWARD_QUANTITY;
				}

				public Boolean AWARD_QUANTITYIsNullable(){
				    return true;
				}
				public Boolean AWARD_QUANTITYIsKey(){
				    return false;
				}
				public Integer AWARD_QUANTITYLength(){
				    return null;
				}
				public Integer AWARD_QUANTITYPrecision(){
				    return null;
				}
				public String AWARD_QUANTITYDefault(){
				
					return "";
				
				}
				public String AWARD_QUANTITYComment(){
				
				    return "";
				
				}
				public String AWARD_QUANTITYPattern(){
				
					return "";
				
				}
				public String AWARD_QUANTITYOriginalDbColumnName(){
			    ...
			    public String ADDNL_LINE_PRICE_KEY;

				public String getADDNL_LINE_PRICE_KEY () {
					return this.ADDNL_LINE_PRICE_KEY;
				}

				public Boolean ADDNL_LINE_PRICE_KEYIsNullable(){
				    return true;
				}
				public Boolean ADDNL_LINE_PRICE_KEYIsKey(){
				    return false;
				}
				public Integer ADDNL_LINE_PRICE_KEYLength(){
				    return null;
				}
				public Integer ADDNL_LINE_PRICE_KEYPrecision(){
				    return null;
				}
				public String ADDNL_LINE_PRICE_KEYDefault(){
				
					return null;
				
				}
				public String ADDNL_LINE_PRICE_KEYComment(){
				
				    return "";
				
				}
				public String ADDNL_LINE_PRICE_KEYPattern(){
				
					return "";
				
				}
				public String ADDNL_LINE_PRICE_KEYOriginalDbColumnName(){
				
					return "ADDNL_LINE_PRICE_KEY";
				...
				public Boolean IS_MANUALIsNullable(){
				    return true;
				}
				public Boolean IS_MANUALIsKey(){
				    return false;
				}
				public Integer IS_MANUALLength(){
				    return null;
				}
				public Integer IS_MANUALPrecision(){
				    return null;
				}
				public String IS_MANUALDefault(){
				
					return null;
				
				}
				public String IS_MANUALComment(){
				
				    return "";
				
				}
				public String IS_MANUALPattern(){
				
					return "";
				
				}
				public String IS_MANUALOriginalDbColumnName(){
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AT_TALEND_JOBS_YFS_PROMOTION_AWARD_H.length) {
				if(length < 1024 && commonByteArray_AT_TALEND_JOBS_YFS_PROMOTION_AWARD_H.length == 0) {
   					commonByteArray_AT_TALEND_JOBS_YFS_PROMOTION_AWARD_H = new byte[1024];
				} else {
   					commonByteArray_AT_TALEND_JOBS_YFS_PROMOTION_AWARD_H = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AT_TALEND_JOBS_YFS_PROMOTION_AWARD_H, 0, length);
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_YFS_PROMOTION_AWARD_H, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AT_TALEND_JOBS_YFS_PROMOTION_AWARD_H, 0, length);
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_YFS_PROMOTION_AWARD_H, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AT_TALEND_JOBS_YFS_PROMOTION_AWARD_H) {

        	try {

        		int length = 0;
		
					this.PROMOTION_AWARD_KEY = readString(dis);
					
					this.PROMOTION_KEY = readString(dis);
					
					this.PROMOTION_ID = readString(dis);
					
					this.ORDER_HEADER_KEY = readString(dis);
					
					this.ORDER_LINE_KEY = readString(dis);
					
					this.AWARD_ID = readString(dis);
					
					this.DESCRIPTION = readString(dis);
					
					this.AWARD_TYPE = readString(dis);
					
						this.AWARD_AMOUNT = (BigDecimal) dis.readObject();
					
					this.AWARD_APPLIED = readString(dis);
					
					this.DENIAL_REASON = readString(dis);
					
					this.POS_REASON_CODE = readString(dis);
					...
					this.IS_FREE_GIFT_AWARD = readString(dis);
					
						this.AWARD_QUANTITY = (BigDecimal) dis.readObject();
					
					this.ADDNL_LINE_PRICE_KEY = readString(dis);
					
					this.IS_MANUAL = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.PROMOTION_AWARD_KEY,dos);
					
					// String
				
						writeString(this.PROMOTION_KEY,dos);
					
					// String
				
						writeString(this.PROMOTION_ID,dos);
					...
					// String
						...
						writeString(this.AWARD_TYPE,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.AWARD_AMOUNT);
					
					// String
				
						writeString(this.AWARD_APPLIED,dos);
					
					// String
				
						writeString(this.DENIAL_REASON,dos);
					
					// String
				
						writeString(this.POS_REASON_CODE,dos);
					...
					// String
						...
						writeString(this.IS_FREE_GIFT_AWARD,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.AWARD_QUANTITY);
					
					// String
				
						writeString(this.ADDNL_LINE_PRICE_KEY,dos);
					
					// String
				
						writeString(this.IS_MANUAL,dos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("PROMOTION_AWARD_KEY="+PROMOTION_AWARD_KEY);
		sb.append(",PROMOTION_KEY="+PROMOTION_KEY);
		sb.append(",PROMOTION_ID="+PROMOTION_ID);
		sb.append(",ORDER_HEADER_KEY="+ORDER_HEADER_KEY);
		sb.append(",ORDER_LINE_KEY="+ORDER_LINE_KEY);
		sb.append(",AWARD_ID="+AWARD_ID);
		sb.append(",DESCRIPTION="+DESCRIPTION);
		sb.append(",AWARD_TYPE="+AWARD_TYPE);
		sb.append(",AWARD_AMOUNT="+String.valueOf(AWARD_AMOUNT));
		sb.append(",AWARD_APPLIED="+AWARD_APPLIED);
		sb.append(",DENIAL_REASON="+DENIAL_REASON);
		sb.append(",POS_REASON_CODE="+POS_REASON_CODE);
		...
		sb.append(",IS_FREE_GIFT_AWARD="+IS_FREE_GIFT_AWARD);
		sb.append(",AWARD_QUANTITY="+String.valueOf(AWARD_QUANTITY));
		sb.append(",ADDNL_LINE_PRICE_KEY="+ADDNL_LINE_PRICE_KEY);
		sb.append(",IS_MANUAL="+IS_MANUAL);
	    sb.append("]");
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        				...
        				if(PROMOTION_AWARD_KEY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PROMOTION_AWARD_KEY);
            			}
            		
        			sb.append("|");
        		
        				if(PROMOTION_KEY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PROMOTION_KEY);
            			}
        			...
        			sb.append("|");
        				...
        				if(AWARD_AMOUNT == null){
            				...
            				sb.append(AWARD_AMOUNT);
            			}
            		
        			sb.append("|");
        		
        				if(AWARD_APPLIED == null){
        					sb.append("<null>");
        				}else{
            				sb.append(AWARD_APPLIED);
            			}
        			...
        			sb.append("|");
        				...
        				if(POS_REASON_CODE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(POS_REASON_CODE);
            			}
        			...
        			sb.append("|");
        				...
        				if(IS_FREE_GIFT_AWARD == null){
        					sb.append("<null>");
        				}else{
            				sb.append(IS_FREE_GIFT_AWARD);
            			}
            		
        			sb.append("|");
        		
        				if(AWARD_QUANTITY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(AWARD_QUANTITY);
            			}
            		
        			sb.append("|");
        		
        				if(ADDNL_LINE_PRICE_KEY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ADDNL_LINE_PRICE_KEY);
            			}
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_1_2_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"PROMOTION_AWARD_KEY\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"PROMOTION_AWARD_KEY\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"PROMOTION_AWARD_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"PROMOTION_AWARD_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"PROMOTION_KEY\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"PROMOTION_KEY\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"PROMOTION_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"PROMOTION_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"PROMOTION_ID\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"PROMOTION_ID\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"PROMOTION_ID\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"PROMOTION_ID\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ORDER_HEADER_KEY\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ORDER_HEADER_KEY\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"ORDER_HEADER_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ORDER_HEADER_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ORDER_LINE_KEY\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ORDER_LINE_KEY\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"ORDER_LINE_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ORDER_LINE_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"AWARD_ID\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"AWARD_ID\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"AWARD_ID\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"AWARD_ID\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"DESCRIPTION\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"DESCRIPTION\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"DESCRIPTION\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"DESCRIPTION\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"AWARD_TYPE\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"AWARD_TYPE\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"AWARD_TYPE\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"AWARD_TYPE\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"AWARD_AMOUNT\",\"type\":{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"AWARD_AMOUNT\",\"talend.field.dbType\":\"\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"AWARD_AMOUNT\",\"di.column.talendType\":\"id_BigDecimal\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"AWARD_AMOUNT\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"AWARD_APPLIED\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"AWARD_APPLIED\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"AWARD_APPLIED\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"AWARD_APPLIED\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"DENIAL_REASON\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"DENIAL_REASON\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"DENIAL_REASON\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"DENIAL_REASON\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"POS_REASON_CODE\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"POS_REASON_CODE\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"POS_REASON_CODE\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"POS_REASON_CODE\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CHARGE_CATEGORY\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CHARGE_CATEGORY\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"CHARGE_CATEGORY\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CHARGE_CATEGORY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CHARGE_NAME\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CHARGE_NAME\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"CHARGE_NAME\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CHARGE_NAME\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CREATETS\",\"type\":{\"type\":\"long\",\"java-class\":\"java.util.Date\"},\"di.table.comment\":\"\",\"di.prop.di.date.noLogicalType\":\"true\",\"AVRO_TECHNICAL_KEY\":\"CREATETS\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"CREATETS\",\"di.column.talendType\":\"id_Date\",\"talend.field.pattern\":\"yyyy-MM-dd'T'HH:mm:ss\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CREATETS\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"MODIFYTS\",\"type\":{\"type\":\"long\",\"java-class\":\"java.util.Date\"},\"di.table.comment\":\"\",\"di.prop.di.date.noLogicalType\":\"true\",\"AVRO_TECHNICAL_KEY\":\"MODIFYTS\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"MODIFYTS\",\"di.column.talendType\":\"id_Date\",\"talend.field.pattern\":\"yyyy-MM-dd'T'HH:mm:ss\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"MODIFYTS\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CREATEUSERID\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CREATEUSERID\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"CREATEUSERID\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CREATEUSERID\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"MODIFYUSERID\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"MODIFYUSERID\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"MODIFYUSERID\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"MODIFYUSERID\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"CREATEPROGID\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CREATEPROGID\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"CREATEPROGID\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CREATEPROGID\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"MODIFYPROGID\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"MODIFYPROGID\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"MODIFYPROGID\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"MODIFYPROGID\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"LOCKID\",\"type\":{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"LOCKID\",\"talend.field.dbType\":\"\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"LOCKID\",\"di.column.talendType\":\"id_BigDecimal\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"LOCKID\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"IS_FREE_GIFT_AWARD\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"IS_FREE_GIFT_AWARD\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"IS_FREE_GIFT_AWARD\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"IS_FREE_GIFT_AWARD\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"AWARD_QUANTITY\",\"type\":[{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"AWARD_QUANTITY\",\"talend.field.dbType\":\"\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"AWARD_QUANTITY\",\"di.column.talendType\":\"id_BigDecimal\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"AWARD_QUANTITY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ADDNL_LINE_PRICE_KEY\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ADDNL_LINE_PRICE_KEY\",\"talend.field.dbType\":\"\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"ADDNL_LINE_PRICE_KEY\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ADDNL_LINE_PRICE_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"IS_MANUAL\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"IS_MANUAL\",\"talend.field.dbType\":\"\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"IS_MANUAL\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"IS_MANUAL\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tDBOutput_1\",\"di.table.label\":\"tDBOutput_1\"}",s);
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"  select * from STERLING.YFS_PROMOTION_AWARD_H where TO_CHAR(MODIFYTS, 'YYYY-MM-DD HH:MI:SS') >= TO_CHAR((sysdate - 7), 'YYYY-MM-DD HH:MI:SS')    \"");
                        log4jParamters_tDBInput_1.append(" | ");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("PROMOTION_AWARD_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("PROMOTION_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("PROMOTION_ID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ORDER_HEADER_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ORDER_LINE_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("AWARD_ID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DESCRIPTION")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("AWARD_TYPE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("AWARD_AMOUNT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("AWARD_APPLIED")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DENIAL_REASON")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("POS_REASON_CODE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CHARGE_CATEGORY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CHARGE_NAME")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATETS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYTS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATEUSERID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYUSERID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATEPROGID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYPROGID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LOCKID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IS_FREE_GIFT_AWARD")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("AWARD_QUANTITY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ADDNL_LINE_PRICE_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("IS_MANUAL")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
		    ...
		    String dbquery_tDBInput_1 = "\nselect * from STERLING.YFS_PROMOTION_AWARD_H where TO_CHAR(MODIFYTS, 'YYYY-MM-DD HH:MI:SS') >= TO_CHAR((sysdate - 7),"
+" 'YYYY-MM-DD HH:MI:SS')\n\n";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row1.PROMOTION_AWARD_KEY = null;
							} else {
	                         		
        	row1.PROMOTION_AWARD_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.PROMOTION_KEY = null;
							} else {
	                         		
        	row1.PROMOTION_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.PROMOTION_ID = null;
							} else {
	                         		
        	row1.PROMOTION_ID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.ORDER_HEADER_KEY = null;
							} else {
	                         		
        	row1.ORDER_HEADER_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.ORDER_LINE_KEY = null;
							} else {
	                         		
        	row1.ORDER_LINE_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.AWARD_ID = null;
							} else {
	                         		
        	row1.AWARD_ID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.DESCRIPTION = null;
							} else {
	                         		
        	row1.DESCRIPTION = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.AWARD_TYPE = null;
							} else {
	                         		
        	row1.AWARD_TYPE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.AWARD_AMOUNT = null;
							} else {
		                          
					if(rs_tDBInput_1.getObject(9) != null) {
						row1.AWARD_AMOUNT = rs_tDBInput_1.getBigDecimal(9);
					} else {
 	                	...
 	                	throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.AWARD_APPLIED = null;
							} else {
	                         		
        	row1.AWARD_APPLIED = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.DENIAL_REASON = null;
							} else {
	                         		
        	row1.DENIAL_REASON = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 12) {
								row1.POS_REASON_CODE = null;
							} else {
	                         		
        	row1.POS_REASON_CODE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 13) {
								row1.CHARGE_CATEGORY = null;
							} else {
	                         		
        	row1.CHARGE_CATEGORY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								row1.CHARGE_NAME = null;
							} else {
	                         		
        	row1.CHARGE_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, false);
		                    }
						...
						row1.LOCKID = rs_tDBInput_1.getBigDecimal(21);
 	                	...
 	                	throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tDBInput_1 < 22) {
								row1.IS_FREE_GIFT_AWARD = null;
							} else {
	                         		
        	row1.IS_FREE_GIFT_AWARD = routines.system.JDBCUtil.getString(rs_tDBInput_1, 22, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 23) {
								row1.AWARD_QUANTITY = null;
							} else {
		                          
					if(rs_tDBInput_1.getObject(23) != null) {
						row1.AWARD_QUANTITY = rs_tDBInput_1.getBigDecimal(23);
					} else {
						...
						row1.AWARD_QUANTITY = null;
							...
							if(colQtyInRs_tDBInput_1 < 24) {
								row1.ADDNL_LINE_PRICE_KEY = null;
							} else {
	                         		
        	row1.ADDNL_LINE_PRICE_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 24, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 25) {
								row1.IS_MANUAL = null;
							} else {
	                         		
        	row1.IS_MANUAL = routines.system.JDBCUtil.getString(rs_tDBInput_1, 25, false);
		                    }
	...
	currentComponent="tDBOutput_1";
        ...
        if (incomingEnforcer_tDBOutput_1 != null) {
            incomingEnforcer_tDBOutput_1.createNewRecord();
                ...
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("PROMOTION_AWARD_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("PROMOTION_AWARD_KEY", row1.PROMOTION_AWARD_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("PROMOTION_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("PROMOTION_KEY", row1.PROMOTION_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("PROMOTION_ID") != null){
                    incomingEnforcer_tDBOutput_1.put("PROMOTION_ID", row1.PROMOTION_ID);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("AWARD_ID") != null){
                    incomingEnforcer_tDBOutput_1.put("AWARD_ID", row1.AWARD_ID);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("DESCRIPTION") != null){
                    incomingEnforcer_tDBOutput_1.put("DESCRIPTION", row1.DESCRIPTION);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("AWARD_TYPE") != null){
                    incomingEnforcer_tDBOutput_1.put("AWARD_TYPE", row1.AWARD_TYPE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("AWARD_AMOUNT") != null){
                    incomingEnforcer_tDBOutput_1.put("AWARD_AMOUNT", row1.AWARD_AMOUNT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("AWARD_APPLIED") != null){
                    incomingEnforcer_tDBOutput_1.put("AWARD_APPLIED", row1.AWARD_APPLIED);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("DENIAL_REASON") != null){
                    incomingEnforcer_tDBOutput_1.put("DENIAL_REASON", row1.DENIAL_REASON);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("POS_REASON_CODE") != null){
                    incomingEnforcer_tDBOutput_1.put("POS_REASON_CODE", row1.POS_REASON_CODE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("IS_FREE_GIFT_AWARD") != null){
                    incomingEnforcer_tDBOutput_1.put("IS_FREE_GIFT_AWARD", row1.IS_FREE_GIFT_AWARD);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("AWARD_QUANTITY") != null){
                    incomingEnforcer_tDBOutput_1.put("AWARD_QUANTITY", row1.AWARD_QUANTITY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("ADDNL_LINE_PRICE_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("ADDNL_LINE_PRICE_KEY", row1.ADDNL_LINE_PRICE_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("IS_MANUAL") != null){
                    incomingEnforcer_tDBOutput_1.put("IS_MANUAL", row1.IS_MANUAL);
                }
 ...
 */
    ...
    public static void main(String[] args){
        final YFS_PROMOTION_AWARD_H YFS_PROMOTION_AWARD_HClass = new YFS_PROMOTION_AWARD_H();

        int exitCode = YFS_PROMOTION_AWARD_HClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'YFS_PROMOTION_AWARD_H' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'YFS_PROMOTION_AWARD_H' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_PFoqAOmLEeu_j5YptPMFjw");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-06-18T03:28:56.677394200Z");
        ...
        try {
            ...
            java.io.InputStream inContext = YFS_PROMOTION_AWARD_H.class.getClassLoader().getResourceAsStream("at_talend_jobs/yfs_promotion_award_h_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = YFS_PROMOTION_AWARD_H.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'YFS_PROMOTION_AWARD_H' - Started.");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : YFS_PROMOTION_AWARD_H");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'YFS_PROMOTION_AWARD_H' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     210253 characters generated by Talend Cloud Data Management Platform 
 *     on the June 17, 2023 at 11:28:56 PM EDT
 ************************************************************************************************/