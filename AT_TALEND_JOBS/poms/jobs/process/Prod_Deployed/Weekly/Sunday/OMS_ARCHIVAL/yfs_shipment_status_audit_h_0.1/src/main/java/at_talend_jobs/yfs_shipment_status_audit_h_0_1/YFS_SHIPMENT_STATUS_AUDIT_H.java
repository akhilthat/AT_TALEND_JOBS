...
package at_talend_jobs.yfs_shipment_status_audit_h_0_1;
...
/**
 * Job: YFS_SHIPMENT_STATUS_AUDIT_H Purpose: <br>
 * Description:  <br>
 * @author thati, akhil
 * @version 8.0.1.20230418_1502-patch
 * @status 
 */
public class YFS_SHIPMENT_STATUS_AUDIT_H implements TalendJob {
	static {System.setProperty("TalendJob.log", "YFS_SHIPMENT_STATUS_AUDIT_H.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(YFS_SHIPMENT_STATUS_AUDIT_H.class);
...
public String getSF_warehouse(){
	...
	private final String jobName = "YFS_SHIPMENT_STATUS_AUDIT_H";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_ADMZAOmgEeu_j5YptPMFjw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				YFS_SHIPMENT_STATUS_AUDIT_H.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(YFS_SHIPMENT_STATUS_AUDIT_H.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
org.talend.components.snowflake.SnowflakeConnectionProperties props_tDBConnection_1 =
        (org.talend.components.snowflake.SnowflakeConnectionProperties) def_tDBConnection_1.createRuntimeProperties();
 		                    ...
 		                    "Talend_user");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:2ufUu59i1MB2Gq6CAmz1yunsgGk9x7y+J5oBPv/wniA3dH04"));
...
public void tDBConnection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_3{
                    ...
                    log4jParamters_tDBConnection_3.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_3.append(" | ");
                            log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:0h+OxQZn85cy4Il8A4ZuDhDbJaO2JOSuXi70BfrsYzmu9iOfu5M=").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_3.append(" | ");
	...
	final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:00MVXcOmtc3EJTWJRn+6+M3fv/uH45mmUQZwW49uMJN2nRkIw0Y=");
...
org.talend.components.snowflake.tsnowflakerow.TSnowflakeRowProperties props_tDBRow_1 =
        (org.talend.components.snowflake.tsnowflakerow.TSnowflakeRowProperties) def_tDBRow_1.createRuntimeProperties();
 		                    ...
 		                    "\nDelete from YFS_SHIPMENT_STATUS_AUDIT_H\nwhere MODIFYTS >= cast(substr(convert_timezone('America/New_York', DATEADD(D"
+"AY, -7, current_timestamp())),0,10) as TIMESTAMPNTZ);\n\n");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AT_TALEND_JOBS_YFS_SHIPMENT_STATUS_AUDIT_H = new byte[0];
    static byte[] commonByteArray_AT_TALEND_JOBS_YFS_SHIPMENT_STATUS_AUDIT_H = new byte[0];

	
			    public String SHIPMENT_STATUS_AUDIT_KEY;

				public String getSHIPMENT_STATUS_AUDIT_KEY () {
					return this.SHIPMENT_STATUS_AUDIT_KEY;
				}

				public Boolean SHIPMENT_STATUS_AUDIT_KEYIsNullable(){
				    return false;
				}
				public Boolean SHIPMENT_STATUS_AUDIT_KEYIsKey(){
				    return false;
				}
				public Integer SHIPMENT_STATUS_AUDIT_KEYLength(){
				    return null;
				}
				public Integer SHIPMENT_STATUS_AUDIT_KEYPrecision(){
				    return null;
				}
				public String SHIPMENT_STATUS_AUDIT_KEYDefault(){
				
					return null;
				
				}
				public String SHIPMENT_STATUS_AUDIT_KEYComment(){
				
				    return "";
				
				}
				public String SHIPMENT_STATUS_AUDIT_KEYPattern(){
				
					return "";
				
				}
				public String SHIPMENT_STATUS_AUDIT_KEYOriginalDbColumnName(){
				
					return "SHIPMENT_STATUS_AUDIT_KEY";
				...
				public Boolean OLD_STATUSIsNullable(){
				    return false;
				}
				public Boolean OLD_STATUSIsKey(){
				    return false;
				}
				public Integer OLD_STATUSLength(){
				    return null;
				}
				public Integer OLD_STATUSPrecision(){
				    return null;
				}
				public String OLD_STATUSDefault(){
				
					return null;
				
				}
				public String OLD_STATUSComment(){
				
				    return "";
				
				}
				public String OLD_STATUSPattern(){
				
					return "";
				
				}
				public String OLD_STATUSOriginalDbColumnName(){
				...
				public Boolean NEW_STATUSIsNullable(){
				    return false;
				}
				public Boolean NEW_STATUSIsKey(){
				    return false;
				}
				public Integer NEW_STATUSLength(){
				    return null;
				}
				public Integer NEW_STATUSPrecision(){
				    return null;
				}
				public String NEW_STATUSDefault(){
				
					return null;
				
				}
				public String NEW_STATUSComment(){
				
				    return "";
				
				}
				public String NEW_STATUSPattern(){
				
					return "";
				
				}
				public String NEW_STATUSOriginalDbColumnName(){
			    ...
			    public java.util.Date OLD_STATUS_DATE;

				public java.util.Date getOLD_STATUS_DATE () {
					return this.OLD_STATUS_DATE;
				}

				public Boolean OLD_STATUS_DATEIsNullable(){
				    return false;
				}
				public Boolean OLD_STATUS_DATEIsKey(){
				    return false;
				}
				public Integer OLD_STATUS_DATELength(){
				    return null;
				}
				public Integer OLD_STATUS_DATEPrecision(){
				    return null;
				}
				public String OLD_STATUS_DATEDefault(){
				
					return null;
				
				}
				public String OLD_STATUS_DATEComment(){
				
				    return "";
				
				}
				public String OLD_STATUS_DATEPattern(){
				
					return "yyyy-MM-dd'T'HH:mm:ss";
				
				}
				public String OLD_STATUS_DATEOriginalDbColumnName(){
				
					return "OLD_STATUS_DATE";
				
				}

				
			    public java.util.Date NEW_STATUS_DATE;

				public java.util.Date getNEW_STATUS_DATE () {
					return this.NEW_STATUS_DATE;
				}

				public Boolean NEW_STATUS_DATEIsNullable(){
				    return false;
				}
				public Boolean NEW_STATUS_DATEIsKey(){
				    return false;
				}
				public Integer NEW_STATUS_DATELength(){
				    return null;
				}
				public Integer NEW_STATUS_DATEPrecision(){
				    return null;
				}
				public String NEW_STATUS_DATEDefault(){
				
					return null;
				
				}
				public String NEW_STATUS_DATEComment(){
				
				    return "";
				
				}
				public String NEW_STATUS_DATEPattern(){
				
					return "yyyy-MM-dd'T'HH:mm:ss";
				
				}
				public String NEW_STATUS_DATEOriginalDbColumnName(){
				
					return "NEW_STATUS_DATE";
				...
				public Boolean REASON_CODEIsNullable(){
				    return false;
				}
				public Boolean REASON_CODEIsKey(){
				    return false;
				}
				public Integer REASON_CODELength(){
				    return null;
				}
				public Integer REASON_CODEPrecision(){
				    return null;
				}
				public String REASON_CODEDefault(){
				
					return null;
				
				}
				public String REASON_CODEComment(){
				
				    return "";
				
				}
				public String REASON_CODEPattern(){
				
					return "";
				
				}
				public String REASON_CODEOriginalDbColumnName(){
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AT_TALEND_JOBS_YFS_SHIPMENT_STATUS_AUDIT_H.length) {
				if(length < 1024 && commonByteArray_AT_TALEND_JOBS_YFS_SHIPMENT_STATUS_AUDIT_H.length == 0) {
   					commonByteArray_AT_TALEND_JOBS_YFS_SHIPMENT_STATUS_AUDIT_H = new byte[1024];
				} else {
   					commonByteArray_AT_TALEND_JOBS_YFS_SHIPMENT_STATUS_AUDIT_H = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AT_TALEND_JOBS_YFS_SHIPMENT_STATUS_AUDIT_H, 0, length);
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_YFS_SHIPMENT_STATUS_AUDIT_H, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AT_TALEND_JOBS_YFS_SHIPMENT_STATUS_AUDIT_H, 0, length);
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_YFS_SHIPMENT_STATUS_AUDIT_H, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AT_TALEND_JOBS_YFS_SHIPMENT_STATUS_AUDIT_H) {

        	try {

        		int length = 0;
		
					this.SHIPMENT_STATUS_AUDIT_KEY = readString(dis);
					
					this.SHIPMENT_KEY = readString(dis);
					
					this.OLD_STATUS = readString(dis);
					
					this.NEW_STATUS = readString(dis);
					
					this.OLD_STATUS_DATE = readDate(dis);
					
					this.NEW_STATUS_DATE = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.SHIPMENT_STATUS_AUDIT_KEY,dos);
					...
					// String
						...
						writeString(this.OLD_STATUS,dos);
					
					// String
				
						writeString(this.NEW_STATUS,dos);
					
					// java.util.Date
				
						writeDate(this.OLD_STATUS_DATE,dos);
					
					// java.util.Date
				
						writeDate(this.NEW_STATUS_DATE,dos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("SHIPMENT_STATUS_AUDIT_KEY="+SHIPMENT_STATUS_AUDIT_KEY);
		sb.append(",SHIPMENT_KEY="+SHIPMENT_KEY);
		sb.append(",OLD_STATUS="+OLD_STATUS);
		sb.append(",NEW_STATUS="+NEW_STATUS);
		sb.append(",OLD_STATUS_DATE="+String.valueOf(OLD_STATUS_DATE));
		sb.append(",NEW_STATUS_DATE="+String.valueOf(NEW_STATUS_DATE));
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        				...
        				if(SHIPMENT_STATUS_AUDIT_KEY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SHIPMENT_STATUS_AUDIT_KEY);
            			}
        			...
        			sb.append("|");
        				...
        				if(OLD_STATUS_DATE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(OLD_STATUS_DATE);
            			}
            		
        			sb.append("|");
        		
        				if(NEW_STATUS_DATE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(NEW_STATUS_DATE);
            			}
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_1_2_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"SHIPMENT_STATUS_AUDIT_KEY\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"SHIPMENT_STATUS_AUDIT_KEY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"SHIPMENT_STATUS_AUDIT_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"SHIPMENT_STATUS_AUDIT_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"OLD_STATUS\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"OLD_STATUS\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"OLD_STATUS\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"OLD_STATUS\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"NEW_STATUS\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"NEW_STATUS\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"NEW_STATUS\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"NEW_STATUS\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"OLD_STATUS_DATE\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"},\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"OLD_STATUS_DATE\",\"talend.field.dbColumnName\":\"OLD_STATUS_DATE\",\"di.column.talendType\":\"id_Date\",\"talend.field.pattern\":\"yyyy-MM-dd'T'HH:mm:ss\",\"di.column.relationshipType\":\"\",\"di.prop.di.column.logicalType\":\"timestamp-millis\",\"di.table.label\":\"OLD_STATUS_DATE\",\"di.prop.di.date.timestamp\":\"true\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"NEW_STATUS_DATE\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"},\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"NEW_STATUS_DATE\",\"talend.field.dbColumnName\":\"NEW_STATUS_DATE\",\"di.column.talendType\":\"id_Date\",\"talend.field.pattern\":\"yyyy-MM-dd'T'HH:mm:ss\",\"di.column.relationshipType\":\"\",\"di.prop.di.column.logicalType\":\"timestamp-millis\",\"di.table.label\":\"NEW_STATUS_DATE\",\"di.prop.di.date.timestamp\":\"true\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"REASON_CODE\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"REASON_CODE\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"REASON_CODE\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"REASON_CODE\",\"di.column.relatedEntity\":\"\"},{",s);
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"  select * from STERLING.YFS_SHIPMENT_STATUS_AUDIT_H where TO_CHAR(MODIFYTS, 'YYYY-MM-DD HH:MI:SS') >= TO_CHAR((sysdate - 7), 'YYYY-MM-DD HH:MI:SS')    \"");
                        log4jParamters_tDBInput_1.append(" | ");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("SHIPMENT_STATUS_AUDIT_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("SHIPMENT_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("OLD_STATUS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("NEW_STATUS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("OLD_STATUS_DATE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("NEW_STATUS_DATE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("REASON_CODE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("REASON_TEXT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LOCKID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATETS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYTS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATEUSERID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYUSERID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATEPROGID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYPROGID")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
		    ...
		    String dbquery_tDBInput_1 = "\nselect * from STERLING.YFS_SHIPMENT_STATUS_AUDIT_H where TO_CHAR(MODIFYTS, 'YYYY-MM-DD HH:MI:SS') >= TO_CHAR((sysdate"
+" - 7), 'YYYY-MM-DD HH:MI:SS')\n\n";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row1.SHIPMENT_STATUS_AUDIT_KEY = null;
							} else {
	                         		
        	row1.SHIPMENT_STATUS_AUDIT_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.SHIPMENT_KEY = null;
							} else {
	                         		
        	row1.SHIPMENT_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.OLD_STATUS = null;
							} else {
	                         		
        	row1.OLD_STATUS = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.NEW_STATUS = null;
							} else {
	                         		
        	row1.NEW_STATUS = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.OLD_STATUS_DATE = null;
							} else {
										
			row1.OLD_STATUS_DATE = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 5);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.NEW_STATUS_DATE = null;
							} else {
										
			row1.NEW_STATUS_DATE = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 6);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.REASON_CODE = null;
							} else {
	                         		
        	row1.REASON_CODE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.REASON_TEXT = null;
							} else {
	                         		
        	row1.REASON_TEXT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
					...
					if(rs_tDBInput_1.getObject(9) != null) {
						row1.LOCKID = rs_tDBInput_1.getBigDecimal(9);
					} else {
			...
			row1.CREATETS = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 10);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.MODIFYTS = null;
							} else {
										
			row1.MODIFYTS = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 11);
		                    }
							if(colQtyInRs_tDBInput_1 < 12) {
								row1.CREATEUSERID = null;
							} else {
	                         		
        	row1.CREATEUSERID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 13) {
								row1.MODIFYUSERID = null;
							} else {
	                         		
        	row1.MODIFYUSERID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								row1.CREATEPROGID = null;
							} else {
	                         		
        	row1.CREATEPROGID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 15) {
								row1.MODIFYPROGID = null;
							} else {
	                         		
        	row1.MODIFYPROGID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 15, false);
		                    }
	...
	currentComponent="tDBOutput_1";
        ...
        if (incomingEnforcer_tDBOutput_1 != null) {
            incomingEnforcer_tDBOutput_1.createNewRecord();
                ...
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("SHIPMENT_STATUS_AUDIT_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("SHIPMENT_STATUS_AUDIT_KEY", row1.SHIPMENT_STATUS_AUDIT_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("OLD_STATUS") != null){
                    incomingEnforcer_tDBOutput_1.put("OLD_STATUS", row1.OLD_STATUS);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("NEW_STATUS") != null){
                    incomingEnforcer_tDBOutput_1.put("NEW_STATUS", row1.NEW_STATUS);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("OLD_STATUS_DATE") != null){
                    incomingEnforcer_tDBOutput_1.put("OLD_STATUS_DATE", row1.OLD_STATUS_DATE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("NEW_STATUS_DATE") != null){
                    incomingEnforcer_tDBOutput_1.put("NEW_STATUS_DATE", row1.NEW_STATUS_DATE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("REASON_CODE") != null){
                    incomingEnforcer_tDBOutput_1.put("REASON_CODE", row1.REASON_CODE);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
 ...
 */
    ...
    public static void main(String[] args){
        final YFS_SHIPMENT_STATUS_AUDIT_H YFS_SHIPMENT_STATUS_AUDIT_HClass = new YFS_SHIPMENT_STATUS_AUDIT_H();

        int exitCode = YFS_SHIPMENT_STATUS_AUDIT_HClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'YFS_SHIPMENT_STATUS_AUDIT_H' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'YFS_SHIPMENT_STATUS_AUDIT_H' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_ADMZAOmgEeu_j5YptPMFjw");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-06-18T03:24:56.147306100Z");
        ...
        try {
            ...
            java.io.InputStream inContext = YFS_SHIPMENT_STATUS_AUDIT_H.class.getClassLoader().getResourceAsStream("at_talend_jobs/yfs_shipment_status_audit_h_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = YFS_SHIPMENT_STATUS_AUDIT_H.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'YFS_SHIPMENT_STATUS_AUDIT_H' - Started.");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : YFS_SHIPMENT_STATUS_AUDIT_H");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'YFS_SHIPMENT_STATUS_AUDIT_H' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     186109 characters generated by Talend Cloud Data Management Platform 
 *     on the June 17, 2023 at 11:24:56 PM EDT
 ************************************************************************************************/