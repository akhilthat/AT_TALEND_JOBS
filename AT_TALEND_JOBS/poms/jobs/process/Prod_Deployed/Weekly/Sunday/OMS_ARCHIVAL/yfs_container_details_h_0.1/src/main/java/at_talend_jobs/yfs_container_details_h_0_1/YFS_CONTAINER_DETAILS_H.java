...
package at_talend_jobs.yfs_container_details_h_0_1;
...
/**
 * Job: YFS_CONTAINER_DETAILS_H Purpose: <br>
 * Description:  <br>
 * @author thati, akhil
 * @version 8.0.1.20230418_1502-patch
 * @status 
 */
public class YFS_CONTAINER_DETAILS_H implements TalendJob {
	static {System.setProperty("TalendJob.log", "YFS_CONTAINER_DETAILS_H.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(YFS_CONTAINER_DETAILS_H.class);
...
public String getSF_warehouse(){
	...
	private final String jobName = "YFS_CONTAINER_DETAILS_H";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_1yJbQOv1Eeui_7U8UwU2ug", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				YFS_CONTAINER_DETAILS_H.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(YFS_CONTAINER_DETAILS_H.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
org.talend.components.snowflake.SnowflakeConnectionProperties props_tDBConnection_2 =
        (org.talend.components.snowflake.SnowflakeConnectionProperties) def_tDBConnection_2.createRuntimeProperties();
 		                    ...
 		                    "Talend_user");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:KxIS39vBkTtpALhUTet6eKZPiCB8WI0gXQ95hKMlp+6CvKnK"));
...
public void tDBConnection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_3{
                    ...
                    log4jParamters_tDBConnection_3.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_3.append(" | ");
                            log4jParamters_tDBConnection_3.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:48yhIwMsqOEnB+CcRCc/B/O8BtBaRUGAeHtOlv2lGGIsl99Wcuk=").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_3.append(" | ");
	...
	final String decryptedPassword_tDBConnection_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:S4dHJKEdWVfQo7eVphHkTN+eYIyyFxQUGeXz4aqLozwSv6omPl0=");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AT_TALEND_JOBS_YFS_CONTAINER_DETAILS_H = new byte[0];
    static byte[] commonByteArray_AT_TALEND_JOBS_YFS_CONTAINER_DETAILS_H = new byte[0];

	
			    public String CONTAINER_DETAILS_KEY;

				public String getCONTAINER_DETAILS_KEY () {
					return this.CONTAINER_DETAILS_KEY;
				}

				public Boolean CONTAINER_DETAILS_KEYIsNullable(){
				    return true;
				}
				public Boolean CONTAINER_DETAILS_KEYIsKey(){
				    return false;
				}
				public Integer CONTAINER_DETAILS_KEYLength(){
				    return null;
				}
				public Integer CONTAINER_DETAILS_KEYPrecision(){
				    return null;
				}
				public String CONTAINER_DETAILS_KEYDefault(){
				
					return null;
				
				}
				public String CONTAINER_DETAILS_KEYComment(){
				
				    return "";
				
				}
				public String CONTAINER_DETAILS_KEYPattern(){
				
					return "";
				
				}
				public String CONTAINER_DETAILS_KEYOriginalDbColumnName(){
			    ...
			    public String ORDER_RELEASE_KEY;

				public String getORDER_RELEASE_KEY () {
					return this.ORDER_RELEASE_KEY;
				}

				public Boolean ORDER_RELEASE_KEYIsNullable(){
				    return true;
				}
				public Boolean ORDER_RELEASE_KEYIsKey(){
				    return false;
				}
				public Integer ORDER_RELEASE_KEYLength(){
				    return null;
				}
				public Integer ORDER_RELEASE_KEYPrecision(){
				    return null;
				}
				public String ORDER_RELEASE_KEYDefault(){
				
					return null;
				
				}
				public String ORDER_RELEASE_KEYComment(){
				
				    return "";
				
				}
				public String ORDER_RELEASE_KEYPattern(){
				
					return "";
				
				}
				public String ORDER_RELEASE_KEYOriginalDbColumnName(){
			    ...
			    public String ORDER_RELEASE_STATUS_KEY;

				public String getORDER_RELEASE_STATUS_KEY () {
					return this.ORDER_RELEASE_STATUS_KEY;
				}

				public Boolean ORDER_RELEASE_STATUS_KEYIsNullable(){
				    return false;
				}
				public Boolean ORDER_RELEASE_STATUS_KEYIsKey(){
				    return false;
				}
				public Integer ORDER_RELEASE_STATUS_KEYLength(){
				    return null;
				}
				public Integer ORDER_RELEASE_STATUS_KEYPrecision(){
				    return null;
				}
				public String ORDER_RELEASE_STATUS_KEYDefault(){
				
					return null;
				
				}
				public String ORDER_RELEASE_STATUS_KEYComment(){
				
				    return "";
				
				}
				public String ORDER_RELEASE_STATUS_KEYPattern(){
				
					return "";
				
				}
				public String ORDER_RELEASE_STATUS_KEYOriginalDbColumnName(){
				
					return "ORDER_RELEASE_STATUS_KEY";
				
				}

				
			    public String SHIPMENT_CONTAINER_KEY;

				public String getSHIPMENT_CONTAINER_KEY () {
					return this.SHIPMENT_CONTAINER_KEY;
				}

				public Boolean SHIPMENT_CONTAINER_KEYIsNullable(){
				    return false;
				}
				public Boolean SHIPMENT_CONTAINER_KEYIsKey(){
				    return false;
				}
				public Integer SHIPMENT_CONTAINER_KEYLength(){
				    return null;
				}
				public Integer SHIPMENT_CONTAINER_KEYPrecision(){
				    return null;
				}
				public String SHIPMENT_CONTAINER_KEYDefault(){
				
					return null;
				
				}
				public String SHIPMENT_CONTAINER_KEYComment(){
				
				    return "";
				
				}
				public String SHIPMENT_CONTAINER_KEYPattern(){
				
					return "";
				
				}
				public String SHIPMENT_CONTAINER_KEYOriginalDbColumnName(){
			    ...
			    public String SHIPMENT_KEY;

				public String getSHIPMENT_KEY () {
					return this.SHIPMENT_KEY;
				}

				public Boolean SHIPMENT_KEYIsNullable(){
				    return false;
				}
				public Boolean SHIPMENT_KEYIsKey(){
				    return false;
				}
				public Integer SHIPMENT_KEYLength(){
				    return null;
				}
				public Integer SHIPMENT_KEYPrecision(){
				    return null;
				}
				public String SHIPMENT_KEYDefault(){
				
					return null;
				
				}
				public String SHIPMENT_KEYComment(){
				
				    return "";
				
				}
				public String SHIPMENT_KEYPattern(){
				
					return "";
				
				}
				public String SHIPMENT_KEYOriginalDbColumnName(){
			    ...
			    public String SHIPMENT_LINE_KEY;

				public String getSHIPMENT_LINE_KEY () {
					return this.SHIPMENT_LINE_KEY;
				}

				public Boolean SHIPMENT_LINE_KEYIsNullable(){
				    return false;
				}
				public Boolean SHIPMENT_LINE_KEYIsKey(){
				    return false;
				}
				public Integer SHIPMENT_LINE_KEYLength(){
				    return null;
				}
				public Integer SHIPMENT_LINE_KEYPrecision(){
				    return null;
				}
				public String SHIPMENT_LINE_KEYDefault(){
				
					return null;
				
				}
				public String SHIPMENT_LINE_KEYComment(){
				
				    return "";
				
				}
				public String SHIPMENT_LINE_KEYPattern(){
				
					return "";
				
				}
				public String SHIPMENT_LINE_KEYOriginalDbColumnName(){
			    ...
			    public BigDecimal QUANTITY_PLACED;

				public BigDecimal getQUANTITY_PLACED () {
					return this.QUANTITY_PLACED;
				}

				public Boolean QUANTITY_PLACEDIsNullable(){
				    return false;
				}
				public Boolean QUANTITY_PLACEDIsKey(){
				    return false;
				}
				public Integer QUANTITY_PLACEDLength(){
				    return null;
				}
				public Integer QUANTITY_PLACEDPrecision(){
				    return null;
				}
				public String QUANTITY_PLACEDDefault(){
				
					return "";
				
				}
				public String QUANTITY_PLACEDComment(){
				
				    return "";
				
				}
				public String QUANTITY_PLACEDPattern(){
				
					return "";
				
				}
				public String QUANTITY_PLACEDOriginalDbColumnName(){
			    ...
			    public String ORIG_ORDER_LINE_SCHEDULE_KEY;

				public String getORIG_ORDER_LINE_SCHEDULE_KEY () {
					return this.ORIG_ORDER_LINE_SCHEDULE_KEY;
				}

				public Boolean ORIG_ORDER_LINE_SCHEDULE_KEYIsNullable(){
				    return false;
				}
				public Boolean ORIG_ORDER_LINE_SCHEDULE_KEYIsKey(){
				    return false;
				}
				public Integer ORIG_ORDER_LINE_SCHEDULE_KEYLength(){
				    return null;
				}
				public Integer ORIG_ORDER_LINE_SCHEDULE_KEYPrecision(){
				    return null;
				}
				public String ORIG_ORDER_LINE_SCHEDULE_KEYDefault(){
				
					return null;
				
				}
				public String ORIG_ORDER_LINE_SCHEDULE_KEYComment(){
				
				    return "";
				
				}
				public String ORIG_ORDER_LINE_SCHEDULE_KEYPattern(){
				
					return "";
				
				}
				public String ORIG_ORDER_LINE_SCHEDULE_KEYOriginalDbColumnName(){
				
					return "ORIG_ORDER_LINE_SCHEDULE_KEY";
				
				}

				
			    public BigDecimal FIFO_NO;

				public BigDecimal getFIFO_NO () {
					return this.FIFO_NO;
				}

				public Boolean FIFO_NOIsNullable(){
				    return false;
				}
				public Boolean FIFO_NOIsKey(){
				    return false;
				}
				public Integer FIFO_NOLength(){
				    return null;
				}
				public Integer FIFO_NOPrecision(){
				    return null;
				}
				public String FIFO_NODefault(){
				
					return "";
				
				}
				public String FIFO_NOComment(){
				
				    return "";
				
				}
				public String FIFO_NOPattern(){
				
					return "";
				
				}
				public String FIFO_NOOriginalDbColumnName(){
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AT_TALEND_JOBS_YFS_CONTAINER_DETAILS_H.length) {
				if(length < 1024 && commonByteArray_AT_TALEND_JOBS_YFS_CONTAINER_DETAILS_H.length == 0) {
   					commonByteArray_AT_TALEND_JOBS_YFS_CONTAINER_DETAILS_H = new byte[1024];
				} else {
   					commonByteArray_AT_TALEND_JOBS_YFS_CONTAINER_DETAILS_H = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AT_TALEND_JOBS_YFS_CONTAINER_DETAILS_H, 0, length);
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_YFS_CONTAINER_DETAILS_H, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AT_TALEND_JOBS_YFS_CONTAINER_DETAILS_H, 0, length);
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_YFS_CONTAINER_DETAILS_H, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AT_TALEND_JOBS_YFS_CONTAINER_DETAILS_H) {

        	try {

        		int length = 0;
		
					this.CONTAINER_DETAILS_KEY = readString(dis);
					
					this.ORDER_RELEASE_KEY = readString(dis);
					
					this.ORDER_RELEASE_STATUS_KEY = readString(dis);
					
					this.SHIPMENT_CONTAINER_KEY = readString(dis);
					
					this.ORDER_LINE_KEY = readString(dis);
					
					this.ORDER_HEADER_KEY = readString(dis);
					
					this.SHIPMENT_KEY = readString(dis);
					
					this.SHIPMENT_LINE_KEY = readString(dis);
					...
					this.PRODUCT_CLASS = readString(dis);
						...
						this.QUANTITY_PLACED = (BigDecimal) dis.readObject();
					
					this.ENTERPRISE_KEY = readString(dis);
					
					this.ORIG_ORDER_LINE_SCHEDULE_KEY = readString(dis);
					
						this.FIFO_NO = (BigDecimal) dis.readObject();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.CONTAINER_DETAILS_KEY,dos);
					
					// String
				
						writeString(this.ORDER_RELEASE_KEY,dos);
					
					// String
				
						writeString(this.ORDER_RELEASE_STATUS_KEY,dos);
					
					// String
				
						writeString(this.SHIPMENT_CONTAINER_KEY,dos);
					...
					// String
						...
						writeString(this.SHIPMENT_KEY,dos);
					
					// String
				
						writeString(this.SHIPMENT_LINE_KEY,dos);
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.QUANTITY_PLACED);
					...
					// String
						...
						writeString(this.ORIG_ORDER_LINE_SCHEDULE_KEY,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FIFO_NO);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("CONTAINER_DETAILS_KEY="+CONTAINER_DETAILS_KEY);
		sb.append(",ORDER_RELEASE_KEY="+ORDER_RELEASE_KEY);
		sb.append(",ORDER_RELEASE_STATUS_KEY="+ORDER_RELEASE_STATUS_KEY);
		sb.append(",SHIPMENT_CONTAINER_KEY="+SHIPMENT_CONTAINER_KEY);
		sb.append(",ORDER_LINE_KEY="+ORDER_LINE_KEY);
		sb.append(",ORDER_HEADER_KEY="+ORDER_HEADER_KEY);
		sb.append(",SHIPMENT_KEY="+SHIPMENT_KEY);
		sb.append(",SHIPMENT_LINE_KEY="+SHIPMENT_LINE_KEY);
		...
		sb.append(",QUANTITY_PLACED="+String.valueOf(QUANTITY_PLACED));
		sb.append(",ENTERPRISE_KEY="+ENTERPRISE_KEY);
		sb.append(",ORIG_ORDER_LINE_SCHEDULE_KEY="+ORIG_ORDER_LINE_SCHEDULE_KEY);
		sb.append(",FIFO_NO="+String.valueOf(FIFO_NO));
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        				...
        				if(CONTAINER_DETAILS_KEY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(CONTAINER_DETAILS_KEY);
            			}
            		
        			sb.append("|");
        		
        				if(ORDER_RELEASE_KEY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORDER_RELEASE_KEY);
            			}
            		
        			sb.append("|");
        		
        				if(ORDER_RELEASE_STATUS_KEY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORDER_RELEASE_STATUS_KEY);
            			}
            		
        			sb.append("|");
        		
        				if(SHIPMENT_CONTAINER_KEY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SHIPMENT_CONTAINER_KEY);
            			}
        			...
        			sb.append("|");
        				...
        				if(SHIPMENT_KEY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SHIPMENT_KEY);
            			}
            		
        			sb.append("|");
        		
        				if(SHIPMENT_LINE_KEY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SHIPMENT_LINE_KEY);
            			}
        			...
        			sb.append("|");
        				...
        				if(QUANTITY_PLACED == null){
        					sb.append("<null>");
        				}else{
            				sb.append(QUANTITY_PLACED);
            			}
        			...
        			sb.append("|");
        				...
        				if(ORIG_ORDER_LINE_SCHEDULE_KEY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORIG_ORDER_LINE_SCHEDULE_KEY);
            			}
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_1_2_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"CONTAINER_DETAILS_KEY\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CONTAINER_DETAILS_KEY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"CONTAINER_DETAILS_KEY\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CONTAINER_DETAILS_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ORDER_RELEASE_KEY\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ORDER_RELEASE_KEY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"ORDER_RELEASE_KEY\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ORDER_RELEASE_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ORDER_RELEASE_STATUS_KEY\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ORDER_RELEASE_STATUS_KEY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"ORDER_RELEASE_STATUS_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ORDER_RELEASE_STATUS_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"SHIPMENT_CONTAINER_KEY\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"SHIPMENT_CONTAINER_KEY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"SHIPMENT_CONTAINER_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"SHIPMENT_CONTAINER_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ORDER_LINE_KEY\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ORDER_LINE_KEY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"ORDER_LINE_KEY\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ORDER_LINE_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ORDER_HEADER_KEY\",\"type\":[\"string\",\"null\"],\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ORDER_HEADER_KEY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"ORDER_HEADER_KEY\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ORDER_HEADER_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"SHIPMENT_KEY\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"SHIPMENT_KEY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"SHIPMENT_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"SHIPMENT_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"SHIPMENT_LINE_KEY\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"SHIPMENT_LINE_KEY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"SHIPMENT_LINE_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"SHIPMENT_LINE_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"QUANTITY\",\"type\":{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"QUANTITY\",\"talend.field.dbColumnName\":\"QUANTITY\",\"di.column.talendType\":\"id_BigDecimal\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"QUANTITY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"QUANTITY_PLACED\",\"type\":{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"QUANTITY_PLACED\",\"talend.field.dbColumnName\":\"QUANTITY_PLACED\",\"di.column.talendType\":\"id_BigDecimal\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"QUANTITY_PLACED\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"ORIG_ORDER_LINE_SCHEDULE_KEY\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ORIG_ORDER_LINE_SCHEDULE_KEY\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"ORIG_ORDER_LINE_SCHEDULE_KEY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ORIG_ORDER_LINE_SCHEDULE_KEY\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"FIFO_NO\",\"type\":{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"},\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"FIFO_NO\",\"talend.field.dbColumnName\":\"FIFO_NO\",\"di.column.talendType\":\"id_BigDecimal\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"FIFO_NO\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"MODIFYPROGID\",\"type\":\"string\",\"default\":\"\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"MODIFYPROGID\",\"talend.field.default\":\"\",\"talend.field.dbColumnName\":\"MODIFYPROGID\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"MODIFYPROGID\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tDBOutput_1\",\"di.table.label\":\"tDBOutput_1\"}",s);
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"  select * from STERLING.YFS_CONTAINER_DETAILS_H where TO_CHAR(MODIFYTS, 'YYYY-MM-DD HH:MI:SS') >= TO_CHAR((sysdate - 7), 'YYYY-MM-DD HH:MI:SS')    \"");
                        log4jParamters_tDBInput_1.append(" | ");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("CONTAINER_DETAILS_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ORDER_RELEASE_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ORDER_RELEASE_STATUS_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("SHIPMENT_CONTAINER_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ORDER_LINE_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ORDER_HEADER_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("SHIPMENT_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("SHIPMENT_LINE_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("COUNTRY_OF_ORIGIN")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ITEM_ID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("UOM")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("PRODUCT_CLASS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("QUANTITY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("QUANTITY_PLACED")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ENTERPRISE_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ORIG_ORDER_LINE_SCHEDULE_KEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("FIFO_NO")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LOCKID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATETS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYTS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATEUSERID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYUSERID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CREATEPROGID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MODIFYPROGID")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
		    ...
		    String dbquery_tDBInput_1 = "\nselect * from STERLING.YFS_CONTAINER_DETAILS_H where TO_CHAR(MODIFYTS, 'YYYY-MM-DD HH:MI:SS') >= TO_CHAR((sysdate - 7"
+"), 'YYYY-MM-DD HH:MI:SS')\n\n";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row1.CONTAINER_DETAILS_KEY = null;
							} else {
	                         		
        	row1.CONTAINER_DETAILS_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.ORDER_RELEASE_KEY = null;
							} else {
	                         		
        	row1.ORDER_RELEASE_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.ORDER_RELEASE_STATUS_KEY = null;
							} else {
	                         		
        	row1.ORDER_RELEASE_STATUS_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.SHIPMENT_CONTAINER_KEY = null;
							} else {
	                         		
        	row1.SHIPMENT_CONTAINER_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
        	...
        	row1.ORDER_HEADER_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.SHIPMENT_KEY = null;
							} else {
	                         		
        	row1.SHIPMENT_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.SHIPMENT_LINE_KEY = null;
							} else {
	                         		
        	row1.SHIPMENT_LINE_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.COUNTRY_OF_ORIGIN = null;
							} else {
	                         		
        	row1.COUNTRY_OF_ORIGIN = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.ITEM_ID = null;
							} else {
	                         		
        	row1.ITEM_ID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.UOM = null;
							} else {
	                         		
        	row1.UOM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 12) {
								row1.PRODUCT_CLASS = null;
							} else {
	                         		
        	row1.PRODUCT_CLASS = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, false);
		                    }
					...
					if(rs_tDBInput_1.getObject(13) != null) {
						row1.QUANTITY = rs_tDBInput_1.getBigDecimal(13);
					} else {
 	                	...
 	                	throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tDBInput_1 < 14) {
								row1.QUANTITY_PLACED = null;
							} else {
		                          
					if(rs_tDBInput_1.getObject(14) != null) {
						row1.QUANTITY_PLACED = rs_tDBInput_1.getBigDecimal(14);
					} else {
        	...
        	row1.ENTERPRISE_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 15, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 16) {
								row1.ORIG_ORDER_LINE_SCHEDULE_KEY = null;
							} else {
	                         		
        	row1.ORIG_ORDER_LINE_SCHEDULE_KEY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 16, false);
		                    }
					...
					if(rs_tDBInput_1.getObject(17) != null) {
						row1.FIFO_NO = rs_tDBInput_1.getBigDecimal(17);
					} else {
					...
					if(rs_tDBInput_1.getObject(18) != null) {
						row1.LOCKID = rs_tDBInput_1.getBigDecimal(18);
					} else {
			...
			row1.CREATETS = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 19);
		                    }
							if(colQtyInRs_tDBInput_1 < 20) {
								row1.MODIFYTS = null;
							} else {
										
			row1.MODIFYTS = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 20);
		                    }
							if(colQtyInRs_tDBInput_1 < 21) {
								row1.CREATEUSERID = null;
							} else {
	                         		
        	row1.CREATEUSERID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 21, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 22) {
								row1.MODIFYUSERID = null;
							} else {
	                         		
        	row1.MODIFYUSERID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 22, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 23) {
								row1.CREATEPROGID = null;
							} else {
	                         		
        	row1.CREATEPROGID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 23, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 24) {
								row1.MODIFYPROGID = null;
							} else {
	                         		
        	row1.MODIFYPROGID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 24, false);
		                    }
	...
	currentComponent="tDBOutput_1";
        ...
        if (incomingEnforcer_tDBOutput_1 != null) {
            incomingEnforcer_tDBOutput_1.createNewRecord();
                ...
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CONTAINER_DETAILS_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("CONTAINER_DETAILS_KEY", row1.CONTAINER_DETAILS_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("ORDER_RELEASE_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("ORDER_RELEASE_KEY", row1.ORDER_RELEASE_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("ORDER_RELEASE_STATUS_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("ORDER_RELEASE_STATUS_KEY", row1.ORDER_RELEASE_STATUS_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("SHIPMENT_CONTAINER_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("SHIPMENT_CONTAINER_KEY", row1.SHIPMENT_CONTAINER_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("SHIPMENT_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("SHIPMENT_KEY", row1.SHIPMENT_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("SHIPMENT_LINE_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("SHIPMENT_LINE_KEY", row1.SHIPMENT_LINE_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("QUANTITY") != null){
                    incomingEnforcer_tDBOutput_1.put("QUANTITY", row1.QUANTITY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("QUANTITY_PLACED") != null){
                    incomingEnforcer_tDBOutput_1.put("QUANTITY_PLACED", row1.QUANTITY_PLACED);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("ORIG_ORDER_LINE_SCHEDULE_KEY") != null){
                    incomingEnforcer_tDBOutput_1.put("ORIG_ORDER_LINE_SCHEDULE_KEY", row1.ORIG_ORDER_LINE_SCHEDULE_KEY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("FIFO_NO") != null){
                    incomingEnforcer_tDBOutput_1.put("FIFO_NO", row1.FIFO_NO);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
 ...
 */
    ...
    public static void main(String[] args){
        final YFS_CONTAINER_DETAILS_H YFS_CONTAINER_DETAILS_HClass = new YFS_CONTAINER_DETAILS_H();

        int exitCode = YFS_CONTAINER_DETAILS_HClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'YFS_CONTAINER_DETAILS_H' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'YFS_CONTAINER_DETAILS_H' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_1yJbQOv1Eeui_7U8UwU2ug");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-06-18T03:10:12.745866800Z");
        ...
        try {
            ...
            java.io.InputStream inContext = YFS_CONTAINER_DETAILS_H.class.getClassLoader().getResourceAsStream("at_talend_jobs/yfs_container_details_h_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = YFS_CONTAINER_DETAILS_H.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'YFS_CONTAINER_DETAILS_H' - Started.");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : YFS_CONTAINER_DETAILS_H");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'YFS_CONTAINER_DETAILS_H' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     209241 characters generated by Talend Cloud Data Management Platform 
 *     on the June 17, 2023 at 11:10:12 PM EDT
 ************************************************************************************************/