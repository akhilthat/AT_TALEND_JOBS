...
public class INVENTORY_BALANCE_DATA_INVCBL implements TalendJob {
	static {System.setProperty("TalendJob.log", "INVENTORY_BALANCE_DATA_INVCBL.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(INVENTORY_BALANCE_DATA_INVCBL.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_gBb_INm5EeuE0KkKg4NQQA", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(INVENTORY_BALANCE_DATA_INVCBL.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row14Struct implements routines.system.IPersistableRow<row14Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			strReturn = new String(commonByteArray_AT_TALEND_JOBS_INVENTORY_BALANCE_DATA_INVCBL, 0, length, utf8Charset);
		}
		return strReturn;
	}
                ...
                class BytesLimit65535_tFileOutputDelimited_1{
                    ...
                    log4jParamters_tFileOutputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
                            log4jParamters_tFileOutputDelimited_1.append("FILENAME" + " = " + "\"/data/talend/data_repository/INVCBL.csv\"");
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("/data/talend/data_repository/INVCBL.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row14","tDBInput_1","tDBInput_1","tAS400Input","tFileOutputDelimited_1","tFileOutputDelimited_1","tFileOutputDelimited"
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                            log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "\"/data/talend/data_repository/INVCBL.zip\"");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("TRIMSELECT" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("INUMBR")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBHBOY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBHBOP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBHAND")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBTRNS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBGMRI")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBWKCR")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBWK01")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBWK02")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBWK03")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBWK04")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBWK05")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBWK06")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBWK07")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBWK08")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBRSUP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBRSUY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBRSDP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBRSDY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBVRSP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBVRSY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBRCSP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBRCSY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBASUP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBASUY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBASDP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBASDY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBVASP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBVASY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBACSP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBACSY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBRETS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBRCUP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBRCUY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBRCDP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBRCDY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBTIUP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBTIUY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBTOUP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBTOUY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBTFDP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBTFDY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBRVUP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBRVUY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBRVDP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBRVDY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBAJUP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBAJUY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBAJDP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBAJDY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBPHUP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBPHUY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBPHDP")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBPHDY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBAVGC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBAVOH")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBAVRT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBAVCS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBDEPT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBSDPT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBCLAS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBSCLS")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBVNDR")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBSTYL")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBPOOQ")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBTOOQ")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBINTQ")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBMASU")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBMASD")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBMASV")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBMASC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBLAVC")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBARQT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBNSQT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CBHLDQ")+"}]");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"INUMBR", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBHBOY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBHBOP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBHAND", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBTRNS", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBGMRI", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBWKCR", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBWK01", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBWK02", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBWK03", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBWK04", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBWK05", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBWK06", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBWK07", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBWK08", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBRSUP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBRSUY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBRSDP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBRSDY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBVRSP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBVRSY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBRCSP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBRCSY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBASUP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBASUY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBASDP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBASDY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBVASP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBVASY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBACSP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBACSY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBRETS", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBRCUP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBRCUY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBRCDP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBRCDY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBTIUP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBTIUY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBTOUP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBTOUY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBTFDP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBTFDY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBRVUP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBRVUY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBRVDP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBRVDY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBAJUP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBAJUY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBAJDP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBAJDY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBPHUP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBPHUY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBPHDP", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBPHDY", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBAVGC", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBAVOH", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBAVRT", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBAVCS", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBDEPT", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBSDPT", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBCLAS", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBSCLS", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBVNDR", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBPOOQ", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBTOOQ", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBINTQ", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBMASU", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBMASD", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBMASV", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBMASC", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBLAVC", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBARQT", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBNSQT", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CBHLDQ", "row9", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
log.debug("tMap_1 - Outputting the record " + count_tmap_INVCBL_tMap_1 + " of the output table 'tmap_INVCBL'.");
...
if(tmap_INVCBL != null) { 
	...
	currentComponent="tDBOutput_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"tmap_INVCBL","tMap_1","tMap_1","tMap","tDBOutput_1","tDBOutput_1","tSnowflakeOutput"
        ...
        if (incomingEnforcer_tDBOutput_1 != null) {
            incomingEnforcer_tDBOutput_1.createNewRecord();
                ...
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBHBOY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBHBOY", tmap_INVCBL.CBHBOY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBHBOP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBHBOP", tmap_INVCBL.CBHBOP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBHAND") != null){
                    incomingEnforcer_tDBOutput_1.put("CBHAND", tmap_INVCBL.CBHAND);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBTRNS") != null){
                    incomingEnforcer_tDBOutput_1.put("CBTRNS", tmap_INVCBL.CBTRNS);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBGMRI") != null){
                    incomingEnforcer_tDBOutput_1.put("CBGMRI", tmap_INVCBL.CBGMRI);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBWKCR") != null){
                    incomingEnforcer_tDBOutput_1.put("CBWKCR", tmap_INVCBL.CBWKCR);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBWK01") != null){
                    incomingEnforcer_tDBOutput_1.put("CBWK01", tmap_INVCBL.CBWK01);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBWK02") != null){
                    incomingEnforcer_tDBOutput_1.put("CBWK02", tmap_INVCBL.CBWK02);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBWK03") != null){
                    incomingEnforcer_tDBOutput_1.put("CBWK03", tmap_INVCBL.CBWK03);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBWK04") != null){
                    incomingEnforcer_tDBOutput_1.put("CBWK04", tmap_INVCBL.CBWK04);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBWK05") != null){
                    incomingEnforcer_tDBOutput_1.put("CBWK05", tmap_INVCBL.CBWK05);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBWK06") != null){
                    incomingEnforcer_tDBOutput_1.put("CBWK06", tmap_INVCBL.CBWK06);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBWK07") != null){
                    incomingEnforcer_tDBOutput_1.put("CBWK07", tmap_INVCBL.CBWK07);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBWK08") != null){
                    incomingEnforcer_tDBOutput_1.put("CBWK08", tmap_INVCBL.CBWK08);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBRSUP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBRSUP", tmap_INVCBL.CBRSUP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBRSUY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBRSUY", tmap_INVCBL.CBRSUY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBRSDP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBRSDP", tmap_INVCBL.CBRSDP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBRSDY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBRSDY", tmap_INVCBL.CBRSDY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBVRSP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBVRSP", tmap_INVCBL.CBVRSP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBVRSY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBVRSY", tmap_INVCBL.CBVRSY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBRCSP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBRCSP", tmap_INVCBL.CBRCSP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBRCSY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBRCSY", tmap_INVCBL.CBRCSY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBASUP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBASUP", tmap_INVCBL.CBASUP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBASUY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBASUY", tmap_INVCBL.CBASUY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBASDP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBASDP", tmap_INVCBL.CBASDP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBASDY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBASDY", tmap_INVCBL.CBASDY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBVASP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBVASP", tmap_INVCBL.CBVASP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBVASY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBVASY", tmap_INVCBL.CBVASY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBACSP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBACSP", tmap_INVCBL.CBACSP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBACSY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBACSY", tmap_INVCBL.CBACSY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBRETS") != null){
                    incomingEnforcer_tDBOutput_1.put("CBRETS", tmap_INVCBL.CBRETS);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBRCUP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBRCUP", tmap_INVCBL.CBRCUP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBRCUY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBRCUY", tmap_INVCBL.CBRCUY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBRCDP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBRCDP", tmap_INVCBL.CBRCDP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBRCDY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBRCDY", tmap_INVCBL.CBRCDY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBTIUP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBTIUP", tmap_INVCBL.CBTIUP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBTIUY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBTIUY", tmap_INVCBL.CBTIUY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBTOUP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBTOUP", tmap_INVCBL.CBTOUP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBTOUY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBTOUY", tmap_INVCBL.CBTOUY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBTFDP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBTFDP", tmap_INVCBL.CBTFDP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBTFDY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBTFDY", tmap_INVCBL.CBTFDY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBRVUP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBRVUP", tmap_INVCBL.CBRVUP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBRVUY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBRVUY", tmap_INVCBL.CBRVUY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBRVDP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBRVDP", tmap_INVCBL.CBRVDP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBRVDY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBRVDY", tmap_INVCBL.CBRVDY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBAJUP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBAJUP", tmap_INVCBL.CBAJUP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBAJUY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBAJUY", tmap_INVCBL.CBAJUY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBAJDP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBAJDP", tmap_INVCBL.CBAJDP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBAJDY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBAJDY", tmap_INVCBL.CBAJDY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBPHUP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBPHUP", tmap_INVCBL.CBPHUP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBPHUY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBPHUY", tmap_INVCBL.CBPHUY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBPHDP") != null){
                    incomingEnforcer_tDBOutput_1.put("CBPHDP", tmap_INVCBL.CBPHDP);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBPHDY") != null){
                    incomingEnforcer_tDBOutput_1.put("CBPHDY", tmap_INVCBL.CBPHDY);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBAVGC") != null){
                    incomingEnforcer_tDBOutput_1.put("CBAVGC", tmap_INVCBL.CBAVGC);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBAVOH") != null){
                    incomingEnforcer_tDBOutput_1.put("CBAVOH", tmap_INVCBL.CBAVOH);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBAVRT") != null){
                    incomingEnforcer_tDBOutput_1.put("CBAVRT", tmap_INVCBL.CBAVRT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBAVCS") != null){
                    incomingEnforcer_tDBOutput_1.put("CBAVCS", tmap_INVCBL.CBAVCS);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBDEPT") != null){
                    incomingEnforcer_tDBOutput_1.put("CBDEPT", tmap_INVCBL.CBDEPT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBSDPT") != null){
                    incomingEnforcer_tDBOutput_1.put("CBSDPT", tmap_INVCBL.CBSDPT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBCLAS") != null){
                    incomingEnforcer_tDBOutput_1.put("CBCLAS", tmap_INVCBL.CBCLAS);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBSCLS") != null){
                    incomingEnforcer_tDBOutput_1.put("CBSCLS", tmap_INVCBL.CBSCLS);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBVNDR") != null){
                    incomingEnforcer_tDBOutput_1.put("CBVNDR", tmap_INVCBL.CBVNDR);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBSTYL") != null){
                    incomingEnforcer_tDBOutput_1.put("CBSTYL", tmap_INVCBL.CBSTYL);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBPOOQ") != null){
                    incomingEnforcer_tDBOutput_1.put("CBPOOQ", tmap_INVCBL.CBPOOQ);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBTOOQ") != null){
                    incomingEnforcer_tDBOutput_1.put("CBTOOQ", tmap_INVCBL.CBTOOQ);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBINTQ") != null){
                    incomingEnforcer_tDBOutput_1.put("CBINTQ", tmap_INVCBL.CBINTQ);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBMASU") != null){
                    incomingEnforcer_tDBOutput_1.put("CBMASU", tmap_INVCBL.CBMASU);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBMASD") != null){
                    incomingEnforcer_tDBOutput_1.put("CBMASD", tmap_INVCBL.CBMASD);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBMASV") != null){
                    incomingEnforcer_tDBOutput_1.put("CBMASV", tmap_INVCBL.CBMASV);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBMASC") != null){
                    incomingEnforcer_tDBOutput_1.put("CBMASC", tmap_INVCBL.CBMASC);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBLAVC") != null){
                    incomingEnforcer_tDBOutput_1.put("CBLAVC", tmap_INVCBL.CBLAVC);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBARQT") != null){
                    incomingEnforcer_tDBOutput_1.put("CBARQT", tmap_INVCBL.CBARQT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBNSQT") != null){
                    incomingEnforcer_tDBOutput_1.put("CBNSQT", tmap_INVCBL.CBNSQT);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CBHLDQ") != null){
...
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'tmap_INVCBL': " + count_tmap_INVCBL_tMap_1 + ".");
...
if(row12 != null) { 
    ...
    System.out.println("table PROD_DATA.INVENTORY.INVENTORY_BALANCE_DATA_INVCBL status: "+ row12.X_DASH_DET); 
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileDelete_2{
                    ...
                    log4jParamters_tFileDelete_2.append("Parameters:");
                            log4jParamters_tFileDelete_2.append("PATH" + " = " + "\"/data/talend/data_repository/INVCBL.zip\"");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tSendMail_2{
                    ...
                    log4jParamters_tSendMail_2.append("Parameters:");
                        ...
                        log4jParamters_tSendMail_2.append(" | ");
                            log4jParamters_tSendMail_2.append("MESSAGE" + " = " + "jobName + \"  Failed!!!, this email is triggered from INVENTORY_BALANCE_DATA_INVCBL Subjob because its missing data \" ");
                        log4jParamters_tSendMail_2.append(" | ");
 ...
 */
	...
	String message_tSendMail_2 = ((jobName + "  Failed!!!, this email is triggered from INVENTORY_BALANCE_DATA_INVCBL Subjob because its missing data " ) == null || "".equals(jobName + "  Failed!!!, this email is triggered from INVENTORY_BALANCE_DATA_INVCBL Subjob because its missing data " )) ? "\"\"" : (jobName + "  Failed!!!, this email is triggered from INVENTORY_BALANCE_DATA_INVCBL Subjob because its missing data " ) ;
...
org.talend.components.snowflake.SnowflakeConnectionProperties props_tDBConnection_1 =
        (org.talend.components.snowflake.SnowflakeConnectionProperties) def_tDBConnection_1.createRuntimeProperties();
 		                    ...
 		                    "Talend_user");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:oR/8APO8EwJvHdYfOFlu4wPCvgSO4cuy9awkSwd22o/4rsOY"));
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:b6Ebc8iW9eiG/Cmpmm/TX8JHB8IR7LxTqKZSM019AfXWbg==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:QDynYDROUBINqluBNW5lMp3hyfWZNYvwDWzKs8FWI9aQ/A==");
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'INVENTORY_BALANCE_DATA_INVCBL' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-06-30T12:58:04.309754200Z");
        ...
        try {
            ...
            java.io.InputStream inContext = INVENTORY_BALANCE_DATA_INVCBL.class.getClassLoader().getResourceAsStream("at_talend_jobs/inventory_balance_data_invcbl_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = INVENTORY_BALANCE_DATA_INVCBL.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : INVENTORY_BALANCE_DATA_INVCBL");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'INVENTORY_BALANCE_DATA_INVCBL' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     791412 characters generated by Talend Cloud Data Management Platform 
 *     on the June 30, 2023 at 8:58:04 AM EDT
 ************************************************************************************************/