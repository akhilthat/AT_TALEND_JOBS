...
public class DROP_SHIP_REVENUE implements TalendJob {
	static {System.setProperty("TalendJob.log", "DROP_SHIP_REVENUE.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(DROP_SHIP_REVENUE.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_UNxWgArAEe6WaNrWmUUUzw", "0.1");
...
org.talend.components.snowflake.SnowflakeConnectionProperties props_tDBConnection_2 =
        (org.talend.components.snowflake.SnowflakeConnectionProperties) def_tDBConnection_2.createRuntimeProperties();
 		                    ...
 		                    "Talend_user");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:pdZiTTVgpFxvX0T/BgI7L9XoVvnxyvdvgCqaxv2rSWq1hNrC"));
...
org.talend.components.snowflake.SnowflakeConnectionProperties props_tDBConnection_3 =
        (org.talend.components.snowflake.SnowflakeConnectionProperties) def_tDBConnection_3.createRuntimeProperties();
 		                    ...
 		                    "Talend_user");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:4X2u6hgqEq8zuQmJ3KVsHP+MqyDD5EeXXkv7S3msCmJurrJ8"));
...
org.talend.components.snowflake.tsnowflakeinput.TSnowflakeInputProperties props_tDBInput_2 =
        (org.talend.components.snowflake.tsnowflakeinput.TSnowflakeInputProperties) def_tDBInput_2.createRuntimeProperties();
 		                    ...
 		                    "select max(transaction_date) from DROP_SHIP_REVENUE");
 		                    ...
 		                    class SchemaSettingTool_tDBInput_2_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"Transaction_date\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"Transaction_date\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Transaction_date\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"MAIN\",\"di.table.label\":\"MAIN\"}",s);
 ...
 */
	...
	currentComponent="tJavaRow_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tDBInput_2","DROP_SHIP_REVENUE","tSnowflakeInput","tJavaRow_1","tJavaRow_1","tJavaRow"
...
globalMap.put("tJavaRow_1_NB_LINE",nb_line_tJavaRow_1);
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tDBInput_2","DROP_SHIP_REVENUE","tSnowflakeInput","tJavaRow_1","tJavaRow_1","tJavaRow","output")) {
						talendJobLogProcess(globalMap);
					}
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'DROP_SHIP_REVENUE' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-06-14T15:37:20.526484Z");
        ...
        try {
            ...
            java.io.InputStream inContext = DROP_SHIP_REVENUE.class.getClassLoader().getResourceAsStream("at_talend_jobs/drop_ship_revenue_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = DROP_SHIP_REVENUE.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : DROP_SHIP_REVENUE");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     139966 characters generated by Talend Cloud Data Management Platform 
 *     on the June 14, 2023 at 11:37:20 AM EDT
 ************************************************************************************************/