			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_2.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:Cl8kX47oFeHsBp41dtbCF9jUJ53/CFQskfha2J3TFmFS1gMs"));
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_3.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:7Anu98caW+8oVLpJfLK4PYYe5U8FHKXUCPfXkaCoC33pMrfv"));
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBRow_1.setValue("query",
						"INSERT INTO  MSTR_DB.DASHBOARD.DROP_SHIP_REVENUE ( TRANSACTION_DATE, STORE_NO, SKU_ID, SALES, UNITS , COST,SCANS)\nSELE"
								+ "CT TRANSACTION_DATE, STORE_NO, SKU_ID,Basket_spend, Items, COST,SCANS from PROD_DATA.INVENTORY.MARGIN_TRANSACTION where "
...
// finally of generic
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-06-14T15:19:01.254218Z");
...
/************************************************************************************************
 * 139966 characters generated by Talend Cloud Data Management Platform on the
 * June 14, 2023 at 11:19:01 AM EDT
 ************************************************************************************************/