			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (sourceOrSink_tDBInput_2 instanceof org.talend.components.api.component.runtime.Source) {
					...
					for (; available_tDBInput_2; available_tDBInput_2 = reader_tDBInput_2.advance()) {
						...
						System.out.println(context.Transaction_date);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:2w0TEVxX7i8dlPpuU69lb664RDQStM376qgXos1Z2rUaFMBUlK0=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:LfcucIO4lRHp0P95KeMrF/spIFkbsIszWh/Cugx4FbPwmE5QVvc=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_2.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:sU7LTB8fDmVJHQfki28LYmXnW5v6GtiLxGcQ5MxlcJj9SGlC"));
	...
	public void tDBConnection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBConnection_3", "SF_MSTR_PROD", "tSnowflakeConnection");
					talendJobLogProcess(globalMap);
				}
				...
				props_tDBConnection_3.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:PTHYI56WzZwNaqell2FPG5hXAFbmkjyWfzoW3BXrcLyQakpI"));
...
// finally of generic
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-06-14T14:46:31.073644900Z");
...
/************************************************************************************************
 * 129266 characters generated by Talend Cloud Data Management Platform on the
 * June 14, 2023 at 10:46:31 AM EDT
 ************************************************************************************************/