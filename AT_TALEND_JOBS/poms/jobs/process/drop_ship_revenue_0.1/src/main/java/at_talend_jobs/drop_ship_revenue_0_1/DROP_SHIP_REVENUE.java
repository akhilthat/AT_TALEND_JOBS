			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (sourceOrSink_tDBInput_2 instanceof org.talend.components.api.component.runtime.Source) {
					...
					for (; available_tDBInput_2; available_tDBInput_2 = reader_tDBInput_2.advance()) {
						...
						System.out.println(
								"Query: SELECT TRANSACTION_DATE, STORE_NO, SKU_ID,Basket_spend, Items, COST,SCANS from MARGIN_TRANSACTION where store_no=6103 and transaction_date > '"
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_2.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:po89UPfv1X6dTDpEzNMUDjrSPsuODcnhN/mteazTD/o46Wb0"));
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_3.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:8fFY+gdvnU4TdSixGORrsPjtywORdvUMqK9zwqZV5Otevp4I"));
...
// finally of generic
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-06-14T14:58:43.732665300Z");
...
/************************************************************************************************
 * 123497 characters generated by Talend Cloud Data Management Platform on the
 * June 14, 2023 at 10:58:43 AM EDT
 ************************************************************************************************/