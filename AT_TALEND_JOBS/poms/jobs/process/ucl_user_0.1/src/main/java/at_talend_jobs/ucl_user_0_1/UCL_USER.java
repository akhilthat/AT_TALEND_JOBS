				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_1", "tDBInput_1", "tOracleInput", "tDBOutput_1",
								"INVENTORY.UCL_USER", "tSnowflakeOutput"
...
// end of generic
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_1", "tDBInput_1", "tOracleInput", "tDBOutput_1", "INVENTORY.UCL_USER",
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBOutput_2.setValue("dieOnError", true);
				...
				props_tDBOutput_2.table.setValue("tableName", "UCL_USER");
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_2", "tDBInput_2", "tOracleInput", "tDBOutput_2",
								"INVENTORY.UCL_USER", "tSnowflakeOutput"
						...
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("UCL_USER_ID") != null) {
							incomingEnforcer_tDBOutput_2.put("UCL_USER_ID", row2.UCL_USER_ID);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("COMPANY_ID") != null) {
							incomingEnforcer_tDBOutput_2.put("COMPANY_ID", row2.COMPANY_ID);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("USER_NAME") != null) {
							incomingEnforcer_tDBOutput_2.put("USER_NAME", row2.USER_NAME);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("USER_PASSWORD") != null) {
							incomingEnforcer_tDBOutput_2.put("USER_PASSWORD", row2.USER_PASSWORD);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("IS_ACTIVE") != null) {
						...
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("CREATED_SOURCE") != null) {
							incomingEnforcer_tDBOutput_2.put("CREATED_SOURCE", row2.CREATED_SOURCE);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("CREATED_DTTM") != null) {
						...
						if (incomingEnforcer_tDBOutput_2 != null && incomingEnforcer_tDBOutput_2.getRuntimeSchema()
								.getField("LAST_UPDATED_SOURCE_TYPE_ID") != null) {
							incomingEnforcer_tDBOutput_2.put("LAST_UPDATED_SOURCE_TYPE_ID",
									row2.LAST_UPDATED_SOURCE_TYPE_ID);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null && incomingEnforcer_tDBOutput_2.getRuntimeSchema()
						...
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("USER_TYPE_ID") != null) {
							incomingEnforcer_tDBOutput_2.put("USER_TYPE_ID", row2.USER_TYPE_ID);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("LOCALE_ID") != null) {
							incomingEnforcer_tDBOutput_2.put("LOCALE_ID", row2.LOCALE_ID);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("LOCATION_ID") != null) {
						...
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("USER_LAST_NAME") != null) {
							incomingEnforcer_tDBOutput_2.put("USER_LAST_NAME", row2.USER_LAST_NAME);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("USER_PREFIX") != null) {
							incomingEnforcer_tDBOutput_2.put("USER_PREFIX", row2.USER_PREFIX);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("USER_TITLE") != null) {
						...
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("FAX_NUMBER") != null) {
							incomingEnforcer_tDBOutput_2.put("FAX_NUMBER", row2.FAX_NUMBER);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("ADDRESS_1") != null) {
							incomingEnforcer_tDBOutput_2.put("ADDRESS_1", row2.ADDRESS_1);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("ADDRESS_2") != null) {
						...
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("POSTAL_CODE") != null) {
							incomingEnforcer_tDBOutput_2.put("POSTAL_CODE", row2.POSTAL_CODE);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("COUNTRY_CODE") != null) {
							incomingEnforcer_tDBOutput_2.put("COUNTRY_CODE", row2.COUNTRY_CODE);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("USER_EMAIL_1") != null) {
							incomingEnforcer_tDBOutput_2.put("USER_EMAIL_1", row2.USER_EMAIL_1);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("USER_EMAIL_2") != null) {
						...
						if (incomingEnforcer_tDBOutput_2 != null && incomingEnforcer_tDBOutput_2.getRuntimeSchema()
								.getField("COMM_METHOD_ID_DURING_BH_1") != null) {
							incomingEnforcer_tDBOutput_2.put("COMM_METHOD_ID_DURING_BH_1",
									row2.COMM_METHOD_ID_DURING_BH_1);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null && incomingEnforcer_tDBOutput_2.getRuntimeSchema()
								.getField("COMM_METHOD_ID_DURING_BH_2") != null) {
							incomingEnforcer_tDBOutput_2.put("COMM_METHOD_ID_DURING_BH_2",
									row2.COMM_METHOD_ID_DURING_BH_2);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null && incomingEnforcer_tDBOutput_2.getRuntimeSchema()
								.getField("COMM_METHOD_ID_AFTER_BH_1") != null) {
							incomingEnforcer_tDBOutput_2.put("COMM_METHOD_ID_AFTER_BH_1",
									row2.COMM_METHOD_ID_AFTER_BH_1);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null && incomingEnforcer_tDBOutput_2.getRuntimeSchema()
								.getField("COMM_METHOD_ID_AFTER_BH_2") != null) {
							incomingEnforcer_tDBOutput_2.put("COMM_METHOD_ID_AFTER_BH_2",
									row2.COMM_METHOD_ID_AFTER_BH_2);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("COMMON_NAME") != null) {
						...
						if (incomingEnforcer_tDBOutput_2 != null && incomingEnforcer_tDBOutput_2.getRuntimeSchema()
								.getField("LAST_PASSWORD_CHANGE_DTTM") != null) {
							incomingEnforcer_tDBOutput_2.put("LAST_PASSWORD_CHANGE_DTTM",
									row2.LAST_PASSWORD_CHANGE_DTTM);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("LOGGED_IN") != null) {
						...
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("CHANNEL_ID") != null) {
						...
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("TAX_ID_NBR") != null) {
							incomingEnforcer_tDBOutput_2.put("TAX_ID_NBR", row2.TAX_ID_NBR);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("EMP_START_DATE") != null) {
							incomingEnforcer_tDBOutput_2.put("EMP_START_DATE", row2.EMP_START_DATE);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("BIRTH_DATE") != null) {
							incomingEnforcer_tDBOutput_2.put("BIRTH_DATE", row2.BIRTH_DATE);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("GENDER_ID") != null) {
						...
						// schema
						if (incomingEnforcer_tDBOutput_2 != null
								&& incomingEnforcer_tDBOutput_2.getRuntimeSchema().getField("PASSWORD_TOKEN") != null) {
						...
						if (incomingEnforcer_tDBOutput_2 != null && incomingEnforcer_tDBOutput_2.getRuntimeSchema()
								.getField("ISPASSWORDMANAGEDINTERNALLY") != null) {
							incomingEnforcer_tDBOutput_2.put("ISPASSWORDMANAGEDINTERNALLY",
									row2.ISPASSWORDMANAGEDINTERNALLY);
						}
...
// end of generic
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tDBInput_2", "tDBInput_2", "tOracleInput", "tDBOutput_2", "INVENTORY.UCL_USER",
						"tSnowflakeOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:R/hsrGYkPhJPJmGc/fJn5PxPvH0RB4AvPw1yDVkvtg92nZ9giuM=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:nNzeZ2GmOyF7rs+KM7noyfc9re7R/30eO2teOj06q983FPce65E=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBConnection_2.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:n4tRWj7NJfGQ9RdmpLXFyK1CHFVAe3CXSjIJQctIEK4lv7mWadpg"));
...
// finally of generic
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-05-24T15:37:27.581165100Z");
...
/************************************************************************************************
 * 416247 characters generated by Talend Cloud Data Management Platform on the
 * May 24, 2023 at 11:37:27 AM EDT
 ************************************************************************************************/