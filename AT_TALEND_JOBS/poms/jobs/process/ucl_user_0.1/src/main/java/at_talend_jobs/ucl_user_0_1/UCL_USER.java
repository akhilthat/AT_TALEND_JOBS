...
public class UCL_USER implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:T0XJ5TAWPMc3BZUGdn6sKBb56taT2a9zGDj6iAdwmvU86BBmwVw=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				String url_tDBConnection_1 = "jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host="
						+ context.host + ")(port=" + context.port + "))(connect_data=(service_name=" + context.database
						+ ")))";
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Bua3X1lqt/NPEdTAek1tauB1b2ht0RIiShlMkOgZEB2rU/PEOQo=");
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-05-24T14:52:27.169960300Z");
...
/************************************************************************************************
 * 56228 characters generated by Talend Cloud Data Management Platform on the
 * May 24, 2023 at 10:52:27 AM EDT
 ************************************************************************************************/