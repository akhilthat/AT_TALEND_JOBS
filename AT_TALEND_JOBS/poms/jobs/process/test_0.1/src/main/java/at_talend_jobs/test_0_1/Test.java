...
package at_talend_jobs.test_0_1;
...
public class Test implements TalendJob {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_AT_TALEND_JOBS_Test = new byte[0];
		static byte[] commonByteArray_AT_TALEND_JOBS_Test = new byte[0];
		...
		public Boolean DatasetIsNullable() {
			return true;
		}

		public Boolean DatasetIsKey() {
			return false;
		}

		public Integer DatasetLength() {
			return null;
		}

		public Integer DatasetPrecision() {
			return null;
		}

		public String DatasetDefault() {

			return null;

		}

		public String DatasetComment() {
		...
		public String DatasetOriginalDbColumnName() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_AT_TALEND_JOBS_Test.length) {
					if (length < 1024 && commonByteArray_AT_TALEND_JOBS_Test.length == 0) {
						commonByteArray_AT_TALEND_JOBS_Test = new byte[1024];
					} else {
						commonByteArray_AT_TALEND_JOBS_Test = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_AT_TALEND_JOBS_Test, 0, length);
				strReturn = new String(commonByteArray_AT_TALEND_JOBS_Test, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_AT_TALEND_JOBS_Test, 0, length);
				strReturn = new String(commonByteArray_AT_TALEND_JOBS_Test, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_AT_TALEND_JOBS_Test) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					talendJobLog.addCM("tPivotToColumnsDelimited_1", "tPivotToColumnsDelimited_1",
				...
				String fileName_tPivotToColumnsDelimited_1 = (new java.io.File(
						"C:/Program Files (x86)/Talend-Studio/studio/Workspace/out.csv")).getAbsolutePath()
								.replace("\\", "/");
					...
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1
									.append("FILENAME" + " = " + "\"C:/Users/Akhil.Thati/Downloads/result.csv\"");
							...
							log4jParamters_tFileInputDelimited_1.append("TRIMSELECT" + " = " + "[{TRIM=" + ("false")
									...
									+ ("date") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("Sales") + "}, {TRIM="
									+ ("false") + ", SCHEMA_COLUMN=" + ("Dataset") + "}]");
							log4jParamters_tFileInputDelimited_1.append(" | ");
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Users/Akhil.Thati/Downloads/result.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/Akhil.Thati/Downloads/result.csv", "ISO-8859-15", ";", "\n", true, 1, 0,
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.Sales = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 3;

							row1.Dataset = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									"tPivotToColumnsDelimited_1", "tPivotToColumnsDelimited_1",
									"tPivotToColumnsDelimited"
							...
							for (int i = 0; i < pivot_KeystPivotToColumnsDelimited_1.size(); i++) {
								...
								if (pivot_KeystPivotToColumnsDelimited_1.get(i).equals(row1.Dataset)) {
							...
							if (!pivot_ExiststPivotToColumnsDelimited_1) {
								...
								pivot_KeystPivotToColumnsDelimited_1
										.add(pivot_KeytPivotToColumnsDelimited_1.append(row1.Dataset).toString());
							...
							gKvaluetPivotToColumnsDelimited_1
									.add(group_KeytPivotToColumnsDelimited_1.append(row1.Store).toString());

							group_KeytPivotToColumnsDelimited_1.delete(0, group_KeytPivotToColumnsDelimited_1.length());

							gKvaluetPivotToColumnsDelimited_1
									.add(group_KeytPivotToColumnsDelimited_1.append(row1.date).toString());
							...
							if (!group_ExiststPivotToColumnsDelimited_1) {
								...
								aggValuestPivotToColumnsDelimited_1.add(String.valueOf(row1.Sales));
								...
								if (aggSizetPivotToColumnsDelimited_1 < pivotNumtPivotToColumnsDelimited_1) {
									...
									aggStrtPivotToColumnsDelimited_1.add(String.valueOf(row1.Sales));
									...
									if (!("").equals(aggStrtPivotToColumnsDelimited_1
										...
										if (Float.parseFloat(String.valueOf(row1.Sales)) > Float
												.parseFloat(aggStrtPivotToColumnsDelimited_1
														.get(pivotIndextPivotToColumnsDelimited_1)))
											aggStrtPivotToColumnsDelimited_1.set(pivotIndextPivotToColumnsDelimited_1,
													String.valueOf(row1.Sales));
					...
					if (!((Object) ("C:/Users/Akhil.Thati/Downloads/result.csv") instanceof java.io.InputStream)) {
				...
				outtPivotToColumnsDelimited_1.write("Store");

				outtPivotToColumnsDelimited_1.write(";");

				outtPivotToColumnsDelimited_1.write("date");
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						...
						"tPivotToColumnsDelimited_1", "tPivotToColumnsDelimited_1", "tPivotToColumnsDelimited",
						"output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_qzcMsBBvEe6wAPBS_nnfHw");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-06-21T20:15:08.021465600Z");
		...
		try {
			...
			java.io.InputStream inContext = Test.class.getClassLoader()
					.getResourceAsStream("at_talend_jobs/test_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 74316 characters generated by Talend Cloud Data Management Platform on the
 * June 21, 2023 at 4:15:08 PM EDT
 ************************************************************************************************/